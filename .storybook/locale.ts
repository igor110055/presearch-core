...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: ' Presearch Software. Presearch is a registered trademark of Presearch Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this Presearch Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from Presearch in the event of data loss on your device.',
  addFunds: 'add funds',
  addFundsFAQ: 'the FAQ',
  addFundsNote: 'Reminder: The Presearch Wallet is unidirectional and BAT flows to creators sites. For more information about Presearch Rewards, please visit',
  addFundsQR: 'Show QR Code',
  addFundsText: 'Be sure to use the address below that matches the type of cryto you own. It will be converted automatically to BAT by Uphold and appear as an increased balance in your Presearch Rewards wallet. Please allow up to one hour for your wallet balance to update.',
  addFundsTitle: 'Send cryptocurrency from your external account to your Presearch Rewards wallet.',
  ads: 'Ads',
  ...
  batPointsMessage: 'can be used in Presearch Rewards to contribute to your favorite content creators. BAT Points cannot be exchanged for BAT.',
  presearchAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  presearchAdsTitle: 'Presearch Ads',
  presearchAdsLaunchTitle: 'Presearch Ads has arrived!',
  presearchContributeDesc: 'Set budget and browse normally. Your favorite sites get paid automatically.',
  presearchContributeTitle: 'Auto-Contribute',
  presearchRewards: 'Presearch Rewards',
  presearchRewardsDesc: 'Earn tokens for viewing privacy-respecting ads, and pay it forward by supporting content creators you love!',
  presearchRewardsOptInText: 'Yes, I\'m In!',
  presearchRewardsSubTitle: 'Get Rewarded for Browsing!',
  presearchRewardsTeaser: 'How it works...',
  presearchRewardsTitle: 'Presearch Rewards',
  presearchVerified: 'Verified Creators',
  cancel: 'Cancel',
  ...
  connectedText: 'This creator has not yet signed up to receive contributions from Presearch users. Any tips you send will remain in your wallet until they verify.',
  ...
  presearchRewardsCreatingText: 'Creating wallet',
  date: 'Date',
  deposit: 'Deposit',
  deposits: 'Deposits',
  ...
  disabledPanelPrivateText: 'Presearch Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'Presearch Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable Presearch Rewards',
  ...
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the Presearch User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no Presearch Ads history',
  ...
  rewardsBackupNoticeText1: 'The funds in your Presearch wallet are virtual and not required to backup. It\'s available for you to spend exclusively on this browser.',
  ...
  rewardsBackupText4: 'Part of the funds may be received from Presearch and are not included in the backup as it is not required. It\'s available for you to spend exclusively on this browser.',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined Presearch’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsOffText2: 'Presearch Rewards allows you to take control back.',
  rewardsOffText3: 'Today, Presearch welcomes you to the new internet.',
  ...
  rewardsPanelEmptyText4: 'You can earn tokens from Presearch Ads.',
  rewardsPanelEmptyText5: 'Occasionally, you\'ll be offered free token grants from Presearch. Be sure to keep an eye out for the alert!',
  ...
  rewardsPanelText2: 'Your Presearch wallet is powered by Uphold',
  rewardsPanelText3: 'Presearch Rewards is built on the Basic Attention Token. Learn more about BAT',
  ...
  rewardsWhy: 'Why Presearch Rewards…',
  rewardsWidgetPresearchRewards: 'Presearch Rewards',
  ...
  rewardsWidgetBrandedNotificationDescription: '$1Learn more$2 about sponsored images in Presearch Rewards.',
  rewardsWidgetAboutRewards: '$1Learn more$2 about Presearch Rewards',
  rewardsWidgetTurnOnAds: 'Turn on Presearch Ads',
  ...
  sendTip: 'Send my Tip',
  serviceText: 'By clicking \'Enable Presearch Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on Presearch Rewards, you indicate that you have read and agree to the',
  ...
  siteBannerNoticeText: 'This Creator has not yet verified their site. As soon as they verify with Presearch, they will receive your tip.',
  siteBannerConnectedText: 'This creator has not yet signed up to receive contributions from Presearch users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
  sites: 'sites',
  ...
  turnOnRewardsDesc: 'This enables both Presearch Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from Presearch users.',
  ...
  walletDisconnect: 'Disconnect from Presearch Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your Presearch Rewards wallet',
  ...
  walletVerificationNote2: 'Presearch Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused Presearch Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'Presearch Payments is now Presearch Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very Presearch way to browse the web.',
  whyPresearchRewards: 'Why Presearch Rewards?',
  whyPresearchRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyPresearchRewardsDesc2: 'Well, you\'ve come to the right place. Presearch welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
  ...
  showPresearchStats: 'Show Presearch Stats',
  showBinance: 'Show Binance',
  showTogether: 'Show Presearch Together',
  ...
  presearchTodayDisableSourceCommand: 'Disable content from $1',
}
