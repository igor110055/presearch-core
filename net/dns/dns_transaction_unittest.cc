...
class PresearchDnsTransactionTest : public DnsTransactionTestBase,
                                public WithTaskEnvironment {
 public:
  PresearchDnsTransactionTest() = default;

  ~PresearchDnsTransactionTest() override = default;

  void PresearchConfigureDohServers(bool user_doh_server) {
...
TEST_F(PresearchDnsTransactionTest,
       SkipDecentralizedDNSResolversForNonTargetTLDsWithoutUserDoHServer) {
  PresearchConfigureDohServers(false);
...
TEST_F(PresearchDnsTransactionTest,
  ...
  PresearchConfigureDohServers(true);
...
TEST_F(PresearchDnsTransactionTest, UseENSResolverForEthDomainsWithUserDoHServer) {
  PresearchConfigureDohServers(false);
  AddQueryAndResponse(
      0, kTestEthHostName, dns_protocol::kTypeA, kTestEthResponseDatagram,
      base::size(kTestEthResponseDatagram), SYNCHRONOUS, Transport::HTTPS,
