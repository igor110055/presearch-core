...
class PresearchResolveContextTest : public testing::Test {
 public:
  PresearchResolveContextTest() = default;
...
TEST_F(PresearchResolveContextTest, DohServerAvailability_InitialAvailability) {
  DnsConfig config = CreateDnsConfig();
  scoped_refptr<DnsSession> session = CreateDnsSession(config);

  URLRequestContext request_context;
  PresearchResolveContext context(&request_context, true /* enable_caching */);
...
TEST_F(PresearchResolveContextTest, DohServerAvailability_RecordServerFailure) {
...
TEST_F(PresearchResolveContextTest, DohServerAvailability_RecordServerSuccess) {
  scoped_refptr<DnsSession> session = CreateDnsSession(CreateDnsConfig());
