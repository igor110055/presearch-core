...
#ifndef PRESEARCH_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
#define PRESEARCH_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
...
#endif  // PRESEARCH_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
