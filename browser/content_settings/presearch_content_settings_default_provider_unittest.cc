...
class PresearchContentSettingsDefaultProviderTest : public testing::Test {
 public:
  PresearchContentSettingsDefaultProviderTest()
      : provider_(profile_.GetPrefs(), false) {}
  ~PresearchContentSettingsDefaultProviderTest() override {
 ...
 protected:
  ...
  PresearchDefaultProvider provider_;
};

TEST_F(PresearchContentSettingsDefaultProviderTest, DiscardObsoleteAutoplayAsk) {
  ...
  // The ASK value of the autoplay content setting should be discarded.
  {
    ...
    PresearchDefaultProvider provider(prefs, false);
