...
#ifndef PRESEARCH_BROWSER_EXTENSIONS_PRESEARCH_COMPONENT_LOADER_H_
#define PRESEARCH_BROWSER_EXTENSIONS_PRESEARCH_COMPONENT_LOADER_H_
...
class PresearchComponentLoader : public ComponentLoader {
 public:
  PresearchComponentLoader(ExtensionSystem* extension_system,
                       Profile* browser_context);
  ~PresearchComponentLoader() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PresearchComponentLoader);
};

}  // namespace extensions

#endif  // PRESEARCH_BROWSER_EXTENSIONS_PRESEARCH_COMPONENT_LOADER_H_
