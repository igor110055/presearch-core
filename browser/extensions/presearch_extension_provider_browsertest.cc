...
class PresearchExtensionProviderTest : public extensions::ExtensionFunctionalTest {
 public:
...
IN_PROC_BROWSER_TEST_F(PresearchExtensionProviderTest, BlacklistExtension) {
...
IN_PROC_BROWSER_TEST_F(PresearchExtensionProviderTest, WhitelistedExtension) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  const extensions::Extension* extension = InstallExtension(
...
IN_PROC_BROWSER_TEST_F(PresearchExtensionProviderTest,
...
IN_PROC_BROWSER_TEST_F(PresearchExtensionProviderTest, ExtensionsCanGetCookies) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  scoped_refptr<const extensions::Extension> extension =
      InstallExtensionSilently(
...
IN_PROC_BROWSER_TEST_F(PresearchExtensionProviderTest, ExtensionsCanSetCookies) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  scoped_refptr<const extensions::Extension> extension =
      InstallExtensionSilently(
