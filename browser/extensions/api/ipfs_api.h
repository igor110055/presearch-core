...
#ifndef PRESEARCH_BROWSER_EXTENSIONS_API_IPFS_API_H_
#define PRESEARCH_BROWSER_EXTENSIONS_API_IPFS_API_H_
...
#endif  // PRESEARCH_BROWSER_EXTENSIONS_API_IPFS_API_H_
