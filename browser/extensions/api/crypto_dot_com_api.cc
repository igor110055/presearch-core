...
#include "presearch/browser/extensions/api/crypto_dot_com_api.h"
...
#include "presearch/common/extensions/api/crypto_dot_com.h"
#include "presearch/browser/crypto_dot_com/crypto_dot_com_service_factory.h"
#include "presearch/components/crypto_dot_com/browser/crypto_dot_com_service.h"
#include "presearch/components/crypto_dot_com/browser/regions.h"
...
bool IsCryptoDotComAPIAvailable(content::BrowserContext* context) {
  return presearch::IsRegularProfile(context);
}
