...
#ifndef PRESEARCH_BROWSER_EXTENSIONS_API_BINANCE_API_H_
#define PRESEARCH_BROWSER_EXTENSIONS_API_BINANCE_API_H_
...
#endif  // PRESEARCH_BROWSER_EXTENSIONS_API_BINANCE_API_H_
