...
class PresearchDownloadItemModelTest : public testing::Test {
 public:
  PresearchDownloadItemModelTest() : model_(&item_), presearch_model_(&model_) {}
  ~PresearchDownloadItemModelTest() override {}
 ...
 protected:
  ...
  PresearchDownloadItemModel& model() { return presearch_model_; }
...
TEST_F(PresearchDownloadItemModelTest, GetOriginUrlText) {
...
TEST_F(PresearchDownloadItemModelTest, GetTooltipText) {
