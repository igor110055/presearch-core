...
#ifndef PRESEARCH_BROWSER_INFOBARS_CRYPTO_WALLETS_INFOBAR_DELEGATE_H_
#define PRESEARCH_BROWSER_INFOBARS_CRYPTO_WALLETS_INFOBAR_DELEGATE_H_
...
#endif  // PRESEARCH_BROWSER_INFOBARS_CRYPTO_WALLETS_INFOBAR_DELEGATE_H_
