...
/**
 * Builds a notification according to PresearchAds spec.
 */
public class PresearchAdsNotificationBuilder extends NotificationBuilderBase {
    /**
    ...
    private static Bitmap sPresearchIcon;

    private final Context mContext;

    public PresearchAdsNotificationBuilder(Context context) {
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(PresearchChannelDefinitions.ChannelId.PRESEARCH_ADS);
    }
    ...
    public NotificationWrapper build(NotificationMetadata metadata) {
        ...
        RemoteViews compactView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_presearch_ads);
        RemoteViews bigView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_big_presearch_ads);
        ...
        setChannelId(PresearchChannelDefinitions.ChannelId.PRESEARCH_ADS);
        ...
        for (RemoteViews view : new RemoteViews[] {compactView, bigView}) {
            ...
            view.setImageViewBitmap(R.id.icon, getPresearchIcon());
        ...
        String channelId =  (ApplicationStatus.hasVisibleActivities()) ?
                PresearchChannelDefinitions.ChannelId.PRESEARCH_ADS :
                PresearchChannelDefinitions.ChannelId.PRESEARCH_ADS_BACKGROUND;
        ...
        builder.setLargeIcon(getPresearchIcon());
