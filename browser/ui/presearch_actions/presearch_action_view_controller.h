...
#ifndef PRESEARCH_BROWSER_UI_PRESEARCH_ACTIONS_PRESEARCH_ACTION_VIEW_CONTROLLER_H_
#define PRESEARCH_BROWSER_UI_PRESEARCH_ACTIONS_PRESEARCH_ACTION_VIEW_CONTROLLER_H_
...
class PresearchActionViewController : public ExtensionActionViewController {
 public:
 ...
 private:
    ...
    std::unique_ptr<PresearchActionIconWithBadgeImageSource> GetIconImageSource(
        content::WebContents* web_contents,
        const gfx::Size& size);
    DISALLOW_COPY_AND_ASSIGN(PresearchActionViewController);
};

#endif  // PRESEARCH_BROWSER_UI_PRESEARCH_ACTIONS_PRESEARCH_ACTION_VIEW_CONTROLLER_H_
