...
base::Optional<int>
PresearchActionIconWithBadgeImageSource::GetCustomGraphicSize() {
  return kPresearchActionGraphicSize;
}

base::Optional<int>
PresearchActionIconWithBadgeImageSource::GetCustomGraphicXOffset() {
  return std::floor(
      (size().width() - kPresearchActionRightMargin - kPresearchActionGraphicSize) /
      2.0);
}

base::Optional<int>
PresearchActionIconWithBadgeImageSource::GetCustomGraphicYOffset() {
  return std::floor((size().height() - kPresearchActionGraphicSize) / 2.0);
}

void PresearchActionIconWithBadgeImageSource::PaintBadge(gfx::Canvas* canvas) {
  ...
  // LOG(ERROR) << "PresearchAction badge text size initial, "
  //            << "w:"
  //            << text_width
  //            << " h:"
  //            << text_height;
...
gfx::Rect PresearchActionIconWithBadgeImageSource::GetIconAreaRect() const {
