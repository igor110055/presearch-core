...
typedef InProcessBrowserTest PresearchAutoplayBlockedImageModelTest;

IN_PROC_BROWSER_TEST_F(PresearchAutoplayBlockedImageModelTest, CreateBubbleModel) {
  ...
  auto model = std::make_unique<PresearchAutoplayBlockedImageModel>();
