...
PresearchAutoplayBlockedImageModel::PresearchAutoplayBlockedImageModel()
    : ContentSettingSimpleImageModel(ImageType::MEDIASTREAM,
                                     ContentSettingsType::AUTOPLAY) {}

bool PresearchAutoplayBlockedImageModel::UpdateAndGetVisibility(
...
PresearchAutoplayBlockedImageModel::CreateBubbleModelImpl(
    ContentSettingBubbleModel::Delegate* delegate,
    content::WebContents* web_contents) {
  return std::make_unique<PresearchAutoplayContentSettingBubbleModel>(delegate,
                                                                  web_contents);
}
