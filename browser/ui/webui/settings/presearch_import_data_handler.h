...
#ifndef PRESEARCH_BROWSER_UI_WEBUI_SETTINGS_PRESEARCH_IMPORT_DATA_HANDLER_H_
#define PRESEARCH_BROWSER_UI_WEBUI_SETTINGS_PRESEARCH_IMPORT_DATA_HANDLER_H_
...
// This class checks whether Presearch has full disk access permission to import
// safari data on macOS. ImportDataHandler::StartImport() will be run after
// checking disk access permission. If Presearch doesn't have that permission, this
...
class PresearchImportDataHandler : public ImportDataHandler,
                                      content::WebContentsObserver {
 public:
  PresearchImportDataHandler();
  ~PresearchImportDataHandler() override;

  PresearchImportDataHandler(const PresearchImportDataHandler&) = delete;
  PresearchImportDataHandler& operator=(const PresearchImportDataHandler&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<PresearchImportDataHandler> weak_factory_;
#endif
};

}  // namespace settings

#endif  // PRESEARCH_BROWSER_UI_WEBUI_SETTINGS_PRESEARCH_IMPORT_DATA_HANDLER_H_
