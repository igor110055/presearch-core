...
#ifndef PRESEARCH_BROWSER_UI_WEBUI_NEW_TAB_PAGE_PRESEARCH_NEW_TAB_MESSAGE_HANDLER_H_
#define PRESEARCH_BROWSER_UI_WEBUI_NEW_TAB_PAGE_PRESEARCH_NEW_TAB_MESSAGE_HANDLER_H_
...
class PresearchNewTabMessageHandler : public content::WebUIMessageHandler,
                                  public TorLauncherObserver {
 public:
  explicit PresearchNewTabMessageHandler(Profile* profile);
  ~PresearchNewTabMessageHandler() override;
  ...
  static PresearchNewTabMessageHandler* Create(
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PresearchNewTabMessageHandler);
};

#endif  // PRESEARCH_BROWSER_UI_WEBUI_NEW_TAB_PAGE_PRESEARCH_NEW_TAB_MESSAGE_HANDLER_H_
