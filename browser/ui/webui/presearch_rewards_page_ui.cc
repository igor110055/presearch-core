...
#include "presearch/browser/ui/webui/presearch_rewards_page_ui.h"
...
#include "presearch/components/presearch_rewards/resources/grit/presearch_rewards_page_generated_map.h"
...
// The handler for Javascript messages for Presearch about: pages
class RewardsDOMHandler : public WebUIMessageHandler,
    public presearch_ads::AdsServiceObserver,
 ...
 private:
  ...
  void OnGetPaymentId(ledger::type::PresearchWalletPtr wallet);
  ...
  void OnAdsEnabled(presearch_rewards::RewardsService* rewards_service,
  ...
  void OnNotificationDeleted(
      ...
      const presearch_rewards::RewardsNotificationService::RewardsNotification&
          notification) override;
  void OnAllNotificationsDeleted(presearch_rewards::RewardsNotificationService*
  ...
  presearch_ads::AdsService* ads_service_;  // NOT OWNED
...
void RewardsDOMHandler::RegisterMessages() {
  ...
  web_ui()->RegisterMessageCallback("presearch_rewards.isInitialized",
      base::BindRepeating(&RewardsDOMHandler::IsInitialized,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getRewardsParameters",
      base::BindRepeating(&RewardsDOMHandler::GetRewardsParameters,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getAutoContributeProperties",
      base::BindRepeating(&RewardsDOMHandler::GetAutoContributeProperties,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.fetchPromotions",
      base::BindRepeating(&RewardsDOMHandler::FetchPromotions,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.claimPromotion",
      base::BindRepeating(&RewardsDOMHandler::ClaimPromotion,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.attestPromotion",
      base::BindRepeating(&RewardsDOMHandler::AttestPromotion,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.recoverWallet",
      base::BindRepeating(&RewardsDOMHandler::RecoverWallet,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getReconcileStamp",
      base::BindRepeating(&RewardsDOMHandler::GetReconcileStamp,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.saveSetting",
      base::BindRepeating(&RewardsDOMHandler::SaveSetting,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.excludePublisher",
      base::BindRepeating(&RewardsDOMHandler::ExcludePublisher,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.restorePublishers",
      base::BindRepeating(&RewardsDOMHandler::RestorePublishers,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.restorePublisher",
      base::BindRepeating(&RewardsDOMHandler::RestorePublisher,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getContributionAmount",
      base::BindRepeating(&RewardsDOMHandler::GetAutoContributionAmount,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.removeRecurringTip",
      base::BindRepeating(&RewardsDOMHandler::RemoveRecurringTip,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "presearch_rewards.getRecurringTips",
      base::BindRepeating(&RewardsDOMHandler::GetRecurringTips,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getOneTimeTips",
      base::BindRepeating(&RewardsDOMHandler::GetOneTimeTips,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getContributionList",
      base::BindRepeating(&RewardsDOMHandler::GetContributionList,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getAdsData",
      base::BindRepeating(&RewardsDOMHandler::GetAdsData,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getAdsHistory",
      base::BindRepeating(&RewardsDOMHandler::GetAdsHistory,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.toggleAdThumbUp",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdThumbUp,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.toggleAdThumbDown",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdThumbDown,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.toggleAdOptInAction",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdOptInAction,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.toggleAdOptOutAction",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdOptOutAction,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.toggleSaveAd",
      base::BindRepeating(&RewardsDOMHandler::ToggleSaveAd,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.toggleFlagAd",
      base::BindRepeating(&RewardsDOMHandler::ToggleFlagAd,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.saveAdsSetting",
      base::BindRepeating(&RewardsDOMHandler::SaveAdsSetting,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.setBackupCompleted",
      base::BindRepeating(&RewardsDOMHandler::SetBackupCompleted,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "presearch_rewards.getPendingContributionsTotal",
      base::BindRepeating(&RewardsDOMHandler::GetPendingContributionsTotal,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "presearch_rewards.getStatement",
      base::BindRepeating(&RewardsDOMHandler::GetStatement,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "presearch_rewards.setInlineTippingPlatformEnabled",
      base::BindRepeating(&RewardsDOMHandler::SetInlineTippingPlatformEnabled,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getPendingContributions",
      base::BindRepeating(&RewardsDOMHandler::GetPendingContributions,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.removePendingContribution",
      base::BindRepeating(&RewardsDOMHandler::RemovePendingContribution,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "presearch_rewards.removeAllPendingContribution",
      base::BindRepeating(&RewardsDOMHandler::RemoveAllPendingContributions,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getExcludedSites",
      base::BindRepeating(&RewardsDOMHandler::GetExcludedSites,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.fetchBalance",
      base::BindRepeating(&RewardsDOMHandler::FetchBalance,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "presearch_rewards.getExternalWallet",
      base::BindRepeating(&RewardsDOMHandler::GetExternalWallet,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.processRewardsPageUrl",
      base::BindRepeating(&RewardsDOMHandler::ProcessRewardsPageUrl,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.disconnectWallet",
      base::BindRepeating(&RewardsDOMHandler::DisconnectWallet,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.onlyAnonWallet",
      base::BindRepeating(&RewardsDOMHandler::OnlyAnonWallet,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getBalanceReport",
      base::BindRepeating(&RewardsDOMHandler::GetBalanceReport,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getMonthlyReport",
      base::BindRepeating(&RewardsDOMHandler::GetMonthlyReport,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getMonthlyReportIds",
      base::BindRepeating(&RewardsDOMHandler::GetAllMonthlyReportIds,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getCountryCode",
      base::BindRepeating(&RewardsDOMHandler::GetCountryCode,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.completeReset",
      base::BindRepeating(&RewardsDOMHandler::CompleteReset,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getPaymentId",
      base::BindRepeating(&RewardsDOMHandler::GetPaymentId,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getWalletPassphrase",
      base::BindRepeating(&RewardsDOMHandler::GetWalletPassphrase,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.getOnboardingStatus",
      base::BindRepeating(&RewardsDOMHandler::GetOnboardingStatus,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("presearch_rewards.saveOnboardingResult",
...
void RewardsDOMHandler::Init() {
  ...
  ads_service_ = presearch_ads::AdsServiceFactory::GetForProfile(profile);
  if (ads_service_) {
...
void RewardsDOMHandler::OnGetRewardsParameters(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
        "presearch_rewards.rewardsParameters", data);
}
...
void RewardsDOMHandler::OnGetAutoContributeProperties(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
    "presearch_rewards.autoContributeProperties",
    values);
}
...
void RewardsDOMHandler::OnFetchPromotions(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.promotions", dict);
}
...
void RewardsDOMHandler::OnClaimPromotion(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.claimPromotion",
      response);
}
...
void RewardsDOMHandler::ClaimPromotion(const base::ListValue* args) {
  ...
  rewards_service_->ClaimPromotion(
      ...
      base::Bind(&RewardsDOMHandler::OnClaimPromotion,
          ...
          promotion_id));
#else
  // No need for a callback. The UI receives "presearch_rewards.promotionFinish".
  presearch_rewards::AttestPromotionCallback callback = base::DoNothing();
...
void RewardsDOMHandler::AttestPromotion(const base::ListValue *args) {
  ...
  if (!rewards_service_) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.promotionFinish",
      finish);
  }
...
void RewardsDOMHandler::OnRecoverWallet(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
        "presearch_rewards.recoverWalletData",
...
void RewardsDOMHandler::OnGetReconcileStamp(uint64_t reconcile_stamp) {
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.reconcileStamp",
        base::Value(stamp));
  }
}
...
void RewardsDOMHandler::OnExcludedSitesChanged(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.excludedSiteChanged");
}
...
void RewardsDOMHandler::OnNotificationDeleted(
  ...
  if (notification.type_ ==
      presearch_rewards::RewardsNotificationService::REWARDS_NOTIFICATION_GRANT
    ...
    web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.grantFinish", finish);
  }
#endif
}
...
void RewardsDOMHandler::OnPublisherList(ledger::type::PublisherInfoList list) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.contributeList",
      *publishers);
}
...
void RewardsDOMHandler::OnExcludedSiteList(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.excludedList",
      *publishers);
}

void RewardsDOMHandler::OnGetContributionAmount(double amount) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.contributionAmount",
        base::Value(amount));
  }
}
...
void RewardsDOMHandler::OnReconcileComplete(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.reconcileComplete",
      complete);
}
...
void RewardsDOMHandler::OnGetRecurringTips(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.recurringTips",
                                         *publishers);
}
...
void RewardsDOMHandler::GetAdsData(const base::ListValue *args) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.adsData", ads_data);
}
...
void RewardsDOMHandler::OnGetAdsHistory(const base::ListValue& ads_history) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.adsHistory",
                                         ads_history);
}
...
void RewardsDOMHandler::OnToggleAdThumbUp(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.onToggleAdThumbUp",
                                         result);
}
...
void RewardsDOMHandler::OnToggleAdThumbDown(
  ...
  result.SetKey("creativeInstanceId", base::Value(creative_instance_id));
  result.SetKey("action", base::Value(action));
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.onToggleAdThumbDown",
                                         result);
}
...
void RewardsDOMHandler::OnToggleAdOptInAction(const std::string& category,
  ...
  result.SetKey("action", base::Value(action));
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.onToggleAdOptInAction",
                                         result);
}
...
void RewardsDOMHandler::OnToggleAdOptOutAction(const std::string& category,
  ...
  result.SetKey("category", base::Value(category));
  result.SetKey("action", base::Value(action));
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.onToggleAdOptOutAction",
                                         result);
}
...
void RewardsDOMHandler::OnToggleSaveAd(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.onToggleSaveAd",
                                         result);
}
...
void RewardsDOMHandler::OnToggleFlagAd(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.onToggleFlagAd",
                                         result);
}
...
void RewardsDOMHandler::OnGetPendingContributionsTotal(double amount) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "presearch_rewards.pendingContributionTotal", base::Value(amount));
  }
}
...
void RewardsDOMHandler::OnPendingContributionSaved(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.onPendingContributionSaved",
      base::Value(static_cast<int>(result)));
}
...
void RewardsDOMHandler::OnGetStatement(const bool success,
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.statement", history);
}
...
void RewardsDOMHandler::OnStatementChanged(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "presearch_rewards.statementChanged");
  }
}
...
void RewardsDOMHandler::OnRecurringTipSaved(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "presearch_rewards.recurringTipSaved", base::Value(success));
  }
}
...
void RewardsDOMHandler::OnRecurringTipRemoved(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.recurringTipRemoved", base::Value(success));
}
...
void RewardsDOMHandler::OnGetPendingContributions(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.pendingContributions",
      *contributions);
}
...
void RewardsDOMHandler::OnPendingContributionRemoved(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "presearch_rewards.onRemovePendingContribution",
        base::Value(static_cast<int>(result)));
  }
}
...
void RewardsDOMHandler::OnFetchBalance(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.balance", data);
}
...
void RewardsDOMHandler::OnGetExternalWallet(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.externalWallet",
                                           data);
  }
}
...
void RewardsDOMHandler::OnProcessRewardsPageUrl(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.processRewardsPageUrl",
                                         data);
}
...
void RewardsDOMHandler::OnDisconnectWallet(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.disconnectWallet",
      data);
}
...
void RewardsDOMHandler::OnlyAnonWallet(const base::ListValue* args) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.onlyAnonWallet",
      base::Value(allow));
}
...
void RewardsDOMHandler::OnUnblindedTokensReady(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.unblindedTokensReady");
}
...
void RewardsDOMHandler::ReconcileStampReset() {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("presearch_rewards.reconcileStampReset");
}
...
void RewardsDOMHandler::OnGetBalanceReport(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.balanceReport",
      data);
}
...
void RewardsDOMHandler::OnGetMonthlyReport(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
    "presearch_rewards.monthlyReport",
    data);
}
...
void RewardsDOMHandler::OnGetAllMonthlyReportIds(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.monthlyReportIds",
      list);
}
...
void RewardsDOMHandler::GetCountryCode(const base::ListValue* args) {
  ...
  const std::string country_code = presearch_l10n::GetCountryCode(locale);

  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.countryCode", base::Value(country_code));
}
...
void RewardsDOMHandler::OnCompleteReset(const bool success) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.completeReset", base::Value(success));
}
...
void RewardsDOMHandler::OnWalletCreatedForPaymentId(
  ...
  rewards_service_->GetPresearchWallet(
      base::BindOnce(&RewardsDOMHandler::OnGetPaymentId,
          weak_factory_.GetWeakPtr()));
}

void RewardsDOMHandler::OnGetPaymentId(ledger::type::PresearchWalletPtr wallet) {
  if (!web_ui()->CanCallJavascript()) {
    return;
  }
...
void RewardsDOMHandler::OnGetWalletPassphrase(const std::string& passphrase) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.walletPassphrase",
...
void RewardsDOMHandler::GetOnboardingStatus(const base::ListValue* args) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "presearch_rewards.onboardingStatus",
      data);
}
...
PresearchRewardsPageUI::PresearchRewardsPageUI(content::WebUI* web_ui,
                                       const std::string& name)
    : WebUIController(web_ui) {
  CreateAndAddWebUIDataSource(web_ui, name, kPresearchRewardsPageGenerated,
                              kPresearchRewardsPageGeneratedSize,
#if defined(OS_ANDROID)
                              IDR_PRESEARCH_REWARDS_ANDROID_PAGE_HTML,
#else
                              IDR_PRESEARCH_REWARDS_PAGE_HTML,
#endif
...
PresearchRewardsPageUI::~PresearchRewardsPageUI() {}
