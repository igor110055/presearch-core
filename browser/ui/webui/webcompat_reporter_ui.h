...
#ifndef PRESEARCH_BROWSER_UI_WEBUI_WEBCOMPAT_REPORTER_UI_H_
#define PRESEARCH_BROWSER_UI_WEBUI_WEBCOMPAT_REPORTER_UI_H_
...
#endif  // PRESEARCH_BROWSER_UI_WEBUI_WEBCOMPAT_REPORTER_UI_H_
