...
PresearchAppMenuModel::PresearchAppMenuModel(
...
PresearchAppMenuModel::~PresearchAppMenuModel() = default;
...
int PresearchAppMenuModel::GetIndexOfPresearchAdBlockItem() const {
  ...
  adblock_item_index = GetIndexOfCommandId(IDC_SHOW_PRESEARCH_SYNC);
  if (adblock_item_index != -1)
    return adblock_item_index + 1;
  ...
  adblock_item_index = GetIndexOfCommandId(IDC_SHOW_PRESEARCH_WALLET);
  if (adblock_item_index != -1)
    return adblock_item_index + 1;
...
int PresearchAppMenuModel::GetIndexOfPresearchRewardsItem() const {
...
int PresearchAppMenuModel::GetIndexOfPresearchSyncItem() const {
  ...
  sync_index = GetIndexOfCommandId(IDC_SHOW_PRESEARCH_WALLET);
  if (sync_index != -1)
    return sync_index + 1;
...
#if BUILDFLAG(ENABLE_SIDEBAR)
int PresearchAppMenuModel::GetIndexOfPresearchSidebarItem() const {
  // Insert as a last item in second section.
  int sidebar_item_index = -1;
  sidebar_item_index = GetIndexOfCommandId(IDC_SHOW_PRESEARCH_SYNC);
  ...
  sidebar_item_index = GetIndexOfCommandId(IDC_SHOW_PRESEARCH_WALLET);
  if (sidebar_item_index != -1)
    return sidebar_item_index + 1;
