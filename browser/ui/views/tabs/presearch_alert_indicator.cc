...
#include "presearch/browser/ui/views/tabs/presearch_alert_indicator.h"
...
class PresearchAlertIndicator::PresearchAlertBackground : public views::Background {
 public:
  explicit PresearchAlertBackground(PresearchAlertIndicator* host_view)
 ...
 private:
  PresearchAlertIndicator* host_view_;

  DISALLOW_COPY_AND_ASSIGN(PresearchAlertBackground);
};

PresearchAlertIndicator::PresearchAlertIndicator(Tab* parent_tab)
    : AlertIndicator(parent_tab) {
  SetBackground(std::make_unique<PresearchAlertBackground>(this));
}

SkColor PresearchAlertIndicator::GetBackgroundColor() const {
...
bool PresearchAlertIndicator::OnMousePressed(const ui::MouseEvent& event) {
  mouse_pressed_ = true;
  SchedulePaint();
...
void PresearchAlertIndicator::OnMouseReleased(const ui::MouseEvent& event) {
...
void PresearchAlertIndicator::OnMouseEntered(const ui::MouseEvent& event) {
  if (IsTabAudioToggleable())
    SchedulePaint();
  AlertIndicator::OnMouseExited(event);
}

void PresearchAlertIndicator::OnMouseExited(const ui::MouseEvent& event) {
  if (IsTabAudioToggleable())
    SchedulePaint();
  AlertIndicator::OnMouseExited(event);
}

bool PresearchAlertIndicator::OnMouseDragged(const ui::MouseEvent& event) {
  if (IsTabAudioToggleable())
    SchedulePaint();
  return AlertIndicator::OnMouseDragged(event);
}

bool PresearchAlertIndicator::IsTabAudioToggleable() const {
