...
class PresearchOmniboxViewViewsTest : public InProcessBrowserTest {
 public:
...
// Load presearch url and check copied url also has presearch scheme.
IN_PROC_BROWSER_TEST_F(PresearchOmniboxViewViewsTest, CopyURLToClipboardTest) {
  const std::string test_url("presearch://version/");
