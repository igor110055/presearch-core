...
#include "presearch/browser/ui/views/sidebar/sidebar_control_view.h"
...
#include "presearch/browser/ui/views/sidebar/sidebar_add_item_bubble_delegate_view.h"
...
SidebarControlView::SidebarControlView(PresearchBrowser* browser)
    : browser_(browser) {
...
void SidebarControlView::UpdateBackgroundAndBorder() {
  if (const ui::ThemeProvider* theme_provider = GetThemeProvider()) {
    ...
    SetBorder(views::CreateSolidSidedBorder(
        ...
        theme_provider->GetColor(PresearchThemeProperties::COLOR_SIDEBAR_BORDER)));
  }
}
...
void SidebarControlView::UpdateItemAddButtonState() {
  ...
  if (const ui::ThemeProvider* theme_provider = GetThemeProvider()) {
    button_base_color = theme_provider->GetColor(
        PresearchThemeProperties::COLOR_SIDEBAR_BUTTON_BASE);
    button_disabled_color = theme_provider->GetColor(
        PresearchThemeProperties::COLOR_SIDEBAR_ADD_BUTTON_DISABLED);
  }
