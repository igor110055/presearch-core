...
#include "presearch/browser/ui/sidebar/sidebar_model_data.h"
...
SidebarContainerView::SidebarContainerView(PresearchBrowser* browser)
    : browser_(browser) {}
  ...
  if (const ui::ThemeProvider* theme_provider = GetThemeProvider()) {
    ...
    SetBorder(views::CreateSolidSidedBorder(
        ...
        theme_provider->GetColor(
            PresearchThemeProperties::COLOR_SIDEBAR_PANEL_BORDER)));
  }
}
