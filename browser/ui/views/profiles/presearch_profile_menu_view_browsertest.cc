...
class PresearchProfileMenuViewTest : public InProcessBrowserTest {
 public:
  PresearchProfileMenuViewTest() = default;
  ~PresearchProfileMenuViewTest() override = default;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(PresearchProfileMenuViewTest);
};

IN_PROC_BROWSER_TEST_F(PresearchProfileMenuViewTest, TestCurrentProfileView) {
  OpenProfileMenuView();
