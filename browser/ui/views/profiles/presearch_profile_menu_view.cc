...
void PresearchProfileMenuView::BuildIdentity() {
...
void PresearchProfileMenuView::BuildAutofillButtons() {}

// We don't want to show any Chromium sync info.
void PresearchProfileMenuView::BuildSyncInfo() {}

// We don't want feature buttons to manage google account
void PresearchProfileMenuView::BuildFeatureButtons() {
  Profile* profile = browser()->profile();
...
gfx::ImageSkia PresearchProfileMenuView::GetSyncIcon() const {
  // We don't need sync overlay.
  return gfx::ImageSkia();
}

void PresearchProfileMenuView::OnExitProfileButtonClicked() {
