...
#ifndef PRESEARCH_BROWSER_UI_VIEWS_LOCATION_BAR_ONION_LOCATION_VIEW_H_
#define PRESEARCH_BROWSER_UI_VIEWS_LOCATION_BAR_ONION_LOCATION_VIEW_H_
...
#endif  // PRESEARCH_BROWSER_UI_VIEWS_LOCATION_BAR_ONION_LOCATION_VIEW_H_
