...
#ifndef PRESEARCH_BROWSER_UI_VIEWS_TOOLBAR_BOOKMARK_BUTTON_H_
#define PRESEARCH_BROWSER_UI_VIEWS_TOOLBAR_BOOKMARK_BUTTON_H_
...
#endif  // PRESEARCH_BROWSER_UI_VIEWS_TOOLBAR_BOOKMARK_BUTTON_H_
