...
#ifndef PRESEARCH_BROWSER_UI_VIEWS_TOOLBAR_PRESEARCH_TOOLBAR_VIEW_H_
#define PRESEARCH_BROWSER_UI_VIEWS_TOOLBAR_PRESEARCH_TOOLBAR_VIEW_H_
...
class PresearchToolbarView : public ToolbarView,
                         public ProfileAttributesStorage::Observer {
 public:
  explicit PresearchToolbarView(Browser* browser, BrowserView* browser_view);
  ~PresearchToolbarView() override;
 ...
 private:
  ...
  bool presearch_initialized_ = false;
...
#endif  // PRESEARCH_BROWSER_UI_VIEWS_TOOLBAR_PRESEARCH_TOOLBAR_VIEW_H_
