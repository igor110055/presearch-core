...
class MockPresearchTranslateBubbleView : public PresearchTranslateBubbleView {
 public:
  MockPresearchTranslateBubbleView(views::View* anchor_view,
                               std::unique_ptr<TranslateBubbleModel> model,
                               translate::TranslateErrors::Type error_type,
                               content::WebContents* web_contents)
    : PresearchTranslateBubbleView(anchor_view,
                               std::move(model),
                               error_type,
                               web_contents)
  ...
  ~MockPresearchTranslateBubbleView() override {
  }
...
class PresearchTranslateBubbleViewTest : public ChromeViewsTestBase {
 public:
  PresearchTranslateBubbleViewTest() {}
 ...
 protected:
  ...
  void CreateAndShowBubble() {
    ...
    bubble_ = new MockPresearchTranslateBubbleView(
  ...
  MockPresearchTranslateBubbleView* bubble_;
  base::test::ScopedFeatureList scoped_feature_list_;
};

TEST_F(PresearchTranslateBubbleViewTest, PresearchBeforeTranslateView) {
  CreateAndShowBubble();
...
TEST_F(PresearchTranslateBubbleViewTest, TranslateButton) {
  CreateAndShowBubble();
...
TEST_F(PresearchTranslateBubbleViewTest, CancelButton) {
  CreateAndShowBubble();
...
TEST_F(PresearchTranslateBubbleViewTest, ReturnKey) {
  CreateAndShowBubble();
  EXPECT_FALSE(mock_model_->translate_called_);
  EXPECT_FALSE(bubble_->install_google_translate_called());
