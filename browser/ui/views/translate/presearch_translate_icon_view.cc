...
PresearchTranslateIconView::PresearchTranslateIconView(
...
void PresearchTranslateIconView::InstallGoogleTranslate() {
  if (!GetWebContents())
    return;
  ...
  scoped_refptr<extensions::WebstoreInstallWithPrompt> installer =
        new extensions::WebstoreInstallWithPrompt(
            ...
            base::BindOnce(&PresearchTranslateIconView::OnInstallResult,
              weak_ptr_factory_.GetWeakPtr()));
  installer->BeginInstall();
}

void PresearchTranslateIconView::OnInstallResult(
    bool success,
...
void PresearchTranslateIconView::UpdateImpl() {
  if (!GetWebContents())
    return;
