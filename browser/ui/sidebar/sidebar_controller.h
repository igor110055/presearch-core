...
#ifndef PRESEARCH_BROWSER_UI_SIDEBAR_SIDEBAR_CONTROLLER_H_
#define PRESEARCH_BROWSER_UI_SIDEBAR_SIDEBAR_CONTROLLER_H_
...
class SidebarController : public SidebarService::Observer {
 public:
  SidebarController(PresearchBrowser* browser, Profile* profile);
...
#endif  // PRESEARCH_BROWSER_UI_SIDEBAR_SIDEBAR_CONTROLLER_H_
