...
class SidebarBrowserTest : public InProcessBrowserTest,
 ...
 public:
  ...
  PresearchBrowser* presearch_browser() {
    return static_cast<PresearchBrowser*>(browser());
  }
  ...
  SidebarController* controller() {
    return presearch_browser()->sidebar_controller();
  }
...
IN_PROC_BROWSER_TEST_F(SidebarBrowserTest, BasicTest) {
  ...
  ui_test_utils::NavigateToURL(browser(), GURL("presearch://newtab/"));
