...
PresearchTabStripModel::PresearchTabStripModel(TabStripModelDelegate* delegate,
                                       Profile* profile)
    : TabStripModel(delegate, profile) {}
PresearchTabStripModel::~PresearchTabStripModel() {}

void PresearchTabStripModel::SelectRelativeTab(bool forward,
...
void PresearchTabStripModel::SelectMRUTab(bool forward, UserGestureDetails detail) {
  if (mru_cycle_list_.empty()) {
    ...
    static_cast<PresearchBrowserWindow*>(browser->window())->StartTabCycling();
  }
...
void PresearchTabStripModel::StopMRUCycling() {
