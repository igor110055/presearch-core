...
using PresearchTabStripModelTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(PresearchTabStripModelTest, MRUCyclingBasic) {
...
IN_PROC_BROWSER_TEST_F(PresearchTabStripModelTest, TabClosingWhileMRUCycling) {
  // Activate MRU cycling
  browser()->profile()->GetPrefs()->SetBoolean(kMRUCyclingEnabled, true);
