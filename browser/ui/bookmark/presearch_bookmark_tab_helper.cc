...
PresearchBookmarkTabHelper::PresearchBookmarkTabHelper(
...
void PresearchBookmarkTabHelper::AddObserver(BookmarkTabHelperObserver* observer) {
  BookmarkTabHelper::FromWebContents(web_contents_)->AddObserver(observer);
}

void PresearchBookmarkTabHelper::RemoveObserver(
    BookmarkTabHelperObserver* observer) {
  BookmarkTabHelper::FromWebContents(web_contents_)->RemoveObserver(observer);
}

bool PresearchBookmarkTabHelper::ShouldShowBookmarkBar() {
...
WEB_CONTENTS_USER_DATA_KEY_IMPL(PresearchBookmarkTabHelper)
