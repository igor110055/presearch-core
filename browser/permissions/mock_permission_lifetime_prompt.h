...
#ifndef PRESEARCH_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
#define PRESEARCH_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
...
#endif  // PRESEARCH_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
