...
#ifndef PRESEARCH_BROWSER_TOR_TOR_PROFILE_SERVICE_FACTORY_H_
#define PRESEARCH_BROWSER_TOR_TOR_PROFILE_SERVICE_FACTORY_H_
...
#endif  // PRESEARCH_BROWSER_TOR_TOR_PROFILE_SERVICE_FACTORY_H_
