...
#ifndef PRESEARCH_BROWSER_TOR_TOR_PROFILE_MANAGER_H_
#define PRESEARCH_BROWSER_TOR_TOR_PROFILE_MANAGER_H_
...
#endif  // PRESEARCH_BROWSER_TOR_TOR_PROFILE_MANAGER_H_
