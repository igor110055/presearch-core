...
class PresearchNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  PresearchNetworkDelegateBrowserTest()
  ...
  void DefaultBlockThirdPartyCookies() {
    presearch_shields::SetCookieControlType(
        content_settings(), presearch_shields::ControlType::BLOCK_THIRD_PARTY,
        GURL());
  }
  ...
  void AllowCookies(const GURL url) {
    presearch_shields::SetCookieControlType(content_settings(),
                                        presearch_shields::ControlType::ALLOW, url);
  }

  void BlockThirdPartyCookies(const GURL url) {
    presearch_shields::SetCookieControlType(
        content_settings(), presearch_shields::ControlType::BLOCK_THIRD_PARTY, url);
  }

  void BlockCookies(const GURL url) {
    presearch_shields::SetCookieControlType(content_settings(),
                                        presearch_shields::ControlType::BLOCK, url);
  }

  void ShieldsDown(const GURL url) {
    presearch_shields::SetPresearchShieldsEnabled(content_settings(), false, url);
  }
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBrowserTest, Iframe3PCookieBlocked) {
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBrowserTest, Iframe3PCookieAllowed) {
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBrowserTest, Iframe3PShieldsDown) {
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBrowserTest, DefaultCookiesBlocked) {
