...
using presearch::RemoveTrackableSecurityHeadersForThirdParty;
using presearch::TrackableSecurityHeaders;
...
class PresearchNetworkDelegateBaseTest : public testing::Test {
 public:
  PresearchNetworkDelegateBaseTest()
      : task_environment_(content::BrowserTaskEnvironment::IO_MAINLOOP),
        context_(new net::TestURLRequestContext(true)) {}
  ~PresearchNetworkDelegateBaseTest() override {}
...
TEST_F(PresearchNetworkDelegateBaseTest, RemoveTrackableSecurityHeaders) {
...
TEST_F(PresearchNetworkDelegateBaseTest, RemoveTrackableSecurityHeadersMixedCase) {
  net::TestDelegate test_delegate;
  GURL request_url(kThirdPartyDomain);
  GURL tab_url(kFirstPartyDomain);
...
TEST_F(PresearchNetworkDelegateBaseTest, RetainTrackableSecurityHeaders) {
  net::TestDelegate test_delegate;
