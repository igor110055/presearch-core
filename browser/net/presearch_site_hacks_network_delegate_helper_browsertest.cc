...
class PresearchSiteHacksNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  PresearchSiteHacksNetworkDelegateBrowserTest()
...
IN_PROC_BROWSER_TEST_F(PresearchSiteHacksNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(PresearchSiteHacksNetworkDelegateBrowserTest,
  ...
  for (size_t i = 0; i < input_count; i++) {
    ...
    presearch_shields::SetPresearchShieldsEnabled(content_settings(), false, dest_url);
