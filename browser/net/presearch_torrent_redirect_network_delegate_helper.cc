...
bool IsWebtorrentInitiated(std::shared_ptr<presearch::PresearchRequestInfo> ctx) {
  return ctx->initiator_url.scheme() == extensions::kExtensionScheme &&
      ctx->initiator_url.host() == presearch_webtorrent_extension_id;
}
...
bool IsMainFrameResource(std::shared_ptr<presearch::PresearchRequestInfo> ctx) {
...
int OnHeadersReceived_TorrentRedirectWork(
  ...
  *override_response_headers =
  ...
  GURL url(
      ...
      "/extension/presearch_webtorrent2.html?",
