...
#ifndef PRESEARCH_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
#define PRESEARCH_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
...
class ResourceContextData : public base::SupportsUserData::Data {
 public:
  ...
  static PresearchProxyingWebSocket* StartProxyingWebSocket(
  ...
  void RemoveProxy(PresearchProxyingURLLoaderFactory* proxy);
  void RemoveProxyWebSocket(PresearchProxyingWebSocket* proxy);

 private:
  ResourceContextData();

  std::unique_ptr<PresearchRequestHandler> request_handler_;
  scoped_refptr<RequestIDGenerator> request_id_generator_;

  std::set<std::unique_ptr<PresearchProxyingURLLoaderFactory>,
           base::UniquePtrComparator>
      proxies_;

  std::set<std::unique_ptr<PresearchProxyingWebSocket>,
           base::UniquePtrComparator>
      websocket_proxies_;
...
#endif  // PRESEARCH_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
