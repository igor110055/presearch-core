...
#ifndef PRESEARCH_BROWSER_NET_PRESEARCH_PROXYING_URL_LOADER_FACTORY_H_
#define PRESEARCH_BROWSER_NET_PRESEARCH_PROXYING_URL_LOADER_FACTORY_H_
...
class PresearchProxyingURLLoaderFactory
    : public network::mojom::URLLoaderFactory {
 public:
  using DisconnectCallback =
      base::OnceCallback<void(PresearchProxyingURLLoaderFactory*)>;
  ...
  class InProgressRequest : public network::mojom::URLLoader,
   ...
   private:
    ...
    std::shared_ptr<presearch::PresearchRequestInfo> ctx_;
    PresearchProxyingURLLoaderFactory* const factory_;
  ...
  PresearchProxyingURLLoaderFactory(
  ...
  ~PresearchProxyingURLLoaderFactory() override;
 ...
 private:
  friend class base::DeleteHelper<PresearchProxyingURLLoaderFactory>;
  friend class base::RefCountedDeleteOnSequence<PresearchProxyingURLLoaderFactory>;
  ...
  PresearchRequestHandler* const request_handler_;
  content::BrowserContext* browser_context_;
  const int render_process_id_;
  const int frame_tree_node_id_;
  ...
  base::WeakPtrFactory<PresearchProxyingURLLoaderFactory> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(PresearchProxyingURLLoaderFactory);
};

#endif  // PRESEARCH_BROWSER_NET_PRESEARCH_PROXYING_URL_LOADER_FACTORY_H_
