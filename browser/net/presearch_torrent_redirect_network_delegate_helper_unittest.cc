...
class PresearchTorrentRedirectNetworkDelegateHelperTest : public testing::Test {
 public:
  PresearchTorrentRedirectNetworkDelegateHelperTest() {
    ...
    torrent_extension_url_ = GURL(
        ...
        "presearch_webtorrent2.html?https://webtorrent.io/torrents/sintel.torrent");
    ...
    non_torrent_extension_url_ = GURL(
        "chrome-extension://lgjmpdmojkpocjcopdikifhejkkjglho/extension/"
        "presearch_webtorrent2.html?https://webtorrent.io/torrents/sintel");
  }
...
TEST_F(PresearchTorrentRedirectNetworkDelegateHelperTest,
  ...
  auto request_info = std::make_shared<presearch::PresearchRequestInfo>(torrent_url());
...
TEST_F(PresearchTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<presearch::PresearchRequestInfo>(non_torrent_url());
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
...
TEST_F(PresearchTorrentRedirectNetworkDelegateHelperTest, MimeTypeNoRedirect) {
  scoped_refptr<net::HttpResponseHeaders> orig_response_headers =
      new net::HttpResponseHeaders(std::string());
...
TEST_F(PresearchTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<presearch::PresearchRequestInfo>(torrent_viewer_url());
  request_info->initiator_url = torrent_extension_url();
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
