...
#ifndef PRESEARCH_BROWSER_NET_PRESEARCH_PROXYING_WEB_SOCKET_H_
#define PRESEARCH_BROWSER_NET_PRESEARCH_PROXYING_WEB_SOCKET_H_
...
// Ensures that all web socket requests go through Presearch network request
// handling framework. Cargoculted from |WebRequestProxyingWebSocket|.
class PresearchProxyingWebSocket
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(PresearchProxyingWebSocket*)>;

  PresearchProxyingWebSocket(
  ...
  ~PresearchProxyingWebSocket() override;

  static PresearchProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<PresearchProxyingWebSocket> weak_factory_{this};
  DISALLOW_COPY_AND_ASSIGN(PresearchProxyingWebSocket);
};

#endif  // PRESEARCH_BROWSER_NET_PRESEARCH_PROXYING_WEB_SOCKET_H_
