...
#include "presearch/components/presearch_shields/browser/adblock_stub_response.h"
...
PresearchProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    FollowRedirectParams() = default;
PresearchProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    ~FollowRedirectParams() = default;

PresearchProxyingURLLoaderFactory::InProgressRequest::InProgressRequest(
    PresearchProxyingURLLoaderFactory* factory,
    uint64_t request_id,
  ...
  target_client_.set_disconnect_handler(base::BindOnce(
      &PresearchProxyingURLLoaderFactory::InProgressRequest::OnRequestError,
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::Restart() {
  UpdateRequestInfo();
  RestartInternal();
}

void PresearchProxyingURLLoaderFactory::InProgressRequest::UpdateRequestInfo() {
  // TODO(iefremov): Update |ctx_| here and get rid of multiple spots where
  // it is refilled.
}

void PresearchProxyingURLLoaderFactory::InProgressRequest::RestartInternal() {
  ...
  base::RepeatingCallback<void(int)> continuation =
      base::BindRepeating(&InProgressRequest::ContinueToBeforeSendHeaders,
                          weak_factory_.GetWeakPtr());
  redirect_url_ = GURL();
  ctx_ = presearch::PresearchRequestInfo::MakeCTX(request_, render_process_id_,
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::FollowRedirect(
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::SetPriority(
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::OnReceiveResponse(
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::OnReceiveRedirect(
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::OnUploadProgress(
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::OnReceiveCachedMetadata(
    mojo_base::BigBuffer data) {
  target_client_->OnReceiveCachedMetadata(std::move(data));
}

void PresearchProxyingURLLoaderFactory::InProgressRequest::OnTransferSizeUpdated(
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::OnComplete(
    const network::URLLoaderCompletionStatus& status) {
  UMA_HISTOGRAM_TIMES("Presearch.ProxyingURLLoader.TotalRequestTime",
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::
  ...
  if (ctx_->blocked_by != presearch::kNotBlocked) {
    ...
    presearch_shields::MakeStubResponse(ctx_->mock_data_url, request_, &response,
                                    &response_data);
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::ContinueToStartRequest(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::ContinueToSendHeaders(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::ContinueToBeforeRedirect(
    const net::RedirectInfo& redirect_info,
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
...
void PresearchProxyingURLLoaderFactory::InProgressRequest::OnRequestError(
    const network::URLLoaderCompletionStatus& status) {
...
PresearchProxyingURLLoaderFactory::PresearchProxyingURLLoaderFactory(
    PresearchRequestHandler* request_handler,
    content::BrowserContext* browser_context,
    int render_process_id,
    int frame_tree_node_id,
  ...
  target_factory_.set_connection_error_handler(
      base::BindOnce(&PresearchProxyingURLLoaderFactory::OnTargetFactoryError,
                     base::Unretained(this)));

  proxy_receivers_.Add(this, std::move(receiver));
  proxy_receivers_.set_disconnect_handler(
      base::BindRepeating(&PresearchProxyingURLLoaderFactory::OnProxyBindingError,
                          base::Unretained(this)));
}

PresearchProxyingURLLoaderFactory::~PresearchProxyingURLLoaderFactory() = default;

// static
bool PresearchProxyingURLLoaderFactory::MaybeProxyRequest(
    content::BrowserContext* browser_context,
...
void PresearchProxyingURLLoaderFactory::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader_receiver,
    int32_t routing_id,
    int32_t request_id,
    uint32_t options,
  ...
  const uint64_t presearch_request_id = request_id_generator_->Generate();

  auto result = requests_.emplace(std::make_unique<InProgressRequest>(
      this, presearch_request_id, request_id, routing_id, render_process_id_,
...
void PresearchProxyingURLLoaderFactory::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver) {
  proxy_receivers_.Add(this, std::move(loader_receiver));
}

void PresearchProxyingURLLoaderFactory::OnTargetFactoryError() {
...
void PresearchProxyingURLLoaderFactory::OnProxyBindingError() {
...
void PresearchProxyingURLLoaderFactory::RemoveRequest(InProgressRequest* request) {
...
void PresearchProxyingURLLoaderFactory::MaybeRemoveProxy() {
