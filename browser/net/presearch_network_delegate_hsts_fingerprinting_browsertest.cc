...
class PresearchNetworkDelegateBaseBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBaseBrowserTest, FirstPartySTS) {
...
IN_PROC_BROWSER_TEST_F(PresearchNetworkDelegateBaseBrowserTest, ThirdPartySTS) {
  const GURL third_party =
      embedded_test_server()->GetURL("c.com", "/iframe_hsts.html");
