...
using PresearchResourcesBrowserTest = InProcessBrowserTest;

// Check presearch's theme resources pacakges are properly added.
IN_PROC_BROWSER_TEST_F(PresearchResourcesBrowserTest, ResourceExistanceTest) {
