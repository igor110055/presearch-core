...
#ifndef PRESEARCH_BROWSER_RENDERER_CONTEXT_MENU_PRESEARCH_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
#define PRESEARCH_BROWSER_RENDERER_CONTEXT_MENU_PRESEARCH_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
...
class PresearchMockRenderViewContextMenu;
class PrefService;
class Profile;
...
// MenuObserver class.
class PresearchMockRenderViewContextMenu : public ui::SimpleMenuModel::Delegate,
 ...
 public:
  ...
  explicit PresearchMockRenderViewContextMenu(Profile* profile);
  ~PresearchMockRenderViewContextMenu() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PresearchMockRenderViewContextMenu);
};

#endif  // PRESEARCH_BROWSER_RENDERER_CONTEXT_MENU_PRESEARCH_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
