...
// accesses resources.
class PresearchSpellingMenuObserverTest : public InProcessBrowserTest {
 public:
  PresearchSpellingMenuObserverTest();
  ...
  ~PresearchSpellingMenuObserverTest() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PresearchSpellingMenuObserverTest);
};

PresearchSpellingMenuObserverTest::PresearchSpellingMenuObserverTest() {}

PresearchSpellingMenuObserverTest::~PresearchSpellingMenuObserverTest() {}

}  // namespace

// Tests that right-clicking not add "Ask Presearch for suggestions".
IN_PROC_BROWSER_TEST_F(PresearchSpellingMenuObserverTest,
