...
#include "presearch/browser/extensions/presearch_base_local_data_files_browsertest.h"
...
class PresearchEnumerateDevicesFarblingBrowserTest : public InProcessBrowserTest {
 public:
  PresearchEnumerateDevicesFarblingBrowserTest()
  ...
  PresearchEnumerateDevicesFarblingBrowserTest(
      const PresearchEnumerateDevicesFarblingBrowserTest&) = delete;
  PresearchEnumerateDevicesFarblingBrowserTest& operator=(
      const PresearchEnumerateDevicesFarblingBrowserTest&) = delete;

  ~PresearchEnumerateDevicesFarblingBrowserTest() override {}
...
IN_PROC_BROWSER_TEST_F(PresearchEnumerateDevicesFarblingBrowserTest,
