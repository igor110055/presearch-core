...
class PresearchDeviceMemoryFarblingBrowserTest : public InProcessBrowserTest {
 public:
  PresearchDeviceMemoryFarblingBrowserTest()
  ...
  PresearchDeviceMemoryFarblingBrowserTest(
      const PresearchDeviceMemoryFarblingBrowserTest&) = delete;
  PresearchDeviceMemoryFarblingBrowserTest& operator=(
      const PresearchDeviceMemoryFarblingBrowserTest&) = delete;

  ~PresearchDeviceMemoryFarblingBrowserTest() override {}
...
IN_PROC_BROWSER_TEST_F(PresearchDeviceMemoryFarblingBrowserTest,
                       FarbleDeviceMemory) {
