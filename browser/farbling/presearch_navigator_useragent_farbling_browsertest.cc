...
class PresearchNavigatorUserAgentFarblingBrowserTest : public InProcessBrowserTest {
 public:
  void SetUpOnMainThread() override {
    ...
    embedded_test_server()->RegisterRequestMonitor(base::BindRepeating(
        &PresearchNavigatorUserAgentFarblingBrowserTest::MonitorHTTPRequest,
...
IN_PROC_BROWSER_TEST_F(PresearchNavigatorUserAgentFarblingBrowserTest,
