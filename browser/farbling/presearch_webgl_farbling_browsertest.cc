...
class PresearchWebGLFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(PresearchWebGLFarblingBrowserTest, FarbleGetParameterWebGL) {
...
IN_PROC_BROWSER_TEST_F(PresearchWebGLFarblingBrowserTest,
