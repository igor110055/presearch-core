...
#include "presearch/components/speedreader/speedreader_switches.h"
...
// disabled in https://github.com/presearch/presearch-browser/issues/11328
IN_PROC_BROWSER_TEST_F(SpeedReaderBrowserTest, DISABLED_SmokeTest) {
  ...
  const char kGetStyleLength[] =
      "document.getElementById(\"presearch_speedreader_style\").innerHTML.length";
