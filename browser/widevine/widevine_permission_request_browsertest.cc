...
#include "presearch/browser/widevine/widevine_permission_request.h"
...
class WidevinePermissionRequestBrowserTest
 ...
 public:
  ...
  PresearchDrmTabHelper* GetPresearchDrmTabHelper() {
    return PresearchDrmTabHelper::FromWebContents(GetActiveWebContents());
  }
...
IN_PROC_BROWSER_TEST_F(WidevinePermissionRequestBrowserTest, VisibilityTest) {
  ...
  auto* drm_tab_helper = GetPresearchDrmTabHelper();
...
IN_PROC_BROWSER_TEST_F(WidevinePermissionRequestBrowserTest, BubbleTest) {
  ...
  GetPresearchDrmTabHelper()->OnWidevineKeySystemAccessRequest();
  content::RunAllTasksUntilIdle();
...
IN_PROC_BROWSER_TEST_F(WidevinePermissionRequestBrowserTest,
  ...
  GetPresearchDrmTabHelper()->OnEvent(
