...
class PresearchPolicyTest : public InProcessBrowserTest {
 protected:
  PresearchPolicyTest() {}
  ~PresearchPolicyTest() override {}
...
class TorDisabledPolicyBrowserTest : public PresearchPolicyTest {
 public:
  TorDisabledPolicyBrowserTest() {}
  ~TorDisabledPolicyBrowserTest() override {}

  void SetUpInProcessBrowserTestFixture() override {
    PresearchPolicyTest::SetUpInProcessBrowserTestFixture();
...
class TorEnabledPolicyBrowserTest : public PresearchPolicyTest {
 public:
...
class BrowserAddPersonPolicyTest : public PresearchPolicyTest {
 public:
...
template <bool enable>
class BrowserGuestModePolicyTest : public PresearchPolicyTest {
 public:
