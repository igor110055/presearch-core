...
#ifndef PRESEARCH_BROWSER_IPFS_IPFS_SERVICE_FACTORY_H_
#define PRESEARCH_BROWSER_IPFS_IPFS_SERVICE_FACTORY_H_
...
#endif  // PRESEARCH_BROWSER_IPFS_IPFS_SERVICE_FACTORY_H_
