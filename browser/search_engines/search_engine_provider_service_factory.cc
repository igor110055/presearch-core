...
#include "presearch/browser/search_engines/private_window_search_engine_provider_service.h"
#include "presearch/browser/search_engines/search_engine_provider_util.h"
#include "presearch/browser/search_engines/tor_window_search_engine_provider_service.h"
...
KeyedService* InitializeSearchEngineProviderServiceIfNeeded(Profile* profile) {
  ...
  if (presearch::IsGuestProfile(profile) && profile->IsOffTheRecord()) {
