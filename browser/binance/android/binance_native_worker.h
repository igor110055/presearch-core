...
#ifndef PRESEARCH_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
#define PRESEARCH_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
...
#endif  // PRESEARCH_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
