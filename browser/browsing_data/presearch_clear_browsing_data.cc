...
class BrowsingDataRemovalWatcher
 ...
 public:
  ...
  void ClearBrowsingDataForLoadedProfiles(
      PresearchClearBrowsingData::OnExitTestingCallback* testing_callback);
...
bool BrowsingDataRemovalWatcher::GetClearBrowsingDataOnExitSettings(
  ...
  *origin_mask = 0;
  ...
  // Note: this will also delete Presearch Shields site-specific settings.
...
PresearchClearBrowsingData::OnExitTestingCallback*
    PresearchClearBrowsingData::on_exit_testing_callback_ = nullptr;

// static
void PresearchClearBrowsingData::ClearOnExit() {
  TRACE_EVENT0("browser", "PresearchClearBrowsingData::ClearOnExit");
...
// static
void PresearchClearBrowsingData::SetOnExitTestingCallback(
