...
#ifndef PRESEARCH_BROWSER_THEMES_THEME_PROPERTIES_H_
#define PRESEARCH_BROWSER_THEMES_THEME_PROPERTIES_H_
...
enum ThemeProperties {
  PRESEARCH_THEME_PROPERTIES_START = 10000,
  COLOR_BOOKMARK_BAR_INSTRUCTIONS_TEXT = PRESEARCH_THEME_PROPERTIES_START,
...
#endif
  PRESEARCH_THEME_PROPERTIES_LAST = COLOR_SIDEBAR_SEPARATOR,
};
...
#endif  // PRESEARCH_BROWSER_THEMES_THEME_PROPERTIES_H_
