...
#include "presearch/browser/themes/theme_properties.h"
...
base::Optional<SkColor> MaybeGetDefaultColorForPresearchLightUi(int id) {
  switch (id) {
    ...
    case PresearchThemeProperties::COLOR_BOOKMARK_BAR_INSTRUCTIONS_TEXT:
    ...
    case PresearchThemeProperties::COLOR_SIDEBAR_BACKGROUND:
      return SkColorSetRGB(0xF3, 0xF3, 0xF5);
    case PresearchThemeProperties::COLOR_SIDEBAR_ARROW_BACKGROUND_HOVERED:
      return SkColorSetRGB(0xE3, 0xE3, 0xE3);
    case PresearchThemeProperties::COLOR_SIDEBAR_ARROW_NORMAL:
      return SkColorSetRGB(0x21, 0x25, 0x29);
    case PresearchThemeProperties::COLOR_SIDEBAR_ARROW_DISABLED:
      return SkColorSetARGB(0x8A, 0x49, 0x50, 0x57);
    case PresearchThemeProperties::COLOR_SIDEBAR_BUTTON_BASE:
      return SkColorSetRGB(0x49, 0x50, 0x57);
    case PresearchThemeProperties::COLOR_SIDEBAR_ADD_BUTTON_DISABLED:
      return SkColorSetARGB(0X66, 0x49, 0x50, 0x57);
    case PresearchThemeProperties::COLOR_SIDEBAR_BORDER:
      return SkColorSetRGB(0xD5, 0xD5, 0xDC);
    case PresearchThemeProperties::COLOR_SIDEBAR_PANEL_BORDER:
      return SkColorSetARGB(0x21, 0x00, 0x00, 0x00);
    case PresearchThemeProperties::COLOR_SIDEBAR_ITEM_BACKGROUND:
      return SkColorSetRGB(0xE8, 0xE8, 0xE8);
    case PresearchThemeProperties::COLOR_SIDEBAR_ITEM_DRAG_INDICATOR_COLOR:
      return SkColorSetRGB(0x21, 0x25, 0x29);
    case PresearchThemeProperties::COLOR_SIDEBAR_SEPARATOR:
      return SkColorSetRGB(0xE6, 0xE8, 0xF5);
    case PresearchThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_BACKGROUND:
      return SK_ColorWHITE;
    case PresearchThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_HEADER_TEXT:
      return SkColorSetRGB(0x17, 0x17, 0x1F);
    case PresearchThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_ITEM_TEXT_NORMAL:
      return SkColorSetRGB(0x21, 0x25, 0x29);
    case PresearchThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_ITEM_TEXT_HOVERED:
      return SkColorSetRGB(0xF0, 0xF2, 0xFF);
    case PresearchThemeProperties::
        COLOR_SIDEBAR_ADD_BUBBLE_ITEM_TEXT_BACKGROUND_HOVERED:
      return SkColorSetRGB(0x4C, 0x54, 0xD2);
#endif
    case PresearchThemeProperties::COLOR_FOR_TEST:
      return PresearchThemeProperties::kLightColorForTest;
    default:
      return base::nullopt;
  }
}
...
base::Optional<SkColor> MaybeGetDefaultColorForPresearchDarkUi(int id) {
  switch (id) {
    // Applies when the window is active, tabs and also tab bar everywhere
    // except active tab
    case ThemeProperties::COLOR_FRAME_ACTIVE:
...
#endif
    case PresearchThemeProperties::COLOR_FOR_TEST:
      return PresearchThemeProperties::kDarkColorForTest;
    default:
      return base::nullopt;
  }
}
...
#endif
    case PresearchThemeProperties::COLOR_FOR_TEST:
      return PresearchThemeProperties::kPrivateColorForTest;
    // The rest is covered by a dark-appropriate value
    default:
      return MaybeGetDefaultColorForPresearchDarkUi(id);
  }
}
...
namespace PresearchThemeProperties {

bool IsPresearchThemeProperties(int id) {
  return id >= PRESEARCH_THEME_PROPERTIES_START &&
         id <= PRESEARCH_THEME_PROPERTIES_LAST;
}

}  // namespace PresearchThemeProperties
// Returns a |nullopt| if the UI color is not handled by Presearch.
base::Optional<SkColor> MaybeGetDefaultColorForPresearchUi(
    int id, bool incognito,
    bool is_tor, dark_mode::PresearchDarkModeType dark_mode) {
  ...
  switch (dark_mode) {
    case dark_mode::PresearchDarkModeType::PRESEARCH_DARK_MODE_TYPE_LIGHT:
      return MaybeGetDefaultColorForPresearchLightUi(id);
    case dark_mode::PresearchDarkModeType::PRESEARCH_DARK_MODE_TYPE_DARK:
      return MaybeGetDefaultColorForPresearchDarkUi(id);
    default:
      NOTREACHED();
  }
