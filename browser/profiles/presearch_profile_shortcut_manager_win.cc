...
#include "presearch/browser/profiles/presearch_profile_shortcut_manager_win.h"

#include "presearch/browser/profiles/profile_util.h"
#include "chrome/browser/profiles/profile_attributes_storage.h"
#include "chrome/browser/profiles/profile_manager.h"

PresearchProfileShortcutManagerWin::PresearchProfileShortcutManagerWin(
    ProfileManager* manager)
    : ProfileShortcutManagerWin(manager),
      profile_manager_(manager) {}

void PresearchProfileShortcutManagerWin::GetShortcutProperties(
  ...
  // this override.
  if (presearch::IsSessionProfilePath(profile_path)) {
