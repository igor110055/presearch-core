...
PresearchProfileImpl::PresearchProfileImpl(
  ...
  if (presearch::IsSessionProfilePath(path) &&
    ...
    auto* parent_profile = presearch::CreateParentProfileData(this);
...
void PresearchProfileImpl::OnProfileWillBeDestroyed(Profile* profile) {
