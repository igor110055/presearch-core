...
void ExtensionRewardsServiceObserver::OnRewardsInitialized(
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::Initialized::Create(0).release());

  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::Initialized::kEventName,
      std::move(args)));
...
void ExtensionRewardsServiceObserver::OnPanelPublisherInfo(
  ...
  extensions::api::presearch_rewards::OnPublisherData::Publisher publisher;
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnPublisherData::Create(windowId,
                                                              publisher)
          .release());

  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_ON_PUBLISHER_DATA,
      extensions::api::presearch_rewards::OnPublisherData::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnFetchPromotions(
  ...
  std::vector<extensions::api::presearch_rewards::OnPromotions::
        PromotionsType> promotions;

  for (const auto& item : list) {
    promotions.push_back(
        extensions::api::presearch_rewards::OnPromotions::PromotionsType());
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnPromotions::Create(
          static_cast<int>(result), promotions)
            .release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnPromotions::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnPromotionFinished(
  ...
  extensions::api::presearch_rewards::OnPromotionFinish::
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnPromotionFinish::Create
      (static_cast<int>(result), promotion_api).release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnPromotionFinish::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnAdsEnabled(
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnAdsEnabled::Create(
          ads_enabled).release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnAdsEnabled::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnPendingContributionSaved(
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnPendingContributionSaved::Create(
          static_cast<int>(result)).release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnPendingContributionSaved::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnPublisherListNormalized(
  ...
  std::vector<extensions::api::presearch_rewards::OnPublisherListNormalized::
        PublishersType> publishers;

  for (const auto& item : list) {
    publishers.push_back(
        extensions::api::presearch_rewards::OnPublisherListNormalized::
        PublishersType());
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::
      OnPublisherListNormalized::Create(publishers)
          .release());

  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnPublisherListNormalized::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnExcludedSitesChanged(
  ...
  extensions::api::presearch_rewards::OnExcludedSitesChanged::Properties result;
  result.publisher_key = publisher_key;
  result.excluded = excluded;

  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnExcludedSitesChanged::Create(result)
          .release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnExcludedSitesChanged::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnRecurringTipSaved(
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnRecurringTipSaved::Create(
          success).release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnRecurringTipSaved::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnRecurringTipRemoved(
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnRecurringTipRemoved::Create(
          success).release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnRecurringTipRemoved::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnPendingContributionRemoved(
  ...
  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnPendingContributionRemoved::Create(
          static_cast<int>(result)).release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnPendingContributionRemoved::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnReconcileComplete(
  ...
  extensions::api::presearch_rewards::OnReconcileComplete::Properties properties;
  properties.result = static_cast<int>(result);
  properties.type = static_cast<int>(type);

  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnReconcileComplete::Create(properties)
          .release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnReconcileComplete::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnDisconnectWallet(
  ...
  extensions::api::presearch_rewards::OnDisconnectWallet::Properties properties;
  properties.result = static_cast<int>(result);
  properties.wallet_type = wallet_type;

  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnDisconnectWallet::Create(properties)
          .release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnDisconnectWallet::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnUnblindedTokensReady(
  ...
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnUnblindedTokensReady::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
...
void ExtensionRewardsServiceObserver::OnCompleteReset(const bool success) {
  ...
  extensions::api::presearch_rewards::OnCompleteReset::Properties properties;
  properties.success = success;

  std::unique_ptr<base::ListValue> args(
      extensions::api::presearch_rewards::OnCompleteReset::Create(properties)
          .release());
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::PRESEARCH_START,
      extensions::api::presearch_rewards::OnCompleteReset::kEventName,
      std::move(args)));
  event_router->BroadcastEvent(std::move(event));
}
