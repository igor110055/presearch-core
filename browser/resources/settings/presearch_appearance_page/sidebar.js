...
/**
 * 'settings-presearch-appearance-sidebar' is the settings page area containing
 * presearch's sidebar settings in appearance settings.
 * This is separated from 'settings-presearch-appearance-toolbar' because sidebar
 * option is located below the home button option.
 */
Polymer({
  is: 'settings-presearch-appearance-sidebar',
  ...
  getCurrentSidebarOption_: function() {
    return this.get('prefs.presearch.sidebar.sidebar_show_option.value');
  },
});
