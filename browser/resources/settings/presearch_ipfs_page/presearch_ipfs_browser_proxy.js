...
/** @interface */
export class PresearchIPFSBrowserProxy {
  /**
...
/**
 * @implements {settings.PresearchIPFSBrowserProxy}
 */
export class PresearchIPFSBrowserProxyImpl {
  setIPFSCompanionEnabled (value) {
...
cr.addSingletonGetter(PresearchIPFSBrowserProxyImpl)
