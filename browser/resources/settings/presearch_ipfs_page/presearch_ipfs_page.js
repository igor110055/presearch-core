 ...
 */
Polymer({
  is: 'settings-presearch-ipfs-page',
   ...
   * in presearch\components\ipfs\ipfs_constants.h */
  ...
  /** @private {?settings.PresearchIPFSBrowserProxy} */
  browserProxy_: null,
  ...
  /** @override */
  created: function() {
    this.browserProxy_ = settings.PresearchIPFSBrowserProxyImpl.getInstance();
  },
  ...
  onLoad_: function() {
    const resolve_method = this.getPref('presearch.ipfs.resolve_method').value;
    ...
    this.$.ipfsStorageMax.value =
      this.getPref('presearch.ipfs.storage_max').value;
  },
