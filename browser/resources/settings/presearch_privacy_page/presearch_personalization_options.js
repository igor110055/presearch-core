...
Polymer({
  is: 'settings-presearch-personalization-options',
  ...
  /** @private {?settings.PresearchPrivacyBrowserProxy} */
  browserProxy_: null,

  /** @override */
  created: function() {
    this.browserProxy_ = settings.PresearchPrivacyBrowserProxyImpl.getInstance();
  },
