...
function getPageVisibility () {
  ...
  // which hides most sections, and add presearch sections to hide.
  if (loadTimeData.getBoolean('isGuest')) {
    // Hide appropriate presearch sections as well as chromium ones
    return {
  ...
  // would like to hide.
  // See presearch/browser/settings/presearch_overrides/basic_page.js for presearch's list,
  ...
  const staticProps = {
    ...
    // custom properties
    presearchSync: !loadTimeData.getBoolean('isSyncDisabled'),
  }
