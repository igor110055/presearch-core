...
import {RegisterStyleOverride, RegisterPolymerComponentBehaviors} from 'chrome://presearch-resources/polymer_overriding.js'

// TODO: move throttle utility to a chrome://presearch-resources module
  ...
  html`
    <style>
      :host {
        ...
        --presearch-settings-content-max-width: 708px;
        --presearch-settings-menu-width: var(--settings-menu-width);
        --presearch-settings-menu-margin: 12px;
      }
      cr-drawer {
      ...
      #left {
        /* fixed size menu */
        flex: 0 0 calc(var(--settings-menu-width) + var(--presearch-settings-menu-margin) * 2)  !important;
      }
      #main {
        /* Take up rest of container up to a max */
        flex: 0 1 var(--presearch-settings-content-max-width) !important;
      }
      #right {
...
const PresearchClearSettingsMenuHighlightBehavior = {
  ready: function() {
...
RegisterPolymerComponentBehaviors({
  'settings-ui': [
    PresearchClearSettingsMenuHighlightBehavior
  ]
})
