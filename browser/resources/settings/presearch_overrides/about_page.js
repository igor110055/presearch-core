...
RegisterPolymerTemplateModifications({
  'settings-about-page': (templateContent) => {
    ...
    if (!section.querySelector('a#release-notes')) {
      ...
      wrapper.setAttribute('href', 'https://presearch.com/latest/')
    ...
    if (updateStatusMessageLink) {
      // <if expr="is_win">
      updateStatusMessageLink.href = 'https://support.presearch.com/hc/en-us/articles/360042816611-Why-isn-t-Presearch-updating-automatically-on-Windows-'
      // </if>

      // <if expr="not is_win">
      updateStatusMessageLink.href = 'https://community.presearch.com?p=update_error'
      // </if>
    }
  }
})
