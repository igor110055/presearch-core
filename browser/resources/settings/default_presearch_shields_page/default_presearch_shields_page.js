...
/**
 * 'settings-default-presearch-shields-page' is the settings page containing presearch's
 * default shields.
 */
Polymer({
  is: 'settings-default-presearch-shields-page',
  ...
  /** @private {?settings.DefaultPresearchShieldsBrowserProxy} */
  browserProxy_: null,

  /** @override */
  created: function() {
    this.browserProxy_ = settings.DefaultPresearchShieldsBrowserProxyImpl.getInstance();
  },
