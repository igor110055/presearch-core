 ...
 */
Polymer({
  is: 'settings-presearch-default-extensions-page',
   ...
   * presearch/componentsdecentralized_dns/constants.h.
   */
  Provider: {
  ...
  /** @private {?settings.PresearchDefaultExtensionsBrowserProxy} */
  browserProxy_: null,

  /** @override */
  created: function() {
    this.browserProxy_ = settings.PresearchDefaultExtensionsBrowserProxyImpl.getInstance();
  },
  ...
  ready: function() {
    ...
    this.addWebUIListener('presearch-needs-restart-changed', (needsRestart) => {
