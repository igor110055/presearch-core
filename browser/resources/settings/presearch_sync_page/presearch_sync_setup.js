...
/**
 * @fileoverview
 * 'presearch-sync-setup' is the UI for starting or joining a sync chain
 * settings.
 */
...
Polymer({
  is: 'settings-presearch-sync-setup',
  ...
  /** @private {?PresearchSyncBrowserProxy} */
  syncBrowserProxy_: null,

  created: function() {
    this.syncBrowserProxy_ = PresearchSyncBrowserProxy.getInstance();
  },
