...
import "./presearch_clear_browsing_data_on_exit_page.js"
...
const PresearchClearBrowsingDataOnExitBehaviorImpl = {
  ...
  addOnExitElements_: function() {
    ...
    let onExitPage = document.createElement(
        'settings-presearch-clear-browsing-data-on-exit-page');
...
export const PresearchClearBrowsingDataOnExitBehavior = [
  I18nBehavior, PresearchClearBrowsingDataOnExitBehaviorImpl
]
