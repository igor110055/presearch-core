...
PresearchWebMainParts::PresearchWebMainParts() {}

PresearchWebMainParts::~PresearchWebMainParts() {}

void PresearchWebMainParts::PreMainMessageLoopStart() {
...
void PresearchWebMainParts::PreCreateThreads() {
...
void PresearchWebMainParts::SetupFieldTrials() {
...
void PresearchWebMainParts::PreMainMessageLoopRun() {
...
void PresearchWebMainParts::PostMainMessageLoopRun() {
  application_context_->StartTearDown();
}

void PresearchWebMainParts::PostDestroyThreads() {
