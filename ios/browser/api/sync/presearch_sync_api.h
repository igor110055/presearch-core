...
#ifndef PRESEARCH_IOS_BROWSER_API_SYNC_PRESEARCH_SYNC_API_H_
#define PRESEARCH_IOS_BROWSER_API_SYNC_PRESEARCH_SYNC_API_H_
...
OBJC_EXPORT
@interface PresearchSyncAPI : NSObject

@property(class, readonly, strong)
    PresearchSyncAPI* sharedSyncAPI NS_SWIFT_NAME(shared);
...
#endif  // PRESEARCH_IOS_BROWSER_API_SYNC_PRESEARCH_SYNC_API_H_
