...
#ifndef PRESEARCH_IOS_BROWSER_API_BOOKMARKS_PRESEARCH_BOOKMARKS_API_H_
#define PRESEARCH_IOS_BROWSER_API_BOOKMARKS_PRESEARCH_BOOKMARKS_API_H_
...
NS_SWIFT_NAME(PresearchBookmarksAPI)
OBJC_EXPORT
@interface PresearchBookmarksAPI : NSObject
@property(class, readonly, getter = sharedBookmarksAPI)
    PresearchBookmarksAPI* shared;
...
#endif  // PRESEARCH_IOS_BROWSER_API_BOOKMARKS_PRESEARCH_BOOKMARKS_API_H_
