...
const char kPresearchTranslateServer[] = "https://"; //NOLINT
const char kPresearchTranslateEndpoint[] = "https://"; // NOLINT
const char kPresearchTranslateLanguageEndpoint[] = "https://"; // NOLINT
const char kPresearchTranslateServerPrefix[] = "https://"; // NOLINT
