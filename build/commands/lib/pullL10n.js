...
const pullL10n = (options) => {
  ...
  cmdOptions.cwd = config.presearchCoreDir
  ...
  // overwritten with modified versions from ./src/presearch during build.
  ...
  l10nUtil.getPresearchTopLevelPaths().forEach((sourceStringPath) => {
