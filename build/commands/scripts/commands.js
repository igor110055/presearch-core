...
program
  ...
  .option('--presearch_google_api_key <presearch_google_api_key>')
  .option('--presearch_google_api_endpoint <presearch_google_api_endpoint>')
  .option('--presearch_infura_project_id <presearch_infura_project_id>')
  ...
  .option('--presearch_safetynet_api_key <presearch_safetynet_api_key>')
...
program
  ...
  .option('--skip_signing', 'skip signing dmg/presearch_installer.exe')
...
program
  ...
  .option('--disable_presearch_extension', 'disable loading the Presearch extension')
  .option('--disable_presearch_rewards_extension', 'disable loading the Presearch Rewards extension')
  ...
  .option('--presearch_ads_staging', 'ads staging')
  .option('--presearch_ads_debug', 'ads debug')
  .option('--single_process', 'use a single process')
  .option('--network_log', 'log network activity to network_log.json')
  .option('--output_path [pathname]', 'use the Presearch binary located at [pathname]')
  .arguments('[build_config]')
  .action(start.bind(null, parsedArgs.unknown))

program
  .command('pull_l10n')
  .option('--extension <extension>', 'Scope this command to localize a Presearch extension such as ethereum-remote-client')
