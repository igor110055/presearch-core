...
#define PRESEARCH_GET_IMAGE_DATA                                              \
  if (ExecutionContext* context = ExecutionContext::From(script_state)) { \
    if (WebContentSettingsClient* settings =                              \
      ...
      presearch::PresearchSessionCache::From(*context).PerturbPixels(             \
          settings,                                                       \
...
#define PRESEARCH_GET_IMAGE_DATA_PARAMS ScriptState *script_state,
...
#undef getImageData
#undef PRESEARCH_GET_IMAGE_DATA_PARAMS
#undef PRESEARCH_GET_IMAGE_DATA
