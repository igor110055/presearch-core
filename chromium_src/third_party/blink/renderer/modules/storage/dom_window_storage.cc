...
#include "third_party/blink/renderer/modules/storage/presearch_dom_window_storage.h"
...
// static
const char PresearchDOMWindowStorage::kSupplementName[] = "PresearchDOMWindowStorage";

// static
PresearchDOMWindowStorage& PresearchDOMWindowStorage::From(LocalDOMWindow& window) {
  PresearchDOMWindowStorage* supplement =
      Supplement<LocalDOMWindow>::From<PresearchDOMWindowStorage>(window);
  if (!supplement) {
    supplement = MakeGarbageCollected<PresearchDOMWindowStorage>(window);
...
// static
StorageArea* PresearchDOMWindowStorage::sessionStorage(
    LocalDOMWindow& window,
...
// static
StorageArea* PresearchDOMWindowStorage::localStorage(
    LocalDOMWindow& window,
    ExceptionState& exception_state) {
  return From(window).localStorage(exception_state);
}

PresearchDOMWindowStorage::PresearchDOMWindowStorage(LocalDOMWindow& window)
...
StorageArea* PresearchDOMWindowStorage::ephemeralSessionStorage() {
...
StorageArea* PresearchDOMWindowStorage::ephemeralLocalStorage() {
...
void PresearchDOMWindowStorage::Trace(Visitor* visitor) const {
