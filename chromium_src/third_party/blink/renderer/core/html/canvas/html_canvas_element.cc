...
#define PRESEARCH_TO_DATA_URL_INTERNAL                                     \
  {                                                                    \
    ...
    if (execution_context) {                                           \
      if (WebContentSettingsClient* settings =                         \
              presearch::GetContentSettingsClientFor(execution_context)) { \
        presearch::PresearchSessionCache::From(*execution_context)             \
...
#undef PRESEARCH_TO_DATA_URL_INTERNAL
