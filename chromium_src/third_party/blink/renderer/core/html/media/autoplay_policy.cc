...
#define PRESEARCH_AUTOPLAY_POLICY_IS_GESTURE_NEEDED_FOR_PLAYBACK \
  if (!IsAutoplayAllowedForElement(element_))                \
    return true;

#define PRESEARCH_GET_AUTOPLAY_POLICY_FOR_DOCUMENT \
...
#undef PRESEARCH_AUTOPLAY_POLICY_IS_GESTURE_NEEDED_FOR_PLAYBACK
#undef PRESEARCH_GET_AUTOPLAY_POLICY_FOR_DOCUMENT
