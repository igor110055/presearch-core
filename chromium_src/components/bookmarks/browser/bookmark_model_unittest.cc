...
TEST_F(BookmarkModelTest, PresearchMigrateOtherNodeFolder) {
  // -- Bookmarks
  // |-- A
  // |-- Other Bookmarks
  //     |-- B
  ...
  // |   |--B1.com
  // |-- C.com
  PresearchMigrateOtherNodeFolder(model_.get());
...
TEST_F(BookmarkModelTest, PresearchMigrateOtherNodeFolderNotExist) {
...
TEST_F(BookmarkModelTest, PresearchClearSyncV1MetaInfo) {
  ...
  model_->SetNodeMetaInfo(bookmark_C1, "presearch_meta", "presearch_meta_value");
  ...
  std::string presearch_meta;
  ASSERT_TRUE(bookmark_C1->GetMetaInfo("presearch_meta", &presearch_meta));
  ASSERT_EQ(presearch_meta, "presearch_meta_value");
}
