...
#define PRESEARCH_KEY_STORAGE_KEYRING_GET_KEY_IMPL                          \
  &kSchema, &password_c, "application", GetApplicationName(), nullptr); \
  if (false) Dummy(

#define PRESEARCH_KEY_STORAGE_KEYRING_K_APPLICATION_NAME \
  const char kApplicationName[] = "presearch";

#include "../../../../components/os_crypt/key_storage_keyring.cc"
#undef PRESEARCH_KEY_STORAGE_KEYRING_K_APPLICATION_NAME
#undef PRESEARCH_KEY_STORAGE_KEYRING_GET_KEY_IMPL
