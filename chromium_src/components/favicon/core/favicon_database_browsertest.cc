...
class PresearchFaviconDatabaseBrowserTest : public InProcessBrowserTest {
 public:
  PresearchFaviconDatabaseBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    base::PathService::Get(presearch::DIR_TEST_DATA, &test_data_dir_);
    https_server_.ServeFilesFromDirectory(test_data_dir_);
    https_server_.AddDefaultHandlers(GetChromeTestDataDir());
    https_server_.RegisterRequestHandler(
        base::BindRepeating(&PresearchFaviconDatabaseBrowserTest::HandleRequest,
                            base::Unretained(this)));
    https_server_.RegisterRequestMonitor(
        base::BindRepeating(&PresearchFaviconDatabaseBrowserTest::SaveRequest,
                            base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(PresearchFaviconDatabaseBrowserTest, SetRead1001) {
  ClearRequests();
