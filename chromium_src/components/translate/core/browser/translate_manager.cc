...
#define HasAPIKeyConfigured PresearchHasAPIKeyConfigured
#include "../../../../../../components/translate/core/browser/translate_manager.cc" // NOLINT
#undef HasAPIKeyConfigured

namespace google_apis {

bool PresearchHasAPIKeyConfigured() {
  // Google API key is not used in presearch for translation service, always return
