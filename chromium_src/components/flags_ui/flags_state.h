...
#ifndef PRESEARCH_CHROMIUM_SRC_COMPONENTS_FLAGS_UI_FLAGS_STATE_H_
#define PRESEARCH_CHROMIUM_SRC_COMPONENTS_FLAGS_UI_FLAGS_STATE_H_
...
#endif  // PRESEARCH_CHROMIUM_SRC_COMPONENTS_FLAGS_UI_FLAGS_STATE_H_
