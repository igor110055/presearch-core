...
extern void LocalizeEngineList(int country_id,
                               std::vector<PresearchPrepopulatedEngineID>* engines);
}
...
class PresearchTemplateURLServiceUtilTest : public testing::Test {
 public:
  void SetUp() override {
...
TEST_F(PresearchTemplateURLServiceUtilTest, GetSearchProvidersUsingKeywordResult) {
...
TEST_F(PresearchTemplateURLServiceUtilTest,
