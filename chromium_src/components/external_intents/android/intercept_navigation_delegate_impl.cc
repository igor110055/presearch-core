...
class PresearchInterceptNavigationDelegate : public InterceptNavigationDelegate {
 public:
  PresearchInterceptNavigationDelegate(JNIEnv* env,
                                   jobject jdelegate,
...
static void JNI_InterceptNavigationDelegateImpl_AssociateWithWebContents(
  ...
  InterceptNavigationDelegate::Associate(
      web_contents,
      std::make_unique<PresearchInterceptNavigationDelegate>(
          env, jdelegate,
