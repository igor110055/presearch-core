...
#ifndef PRESEARCH_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
#define PRESEARCH_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
...
// Widevine plugin must be fetched from Google servers. Presearch's update server
...
// components in one request, which in Presearch's case is a mix of Google and Presearch
...
#endif  // PRESEARCH_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
