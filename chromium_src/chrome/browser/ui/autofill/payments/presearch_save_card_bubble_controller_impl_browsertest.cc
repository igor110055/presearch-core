...
class PresearchSaveCardBubbleControllerImplTest : public InProcessBrowserTest {
 public:
  PresearchSaveCardBubbleControllerImplTest() {}
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PresearchSaveCardBubbleControllerImplTest);
};

// Tests that requesting to open signin promo bubble doesn't result in the
// bubble being shown.
IN_PROC_BROWSER_TEST_F(PresearchSaveCardBubbleControllerImplTest, NoSignInPromo) {
  ShowUi();
