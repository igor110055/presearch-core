...
#define ExternalProcessImporterHost PresearchExternalProcessImporterHost
...
#define PRESEARCH_SEND_BROWSER_PROFILE_DATA                                        \
...
#undef PRESEARCH_IMPORT_DATA
#undef PRESEARCH_SEND_BROWSER_PROFILE_DATA
