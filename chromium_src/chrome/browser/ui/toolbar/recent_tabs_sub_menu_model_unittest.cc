...
// Disabling these tests because they refer g_presearch_browser_process which is not
...
// Need to expect more items at that place, because Presearch has additional item
...
#define PRESEARCH_MAX_TABS_PER_SESSION_AND_RECENCY \
        --num_items;
