...
#define PRESEARCH_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_1 \
  true ? ScaleImageSkiaRep(rep,                             \
                           GetCustomGraphicSize().value_or( \
                               extensions::ExtensionAction::ActionIconSize()), \
                           canvas->image_scale()) :

#define PRESEARCH_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_2 \
...
#undef PRESEARCH_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_2
#undef PRESEARCH_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_1
