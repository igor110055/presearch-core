...
class PresearchBookmarkContextMenuControllerTest : public testing::Test {
 public:
  PresearchBookmarkContextMenuControllerTest() : model_(nullptr) {}
...
TEST_F(PresearchBookmarkContextMenuControllerTest,
