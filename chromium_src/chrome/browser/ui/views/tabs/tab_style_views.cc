...
#define PRESEARCH_GM2_TAB_STYLE_H protected:
#define CreateForTab CreateForTab_ChromiumImpl
#include "../../../../../../../chrome/browser/ui/views/tabs/tab_style_views.cc"
#undef CreateForTab
#undef PRESEARCH_GM2_TAB_STYLE_H

namespace {

class PresearchGM2TabStyle : public GM2TabStyle {
 public:
  explicit PresearchGM2TabStyle(Tab* tab);
  PresearchGM2TabStyle(const PresearchGM2TabStyle&) = delete;
  PresearchGM2TabStyle& operator=(const PresearchGM2TabStyle&) = delete;
...
PresearchGM2TabStyle::PresearchGM2TabStyle(Tab* tab)
    : GM2TabStyle(tab),
      active_tab_font_(
          normal_font_.DeriveWithWeight(gfx::Font::Weight::MEDIUM)) {}

TabStyle::TabColors PresearchGM2TabStyle::CalculateColors() const {
...
const gfx::FontList& PresearchGM2TabStyle::GetFontList() const {
...
std::unique_ptr<TabStyleViews> TabStyleViews::CreateForTab(Tab* tab) {
  return std::make_unique<PresearchGM2TabStyle>(tab);
}
