...
#ifndef PRESEARCH_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
#define PRESEARCH_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#define PRESEARCH_TAB_HOVER_CARD_BUBBLE_VIEW_H_ \
 protected:                                 \
  void PresearchUpdateCardContent(const Tab* tab);
...
#undef PRESEARCH_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#endif  // PRESEARCH_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
