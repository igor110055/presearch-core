...
void PresearchAvatarToolbarButtonDelegate::Init(AvatarToolbarButton* button,
                                            Profile* profile) {
  profile_ = profile;
  AvatarToolbarButtonDelegate::Init(button, profile);
}

AvatarToolbarButton::State PresearchAvatarToolbarButtonDelegate::GetState() const {
...
gfx::Image PresearchAvatarToolbarButtonDelegate::GetGaiaAccountImage() const {
  return gfx::Image();
}
