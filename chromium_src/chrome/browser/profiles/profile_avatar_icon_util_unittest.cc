...
TEST(ProfileUtilTest, PresearchAvatarIconChoices) {
  // Test that the avatar icon choices presented to the user are presearch's.
...
TEST(ProfileUtilTest, RandomIconNeverFirstIcon) {
  ...
  // the placeholder index (which for presearch is always the first item).
