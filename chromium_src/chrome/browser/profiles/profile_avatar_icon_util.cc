...
struct IconResourceInfo;
  ...
  constexpr size_t kPresearchDefaultAvatarIconsCount = 34;
#else
  constexpr size_t kPresearchDefaultAvatarIconsCount = 0;
#endif

const IconResourceInfo* GetPresearchDefaultAvatarIconResourceInfo(
      size_t chromium_index);

size_t GetPresearchAvatarIconStartIndex();

#define PRESEARCH_GET_DEFAULT_AVATAR_ICON_RESOURCE_INFO              \
  size_t presearch_start_index =                                     \
      kDefaultAvatarIconsCount - kPresearchDefaultAvatarIconsCount;  \
  if (index >= presearch_start_index) {                              \
    size_t presearch_icon_index = index - presearch_start_index;         \
    const IconResourceInfo* presearch_icon =                         \
        GetPresearchDefaultAvatarIconResourceInfo(presearch_icon_index); \
    if (presearch_icon)                                              \
      return presearch_icon;                                         \
  }

#define PRESEARCH_GET_MODERN_AVATAR_ICON_START_INDEX  \
  return GetPresearchAvatarIconStartIndex();
...
#undef PRESEARCH_GET_DEFAULT_AVATAR_ICON_RESOURCE_INFO
#undef PRESEARCH_GET_MODERN_AVATAR_ICON_START_INDEX
...
size_t GetPresearchAvatarIconStartIndex() {
  return kDefaultAvatarIconsCount - kPresearchDefaultAvatarIconsCount;
}
...
const IconResourceInfo* GetPresearchDefaultAvatarIconResourceInfo(
  ...
  return nullptr;
#else
  CHECK_LT(index, kPresearchDefaultAvatarIconsCount);
  ...
  //    IDS_PRESEARCH_AVATAR_LABEL_$a},"; a=a+1 done | pbcopy
  static constexpr IconResourceInfo
      resource_info[kPresearchDefaultAvatarIconsCount] = {
        {IDR_PROFILE_AVATAR_56, "avatar_edgy_presearch.png",
            IDS_PRESEARCH_AVATAR_LABEL_56},
        {IDR_PROFILE_AVATAR_57, "avatar_edgy_ocean.png",
            IDS_PRESEARCH_AVATAR_LABEL_57},
        {IDR_PROFILE_AVATAR_58, "avatar_edgy_grass.png",
            IDS_PRESEARCH_AVATAR_LABEL_58},
        {IDR_PROFILE_AVATAR_59, "avatar_edgy_corn.png",
            IDS_PRESEARCH_AVATAR_LABEL_59},
        {IDR_PROFILE_AVATAR_60, "avatar_edgy_royal.png",
            IDS_PRESEARCH_AVATAR_LABEL_60},
        {IDR_PROFILE_AVATAR_61, "avatar_edgy_ninja.png",
            IDS_PRESEARCH_AVATAR_LABEL_61},
        {IDR_PROFILE_AVATAR_62, "avatar_paladin_rewards.png",
            IDS_PRESEARCH_AVATAR_LABEL_62},
        {IDR_PROFILE_AVATAR_63, "avatar_paladin_presearch.png",
            IDS_PRESEARCH_AVATAR_LABEL_63},
        {IDR_PROFILE_AVATAR_64, "avatar_paladin_ocean.png",
            IDS_PRESEARCH_AVATAR_LABEL_64},
        {IDR_PROFILE_AVATAR_65, "avatar_paladin_grass.png",
            IDS_PRESEARCH_AVATAR_LABEL_65},
        {IDR_PROFILE_AVATAR_66, "avatar_paladin_corn.png",
            IDS_PRESEARCH_AVATAR_LABEL_66},
        {IDR_PROFILE_AVATAR_67, "avatar_paladin_royal.png",
            IDS_PRESEARCH_AVATAR_LABEL_67},
        {IDR_PROFILE_AVATAR_68, "avatar_paladin_ninja.png",
            IDS_PRESEARCH_AVATAR_LABEL_68},
        {IDR_PROFILE_AVATAR_69, "avatar_gleam_rewards.png",
            IDS_PRESEARCH_AVATAR_LABEL_69},
        {IDR_PROFILE_AVATAR_70, "avatar_gleam_presearch.png",
            IDS_PRESEARCH_AVATAR_LABEL_70},
        {IDR_PROFILE_AVATAR_71, "avatar_gleam_ocean.png",
            IDS_PRESEARCH_AVATAR_LABEL_71},
        {IDR_PROFILE_AVATAR_72, "avatar_gleam_grass.png",
            IDS_PRESEARCH_AVATAR_LABEL_72},
        {IDR_PROFILE_AVATAR_73, "avatar_gleam_corn.png",
            IDS_PRESEARCH_AVATAR_LABEL_73},
        {IDR_PROFILE_AVATAR_74, "avatar_gleam_royal.png",
            IDS_PRESEARCH_AVATAR_LABEL_74},
        {IDR_PROFILE_AVATAR_75, "avatar_gleam_ninja.png",
            IDS_PRESEARCH_AVATAR_LABEL_75},
        {IDR_PROFILE_AVATAR_76, "avatar_oval_rewards.png",
            IDS_PRESEARCH_AVATAR_LABEL_76},
        {IDR_PROFILE_AVATAR_77, "avatar_oval_presearch.png",
            IDS_PRESEARCH_AVATAR_LABEL_77},
        {IDR_PROFILE_AVATAR_78, "avatar_oval_ocean.png",
            IDS_PRESEARCH_AVATAR_LABEL_78},
        {IDR_PROFILE_AVATAR_79, "avatar_oval_grass.png",
            IDS_PRESEARCH_AVATAR_LABEL_79},
        {IDR_PROFILE_AVATAR_80, "avatar_oval_corn.png",
            IDS_PRESEARCH_AVATAR_LABEL_80},
        {IDR_PROFILE_AVATAR_81, "avatar_oval_royal.png",
            IDS_PRESEARCH_AVATAR_LABEL_81},
        {IDR_PROFILE_AVATAR_82, "avatar_oval_ninja.png",
            IDS_PRESEARCH_AVATAR_LABEL_82},
        {IDR_PROFILE_AVATAR_83, "avatar_bonbon_rewards.png",
            IDS_PRESEARCH_AVATAR_LABEL_83},
        {IDR_PROFILE_AVATAR_84, "avatar_bonbon_presearch.png",
            IDS_PRESEARCH_AVATAR_LABEL_84},
        {IDR_PROFILE_AVATAR_85, "avatar_bonbon_ocean.png",
            IDS_PRESEARCH_AVATAR_LABEL_85},
        {IDR_PROFILE_AVATAR_86, "avatar_bonbon_grass.png",
            IDS_PRESEARCH_AVATAR_LABEL_86},
        {IDR_PROFILE_AVATAR_87, "avatar_bonbon_corn.png",
            IDS_PRESEARCH_AVATAR_LABEL_87},
        {IDR_PROFILE_AVATAR_88, "avatar_bonbon_royal.png",
            IDS_PRESEARCH_AVATAR_LABEL_88},
        {IDR_PROFILE_AVATAR_89, "avatar_bonbon_ninja.png",
            IDS_PRESEARCH_AVATAR_LABEL_89}
  };
  static_assert(
      (resource_info[kPresearchDefaultAvatarIconsCount - 1].resource_id ==
      IDR_PROFILE_AVATAR_89),
      "IconResourceInfo entries for Presearch avatars is less than"
      "kPresearchDefaultAvatarIconsCount but should be the same.");
  return &resource_info[index];
#endif
}

bool IsDefaultAvatarIconUrl(const std::string& url, size_t* icon_index) {
  // Presearch supports user choosing the placeholder avatar, Chromium does not.
...
std::unique_ptr<base::DictionaryValue> GetDefaultProfileAvatarIconAndLabel(
  ...
  return GetAvatarIconAndLabelDict(
      ...
      l10n_util::GetStringUTF16(IDS_PRESEARCH_AVATAR_LABEL_PLACEHOLDER), index,
