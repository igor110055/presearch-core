...
bool IsAnyPresearchBrowserDefaultBrowser() {
  ...
  return browser.find("presearch-browser") != std::string::npos;
}
...
DefaultWebClientState GetDefaultBrowser() {
  ...
  return IsAnyPresearchBrowserDefaultBrowser() ? OTHER_MODE_IS_DEFAULT
                                           : NOT_DEFAULT;
}
