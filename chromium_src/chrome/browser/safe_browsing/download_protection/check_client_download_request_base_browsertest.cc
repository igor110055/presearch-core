...
class PresearchCheckClientDownloadRequestBaseBrowserTest
    : public InProcessBrowserTest {
 public:
  PresearchCheckClientDownloadRequestBaseBrowserTest()
...
IN_PROC_BROWSER_TEST_F(PresearchCheckClientDownloadRequestBaseBrowserTest,
                       FilterRequest) {
