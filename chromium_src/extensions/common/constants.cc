...
const int kPresearchActionGraphicSize = 18;
const int kPresearchActionRightMargin = 2;

const char presearch_extension_id[] = "mnojpmjdmbbfmejpflffifhffcmidifd";
const char presearch_rewards_extension_id[] = "jidkidbbcafjabdphckchenhfomhnfma";
...
const char presearch_webtorrent_extension_id[] = "lgjmpdmojkpocjcopdikifhejkkjglho";
const char presearch_webtorrent_extension_filename[] = "presearch_webtorrent.html";
const char presearch_webtorrent_extension_filename2[] = "presearch_webtorrent2.html";
