...
#ifndef PRESEARCH_CHROMIUM_SRC_EXTENSIONS_COMMON_MANIFEST_URL_HANDLERS_H_
#define PRESEARCH_CHROMIUM_SRC_EXTENSIONS_COMMON_MANIFEST_URL_HANDLERS_H_
...
#endif  // PRESEARCH_CHROMIUM_SRC_EXTENSIONS_COMMON_MANIFEST_URL_HANDLERS_H_
