...
#define PRESEARCH_SANDBOXEDUNPACKER_REWRITEMANIFESTFILE \
  base::DictionaryValue* dict_manifest;             \
  final_manifest.GetAsDictionary(&dict_manifest);   \
  presearch::PresearchRewriteManifest(extension_id_, dict_manifest);

#include "../../../../extensions/browser/sandboxed_unpacker.cc"
#undef PRESEARCH_SANDBOXEDUNPACKER_REWRITEMANIFESTFILE
