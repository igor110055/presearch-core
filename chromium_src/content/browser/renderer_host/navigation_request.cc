...
#define PRESEARCH_ONREQUESTREDIRECTED_MAYBEHIDEREFERRER                   \
...
#define PRESEARCH_ONSTARTCHECKSCOMPLETE_MAYBEHIDEREFERRER \
  GetContentClient()->browser()->MaybeHideReferrer(   \
      browser_context, common_params_->url,           \
      GetTopDocumentGURL(frame_tree_node_), &common_params_->referrer);
...
#undef PRESEARCH_ONSTARTCHECKSCOMPLETE_MAYBEHIDEREFERRER
