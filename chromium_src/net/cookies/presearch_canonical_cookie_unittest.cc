...
TEST(PresearchCanonicalCookieTest, SetMaxExpiration) {
...
TEST(PresearchCanonicalCookieTest, AllowShorterThanMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(PresearchCanonicalCookieTest, SetHTTPOnlyMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(PresearchCanonicalCookieTest, NoExpirationCookie) {
  GURL url("https://www.example.com/test");
