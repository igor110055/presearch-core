...
#ifndef PRESEARCH_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
#define PRESEARCH_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
...
#endif  // PRESEARCH_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
