...
base::Time PresearchCanonExpiration(const base::Time& cookie_expires,
...
#define PRESEARCH_CREATE \
  cookie_expires = PresearchCanonExpiration(cookie_expires, creation_time);

#include "../../../../net/cookies/canonical_cookie.cc"
#undef PRESEARCH_CREATE
