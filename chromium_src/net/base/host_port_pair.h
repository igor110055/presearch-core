...
#ifndef PRESEARCH_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_
#define PRESEARCH_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_

#include <string>

// Nudges HostPortPair past Chromium's style
// threshold for in-line constructors and destructors.
#define PRESEARCH_HOST_PORT_PAIR_H_ \
...
#undef PRESEARCH_HOST_PORT_PAIR_H_

#endif  // PRESEARCH_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_
