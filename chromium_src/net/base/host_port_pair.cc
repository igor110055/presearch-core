...
#define PRESEARCH_HOST_PORT_PAIR_TO_STRING_ \
  ret = MaybeAddUsernameAndPassword(this, ret);

#define PRESEARCH_HOST_PORT_PAIR_FROM_STRING_ \
  if (HasAuthentication(str)) \
    return FromStringWithAuthentication(str);

#define PRESEARCH_HOST_PORT_PAIR_FROM_URL_ \
...
#undef PRESEARCH_HOST_PORT_PAIR_TO_STRING_
#undef PRESEARCH_HOST_PORT_PAIR_FROM_STRING_
#undef PRESEARCH_HOST_PORT_PAIR_FROM_URL_
