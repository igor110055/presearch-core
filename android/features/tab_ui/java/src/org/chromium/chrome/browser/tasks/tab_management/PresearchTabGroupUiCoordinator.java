...
public class PresearchTabGroupUiCoordinator extends TabGroupUiCoordinator {
    // To delete in bytecode, members from parent class will be used instead.
    private TabGroupUiToolbarView mToolbarView;

    public PresearchTabGroupUiCoordinator(ViewGroup parentView, ThemeColorProvider themeColorProvider,
        ...
        if (toolbarRightButton != null) {
            toolbarRightButton.setImageResource(R.drawable.presearch_new_group_tab);
        }
    }
}
