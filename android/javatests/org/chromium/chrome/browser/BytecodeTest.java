 ...
 * See classes from 'presearch/build/android/bytecode/java/org/presearch/bytecode' folder.
 * Classes, methods and fields should be whitelisted in 'presearch/android/java/apk_for_test.flags'.
 */
...
public class BytecodeTest {
    ...
    public void testClassesExist() throws Exception {
        ...
        Assert.assertTrue(classExists("org/chromium/chrome/browser/toolbar/PresearchToolbarManager"));
        Assert.assertTrue(
        ...
        Assert.assertTrue(classExists("org/chromium/chrome/browser/tabmodel/PresearchTabCreator"));
        Assert.assertTrue(classExists("org/chromium/chrome/browser/bookmarks/PresearchBookmarkUtils"));
        Assert.assertTrue(classExists(
                "org/chromium/chrome/browser/safe_browsing/settings/PresearchStandardProtectionSettingsFragment"));
        Assert.assertTrue(classExists(
        ...
        Assert.assertTrue(
                classExists("org/chromium/chrome/browser/toolbar/PresearchIncognitoToggleTabLayout"));
        Assert.assertTrue(classExists(
        ...
        Assert.assertTrue(
                classExists("org/chromium/chrome/browser/site_settings/PresearchSiteSettingsDelegate"));
        Assert.assertTrue(classExists(
        ...
        Assert.assertTrue(
                classExists("org/chromium/components/permissions/PresearchPermissionDialogDelegate"));
        Assert.assertTrue(
                classExists("org/chromium/components/permissions/PermissionDialogDelegate"));
        Assert.assertTrue(
                classExists("org/chromium/components/permissions/PresearchPermissionDialogModel"));
    ...
    public void testMethodsExist() throws Exception {
        ...
        Assert.assertTrue(
                methodExists("org/chromium/chrome/browser/query_tiles/PresearchQueryTileSection",
                        "getMaxRowsForMostVisitedTiles", false, null));
        ...
        Assert.assertTrue(methodExists("org/chromium/chrome/browser/bookmarks/PresearchBookmarkUtils",
        ...
        Assert.assertTrue(
                methodExists("org/chromium/components/permissions/PresearchPermissionDialogModel",
                        "getModel", false, null));
    ...
    public void testMethodsForInvocationExist() throws Exception {
        ...
        // `presearch/android/java/proguard.flags` file under `Add methods for invocation below`
    ...
    public void testConstructorsExistAndMatch() throws Exception {
        ...
        Assert.assertTrue(constructorsMatch("org/chromium/chrome/browser/tabmodel/ChromeTabCreator",
                "org/chromium/chrome/browser/tabmodel/PresearchTabCreator", ChromeActivity.class,
        ...
        Assert.assertTrue(constructorsMatch("org/chromium/chrome/browser/toolbar/ToolbarManager",
                "org/chromium/chrome/browser/toolbar/PresearchToolbarManager", AppCompatActivity.class,
        ...
        Assert.assertTrue(constructorsMatch(
                "org/chromium/chrome/browser/site_settings/ChromeSiteSettingsDelegate",
                "org/chromium/chrome/browser/site_settings/PresearchSiteSettingsDelegate",
    ...
    public void testSuperNames() throws Exception {
        ...
        Assert.assertTrue(checkSuperName(
                "org/chromium/components/browser_ui/site_settings/SingleCategorySettings",
                "org/chromium/components/browser_ui/site_settings/PresearchSingleCategorySettings"));
        Assert.assertTrue(checkSuperName("org/chromium/chrome/browser/ChromeTabbedActivity",
                "org/chromium/chrome/browser/app/PresearchActivity"));
        Assert.assertTrue(checkSuperName(
                "org/chromium/chrome/browser/tabbed_mode/TabbedAppMenuPropertiesDelegate",
                "org/chromium/chrome/browser/app/appmenu/PresearchAppMenuPropertiesDelegateImpl"));
        Assert.assertTrue(checkSuperName(
