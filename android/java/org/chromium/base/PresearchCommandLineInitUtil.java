...
public abstract class PresearchCommandLineInitUtil {
    ...
    public static void initCommandLine(
        ...
        appendPresearchSwitchesAndArguments();
    }

    private static void appendPresearchSwitchesAndArguments() {
        ...
        if (sharedPreferences.getBoolean(PREF_QA_VLOG_REWARDS, false)) {
            ...
            qaCommandLine +=
                    " --vmodule=*/bat-native-ads/*=6,*/presearch_ads/*=6,*/presearch_user_model/*=6,*/bat_ads/*=6,*/bat-native-ledger/*=6,*/presearch_rewards/*=6";
        }
