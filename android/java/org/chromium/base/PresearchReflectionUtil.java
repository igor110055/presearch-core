...
public class PresearchReflectionUtil {
    private static String TAG = "PresearchReflectionUtil";

    // NOTE: For each method for invocation add appropriate test to `testMethodsForInvocationExist`
    // method in 'presearch/android/javatests/org/chromium/chrome/browser/BytecodeTest.java' file with
