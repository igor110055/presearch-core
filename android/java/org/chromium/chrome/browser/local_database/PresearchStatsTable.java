...
public class PresearchStatsTable {
    public static final String TABLE_NAME = "presearch_stats_table";
    ...
    public PresearchStatsTable(String url, String domain, String statType, String statSite, String statSiteDomain, String timestamp) {
        mUrl = url;
        mDomain = domain;
        mStatType = statType;
        mStatSite = statSite;
