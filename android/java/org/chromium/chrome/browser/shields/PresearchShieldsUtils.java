...
public class PresearchShieldsUtils {
	...
	private static final String httpUrl = "https://laptop-updates.presearch.com/1/webcompat";
        ...
        public static final int PRESEARCH_BLOCKED_TIER1 = 1000;
        public static final int PRESEARCH_BLOCKED_TIER2 = 5000;
        public static final int PRESEARCH_BLOCKED_TIER3 = 10000;
        public static final int PRESEARCH_BLOCKED_TIER4 = 25000;
        public static final int PRESEARCH_BLOCKED_TIER5 = 75000;
        public static final int PRESEARCH_BLOCKED_TIER6 = 100000;
        public static final int PRESEARCH_BLOCKED_TIER7 = 250000;
        public static final int PRESEARCH_BLOCKED_TIER8 = 500000;
        public static final int PRESEARCH_BLOCKED_TIER9 = 1000000;

        public static final int PRESEARCH_BLOCKED_SHOW_DIFF = 20;

        public static boolean isTooltipShown;

        public interface PresearchShieldsCallback {
            void presearchShieldsSubmitted();
        }
        ...
        public static class PresearchShieldsWorkerTask extends AsyncTask<Void> {
            private String mDomain;

            public PresearchShieldsWorkerTask(String domain) {
                mDomain = domain;
            }
