...
public class PresearchDownloadSettings
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.presearch_download_preferences);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (PREF_AUTOMATICALLY_OPEN_WHEN_POSSIBLE.equals(preference.getKey())) {
            ContextUtils.getAppSharedPreferences()
                    .edit()
                    .putBoolean(
                            PresearchPreferenceKeys.PRESEARCH_DOWNLOADS_AUTOMATICALLY_OPEN_WHEN_POSSIBLE,
                            (boolean) newValue)
                    .apply();
        }
        return true;
