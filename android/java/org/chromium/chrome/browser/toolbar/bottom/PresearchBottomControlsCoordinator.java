...
public class PresearchBottomControlsCoordinator extends BottomControlsCoordinator {
    ...
    public PresearchBottomControlsCoordinator(
    ...
    public void setBottomToolbarVisible(boolean visible) {
        if (mMediator instanceof PresearchBottomControlsMediator) {
            ((PresearchBottomControlsMediator) mMediator).setBottomToolbarVisible(visible);
        }
        if (mBottomToolbarCoordinator != null) {
    ...
    public ObservableSupplierImpl<Boolean> getBottomToolbarVisibleSupplier() {
        if (mMediator instanceof PresearchBottomControlsMediator) {
            return ((PresearchBottomControlsMediator) mMediator).getBottomToolbarVisibleSupplier();
        }
    ...
    public ObservableSupplierImpl<Boolean> getTabGroupUiVisibleSupplier() {
        if (mMediator instanceof PresearchBottomControlsMediator) {
            return ((PresearchBottomControlsMediator) mMediator).getTabGroupUiVisibleSupplier();
        }
        assert false : "Make sure mMediator is properly patched in bytecode.";
        return null;
    }
