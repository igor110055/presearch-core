...
public class PresearchScrollingBottomViewResourceFrameLayout
    ...
    public PresearchScrollingBottomViewResourceFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setBottomControlsCoordinatorSupplier(
        ...
        presearchBottomControlsCoordinator().getBottomToolbarVisibleSupplier().addObserver(
        ...
        presearchBottomControlsCoordinator().getTabGroupUiVisibleSupplier().addObserver(
                mCallbackController.makeCancelable((visible) -> {
    ...
    private PresearchBottomControlsCoordinator presearchBottomControlsCoordinator() {
        if (mBottomControlsCoordinatorSupplier != null
                && mBottomControlsCoordinatorSupplier.get()
                                instanceof PresearchBottomControlsCoordinator) {
            return (PresearchBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get();
        }
        return null;
    }
