...
import org.chromium.chrome.browser.toolbar.PresearchHomeButton;
...
public class BrowsingModeBottomToolbarCoordinator {
    ...
    private final PresearchHomeButton mPresearchHomeButton;
    ...
    BrowsingModeBottomToolbarCoordinator(View root, ActivityTabProvider tabProvider,
        ...
        mPresearchHomeButton = mToolbarRoot.findViewById(R.id.bottom_home_button);
        mPresearchHomeButton.setOnClickListener(homeButtonListener);
        ...
        if (BottomToolbarVariationManager.isHomeButtonOnBottom()) {
            mPresearchHomeButton.setVisibility(View.VISIBLE);
        }
    ...
    void initializeWithNative(OnClickListener newTabListener, OnClickListener tabSwitcherListener,
        ...
        if (BottomToolbarVariationManager.isHomeButtonOnBottom()) {
            mPresearchHomeButton.setThemeColorProvider(themeColorProvider);
        }
     ...
     */
    PresearchHomeButton getHomeButton() {
        return mPresearchHomeButton;
    }
