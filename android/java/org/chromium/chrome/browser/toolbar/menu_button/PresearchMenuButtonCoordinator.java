...
public class PresearchMenuButtonCoordinator extends MenuButtonCoordinator {
    private static final String PRESEARCH_IS_MENU_FROM_BOTTOM = "presearch_is_menu_from_bottom";

    private Activity mActivity;

    public PresearchMenuButtonCoordinator(
    ...
    private void updateMenuButtonState() {
        PresearchToolbarLayout layout = (PresearchToolbarLayout) mActivity.findViewById(R.id.toolbar);
        assert layout != null;
        if (layout != null) {
    ...
    public static void setMenuFromBottom(boolean isMenuFromBottom) {
        ...
        prefs.edit().putBoolean(PRESEARCH_IS_MENU_FROM_BOTTOM, isMenuFromBottom).apply();
    }

    public static boolean isMenuFromBottom() {
        SharedPreferences sharedPreferences = ContextUtils.getAppSharedPreferences();
        return sharedPreferences.getBoolean(PRESEARCH_IS_MENU_FROM_BOTTOM, true);
    }
}
