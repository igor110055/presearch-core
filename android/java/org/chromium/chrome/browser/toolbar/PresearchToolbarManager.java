...
import org.chromium.chrome.browser.toolbar.bottom.PresearchBottomControlsCoordinator;
import org.chromium.chrome.browser.toolbar.bottom.PresearchScrollingBottomViewResourceFrameLayout;
...
import org.chromium.chrome.browser.toolbar.top.PresearchTopToolbarCoordinator;
...
public class PresearchToolbarManager extends ToolbarManager {
    ...
    private HomepageManager.HomepageStateListener mPresearchHomepageStateListener;
    private AppCompatActivity mActivity;
    private WindowAndroid mWindowAndroid;
    private CompositorViewHolder mCompositorViewHolder;
    private final Object mLock = new Object();
    private boolean mBottomControlsEnabled;
    private PresearchScrollingBottomViewResourceFrameLayout mBottomControls;

    public PresearchToolbarManager(AppCompatActivity activity, BrowserControlsSizer controlsSizer,
        ...
        mPresearchHomepageStateListener = () -> {
            if (mBottomControlsCoordinatorSupplier != null
                    && mBottomControlsCoordinatorSupplier.get()
                                    instanceof PresearchBottomControlsCoordinator) {
                ((PresearchBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get())
    ...
    public void enableBottomControls() {
        ...
        synchronized (mLock) {
            ...
            mBottomControls =
                    (PresearchScrollingBottomViewResourceFrameLayout) bottomControlsStub.inflate();
            ...
            mBottomControlsCoordinatorSupplier.set(new PresearchBottomControlsCoordinator(
    ...
    public void destroy() {
        ...
        HomepageManager.getInstance().removeListener(mPresearchHomepageStateListener);
    }
    ...
    protected void updateBookmarkButtonStatus() {
        ...
        if (mBottomControlsCoordinatorSupplier.get() instanceof PresearchBottomControlsCoordinator) {
            ((PresearchBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get())
    ...
    private void setBottomToolbarVisible(boolean visible) {
        ...
        PresearchMenuButtonCoordinator.setMenuFromBottom(isMenuFromBottom);
        if (mToolbar instanceof PresearchTopToolbarCoordinator) {
            ((PresearchTopToolbarCoordinator) mToolbar).onBottomToolbarVisibilityChanged(visible);
        }
        if (mBottomControlsCoordinatorSupplier.get() instanceof PresearchBottomControlsCoordinator) {
            ((PresearchBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get())
    ...
    private boolean isToolbarPhone() {
        assert (mToolbar instanceof PresearchTopToolbarCoordinator);
        return mToolbar instanceof PresearchTopToolbarCoordinator
                && ((PresearchTopToolbarCoordinator) mToolbar).isToolbarPhone();
    }
}
