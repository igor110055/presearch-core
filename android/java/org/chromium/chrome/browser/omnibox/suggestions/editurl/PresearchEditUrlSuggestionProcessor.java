...
public class PresearchEditUrlSuggestionProcessor extends EditUrlSuggestionProcessor {
    private boolean mHasClearedOmniboxForFocus;

    public PresearchEditUrlSuggestionProcessor(Context context, SuggestionHost suggestionHost,
