...
public class BackgroundImagesPreferences
        extends PresearchPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (showBackgroundImagesPref != null) {
            ...
            showBackgroundImagesPref.setChecked(UserPrefs.get(Profile.getLastUsedRegularProfile()).getBoolean(PresearchPref.NEW_TAB_PAGE_SHOW_BACKGROUND_IMAGE));
        ...
        if (showSponsoredImagesPref != null) {
            showSponsoredImagesPref.setEnabled(UserPrefs.get(Profile.getLastUsedRegularProfile()).getBoolean(PresearchPref.NEW_TAB_PAGE_SHOW_BACKGROUND_IMAGE));
            showSponsoredImagesPref.setChecked(UserPrefs.get(Profile.getLastUsedRegularProfile()).getBoolean(PresearchPref.NEW_TAB_PAGE_SHOW_SPONSORED_IMAGES_BACKGROUND_IMAGE));
    ...
    public static void setOnPreferenceValue(String preferenceName, boolean newValue) {
        if (PREF_SHOW_BACKGROUND_IMAGES.equals(preferenceName)) {
            UserPrefs.get(Profile.getLastUsedRegularProfile()).setBoolean(PresearchPref.NEW_TAB_PAGE_SHOW_BACKGROUND_IMAGE, newValue);
        } else if (PREF_SHOW_SPONSORED_IMAGES.equals(preferenceName)) {
            UserPrefs.get(Profile.getLastUsedRegularProfile()).setBoolean(PresearchPref.NEW_TAB_PAGE_SHOW_SPONSORED_IMAGES_BACKGROUND_IMAGE, (boolean)newValue);
        } else {
