...
public class PresearchWebrtcPolicyPreference
    ...
    public PresearchWebrtcPolicyPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        setLayoutResource(R.layout.presearch_webrtc_policy_preference);
