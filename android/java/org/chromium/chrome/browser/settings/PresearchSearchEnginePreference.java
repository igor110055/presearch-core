...
public class PresearchSearchEnginePreference extends ListFragment {
    private SearchEngineAdapter mSearchEngineAdapter;
    private boolean mPrivate;

    public PresearchSearchEnginePreference(boolean isPrivate) {
        mPrivate = isPrivate;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEngineAdapter = new PresearchSearchEngineAdapter(getActivity(), mPrivate);
