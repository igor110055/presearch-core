...
class PresearchRewardsExternalWallet {
    //fields
    ...
    PresearchRewardsExternalWallet (String json_external_wallet) throws JSONException {
    ...
    public String toString() {
        return "PresearchRewardsExternalWallet{"
