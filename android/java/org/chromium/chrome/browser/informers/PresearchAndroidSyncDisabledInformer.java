...
public class PresearchAndroidSyncDisabledInformer {
    public static final String DONT_SHOW_ANDROID_SYSTEM_SYNC_DISABLED_INFORMER =
            "presearch_dont_show_android_system_sync_disabled_informer";
    ...
    private static void showIfRequired() {
        ...
        boolean presearch_sync_is_enabled = ProfileSyncService.get().isFirstSetupComplete();
        boolean android_system_sync_disabled = !ContentResolver.getMasterSyncAutomatically();

        if (!presearch_sync_is_enabled || !android_system_sync_disabled) {
            return;
        }
    ...
    private static void showAndroidSyncDisabled() {
        ...
        PresearchSimpleConfirmInfoBarBuilder.createInfobarWithDrawable(tab.getWebContents(),
                ...
                // must be enum from
                // src/presearch/chromium_src/components/infobars/core/infobar_delegate.h and java enums
                // are generated by //components/infobars/core:infobar_generated_enums who does not
                // understand `presearch/chromium_src`
                InfoBarIdentifier.INLINE_UPDATE_READY_INFOBAR_ANDROID, activity,
                R.drawable.ic_warning_circle,
                activity.getString(R.string.presearch_sync_android_sync_disabled),
                activity.getString(R.string.presearch_open_system_sync_settings),
                activity.getString(R.string.presearch_android_sync_disabled_ok),
                "\n\n" + activity.getString(R.string.presearch_android_sync_disabled_dont_show), false);
    }
}
