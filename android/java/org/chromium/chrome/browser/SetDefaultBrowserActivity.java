...
public class SetDefaultBrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDefaultBrowserImg.setImageResource(isNightMode
                                        ? R.drawable.ic_setpresearchasdefault_dark
                                        : R.drawable.ic_setpresearchasdefault);
        if (isNightMode) {
        ...
        btnSetDefaultBrowser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (PresearchActivity.getPresearchActivity() != null) {
                    PresearchActivity.getPresearchActivity().handlePresearchSetDefaultBrowserDialog();
                }
                finish();
            }
        });
