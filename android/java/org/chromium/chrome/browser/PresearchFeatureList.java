...
public abstract class PresearchFeatureList {
    public static final String PRESEARCH_REWARDS = "PresearchRewards";
    ...
    public static void enableFeature(
        ...
        PresearchFeatureListJni.get().enableFeature(featureName, enabled, fallbackToDefault);
    }
