...
public class OnboardingPrefManager {
    ...
    public static final String QWANT = "Presearch";
    ...
    public boolean isPresearchStatsEnabled() {
        return mSharedPreferences.getBoolean(PREF_PRESEARCH_STATS, false);
    }

    public void setPresearchStatsEnabled(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor = mSharedPreferences.edit();
        sharedPreferencesEditor.putBoolean(PREF_PRESEARCH_STATS, enabled);
        sharedPreferencesEditor.apply();
    }

    public boolean isPresearchStatsNotificationEnabled() {
        return mSharedPreferences.getBoolean(PREF_PRESEARCH_STATS_NOTIFICATION, true);
    }

    public void setPresearchStatsNotificationEnabled(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor = mSharedPreferences.edit();
        sharedPreferencesEditor.putBoolean(PREF_PRESEARCH_STATS_NOTIFICATION, enabled);
        sharedPreferencesEditor.apply();
    }
    ...
    public boolean showOnboardingForSkip(Context context) {
        boolean shouldShow = PackageUtils.isFirstInstall(context)
                             ...
                             && !PresearchAdsNativeHelper.nativeIsPresearchAdsEnabled(Profile.getLastUsedRegularProfile())
    ...
    public boolean isAdsAvailable() {
        return PresearchAdsNativeHelper.nativeIsSupportedLocale(Profile.getLastUsedRegularProfile());
    }
    ...
    public void onboardingNotification() {
        if (!isOnboardingNotificationShown()) {
            PresearchOnboardingNotification.showOnboardingNotification();
