...
public class PresearchThemePreferences extends ThemeSettingsFragment {

    private static final String SUPER_REFERRAL = "super_referral";

    @Override
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.presearch_theme_preferences);
        ...
        PresearchRadioButtonGroupThemePreference radioButtonGroupThemePreference =
            (PresearchRadioButtonGroupThemePreference) findPreference(PREF_UI_THEME_PREF);
