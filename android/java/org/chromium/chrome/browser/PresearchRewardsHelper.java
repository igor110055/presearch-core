...
public class PresearchRewardsHelper implements LargeIconBridge.LargeIconCallback{
    private static final String PREF_PRESEARCH_REWARDS_APP_OPEN_COUNT = "presearch_rewards_app_open_count";
    private static final String PREF_SHOW_PRESEARCH_REWARDS_ONBOARDING_MODAL =
            "show_presearch_rewards_onboarding_modal";
    private static final String PREF_SHOW_PRESEARCH_REWARDS_ONBOARDING_ONCE =
            "show_presearch_rewards_onboarding_once";
    ...
    public static boolean shouldShowRewardsOnboardingModalOnDay4() {
        if (!hasRewardsOnboardingModalShown()
                ...
                && shouldShowPresearchRewardsOnboardingModal()
    ...
    public static int getPresearchRewardsAppOpenCount() {
        return ContextUtils.getAppSharedPreferences().getInt(PREF_PRESEARCH_REWARDS_APP_OPEN_COUNT, 0);
    }

    public static void updatePresearchRewardsAppOpenCount() {
        SharedPreferences.Editor sharedPreferencesEditor = ContextUtils.getAppSharedPreferences().edit();
        sharedPreferencesEditor.putInt(PREF_PRESEARCH_REWARDS_APP_OPEN_COUNT,
    ...
    public static boolean shouldShowPresearchRewardsOnboardingModal() {
        return ContextUtils.getAppSharedPreferences().getBoolean(
                PREF_SHOW_PRESEARCH_REWARDS_ONBOARDING_MODAL, true);
    }

    public static void setShowPresearchRewardsOnboardingModal(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor =
                ContextUtils.getAppSharedPreferences().edit();
        sharedPreferencesEditor.putBoolean(PREF_SHOW_PRESEARCH_REWARDS_ONBOARDING_MODAL, enabled);
        sharedPreferencesEditor.apply();
    }

    public static boolean shouldShowPresearchRewardsOnboardingOnce() {
        return ContextUtils.getAppSharedPreferences().getBoolean(
                PREF_SHOW_PRESEARCH_REWARDS_ONBOARDING_ONCE, false);
    }

    public static void setShowPresearchRewardsOnboardingOnce(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor =
                ContextUtils.getAppSharedPreferences().edit();
        sharedPreferencesEditor.putBoolean(PREF_SHOW_PRESEARCH_REWARDS_ONBOARDING_ONCE, enabled);
        sharedPreferencesEditor.apply();
    }
    ...
    public PresearchRewardsHelper(Tab tab) {
        mTab = tab;
        assert mTab != null;
    ...
    static public ChromeTabbedActivity getChromeTabbedActivity() {
      return PresearchActivity.getChromeTabbedActivity();
    }

    static public PresearchActivity getPresearchActivity() {
      return PresearchActivity.getPresearchActivity();
    }

  static public String getCurrentMonth(Calendar currentTime,
      Resources resources, boolean upper_case) {
    String month = resources.getString(R.string.presearch_ui_month_jan);
    switch (currentTime.get(Calendar.MONTH)) {
      case Calendar.JANUARY:
        month = resources.getString(R.string.presearch_ui_month_jan);
        break;
      case Calendar.FEBRUARY:
        month = resources.getString(R.string.presearch_ui_month_feb);
        break;
      case Calendar.MARCH:
        month = resources.getString(R.string.presearch_ui_month_mar);
        break;
      case Calendar.APRIL:
        month = resources.getString(R.string.presearch_ui_month_apr);
        break;
      case Calendar.MAY:
        month = resources.getString(R.string.presearch_ui_month_may);
        break;
      case Calendar.JUNE:
        month = resources.getString(R.string.presearch_ui_month_jun);
        break;
      case Calendar.JULY:
        month = resources.getString(R.string.presearch_ui_month_jul);
        break;
      case Calendar.AUGUST:
        month = resources.getString(R.string.presearch_ui_month_aug);
        break;
      case Calendar.SEPTEMBER:
        month = resources.getString(R.string.presearch_ui_month_sep);
        break;
      case Calendar.OCTOBER:
        month = resources.getString(R.string.presearch_ui_month_oct);
        break;
      case Calendar.NOVEMBER:
        month = resources.getString(R.string.presearch_ui_month_nov);
        break;
      case Calendar.DECEMBER:
        month = resources.getString(R.string.presearch_ui_month_dec);
        break;
    }
  ...
  public static Tab currentActiveChromeTabbedActivityTab() {
      ChromeTabbedActivity activity = PresearchRewardsHelper.getChromeTabbedActivity();
  ...
  public static void expandTouchArea(final View parentView, final View childView, final int extraPadding) {
    ...
    public static boolean isAnonWallet() {
      return PresearchRewardsNativeWorker.getInstance().IsAnonWallet();
    }
}
