...
public class PresearchRewardsBalance {
    ...
    /**
     * matching consts in
     * src/presearch/components/presearch_rewards/browser/balance.h
     */
    ...
    PresearchRewardsBalance (String json_balance) throws JSONException {
    ...
    public String toString() {
        return "PresearchRewardsBalance{" +
                "mTotal=" + mTotal +
                ", mWallets=" + mWallets +'}';
    }
}