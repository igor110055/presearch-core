...
public class PresearchSigninManager extends SigninManagerImpl {
    PresearchSigninManager(long nativeSigninManagerAndroid, AccountTrackerService accountTrackerService,
    ...
    private static SigninManager create(long nativeSigninManagerAndroid,
        ...
        return new PresearchSigninManager(nativeSigninManagerAndroid, accountTrackerService,
