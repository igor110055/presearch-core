...
public class PresearchAppMenuPropertiesDelegateImpl extends AppMenuPropertiesDelegateImpl {
    public PresearchAppMenuPropertiesDelegateImpl(Context context,
            ...
            for (int i = 0; i < menu.size(); ++i) {
                ...
                if (item.hasSubMenu()) {
                    ...
                    item.setIcon(AppCompatResources.getDrawable(
                            mContext, R.drawable.presearch_menu_new_private_tab));
                } else if (item.getItemId() == R.id.all_bookmarks_menu_id) {
                    item.setIcon(AppCompatResources.getDrawable(
                            mContext, R.drawable.presearch_menu_bookmarks));
                } else if (item.getItemId() == R.id.recent_tabs_menu_id) {
                    item.setIcon(AppCompatResources.getDrawable(
                            mContext, R.drawable.presearch_menu_recent_tabs));
                } else if (item.getItemId() == R.id.open_history_menu_id) {
                    item.setIcon(AppCompatResources.getDrawable(
                            mContext, R.drawable.presearch_menu_history));
                } else if (item.getItemId() == R.id.downloads_menu_id) {
                    item.setIcon(AppCompatResources.getDrawable(
                            mContext, R.drawable.presearch_menu_downloads));
                } else if (item.getItemId() == R.id.preferences_id) {
                    item.setIcon(AppCompatResources.getDrawable(
                            mContext, R.drawable.presearch_menu_settings));
                }
            }
        }
    }
