...
public class PresearchDbUtil {
    private static final String TAG = "PresearchDbUtil";
    ...
    private static PresearchDbUtil sInstance;

    private PresearchDbUtil() {
    }

    public static PresearchDbUtil getInstance() {
        if (sInstance != null)
            return sInstance;
        sInstance = new PresearchDbUtil();
        return sInstance;
    }
