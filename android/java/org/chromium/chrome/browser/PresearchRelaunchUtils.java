...
public class PresearchRelaunchUtils {
        ...
        alertDialogBuilder
            ...
            .setPositiveButton(R.string.settings_require_relaunch_now, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog,int id) {
                    PresearchRelaunchUtilsJni.get().restart();
                    dialog.cancel();
                }
            })
    ...
    public static void askForRelaunchCustom(Context context) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
        alertDialogBuilder.setTitle(R.string.reset_presearch_rewards_error_title)
                .setMessage(R.string.reset_presearch_rewards_error_description)
                .setCancelable(true)
