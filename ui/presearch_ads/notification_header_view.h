...
#ifndef PRESEARCH_UI_PRESEARCH_ADS_NOTIFICATION_HEADER_VIEW_H_
#define PRESEARCH_UI_PRESEARCH_ADS_NOTIFICATION_HEADER_VIEW_H_
...
#endif  // PRESEARCH_UI_PRESEARCH_ADS_NOTIFICATION_HEADER_VIEW_H_
