...
#include "presearch/ui/presearch_ads/notification_control_buttons_view.h"

#include <memory>

#include "presearch/app/vector_icons/vector_icons.h"
#include "presearch/grit/presearch_theme_resources.h"
#include "presearch/ui/presearch_ads/notification_view.h"
#include "presearch/ui/presearch_ads/padded_button.h"
...
void NotificationControlButtonsView::ShowInfoButton(bool show) {
  if (show && !info_button_) {
    ...
    // TODO(Albert Wang): https://github.com/presearch/presearch-browser/issues/11798
    info_button_ = std::make_unique<PaddedImage>();
    info_button_->set_owned_by_client();
    info_button_->SetImage(
        gfx::CreateVectorIcon(kPresearchAdsInfoIcon, 35, SK_ColorTRANSPARENT));
...
void NotificationControlButtonsView::ShowCloseButton(bool show) {
  if (show && !close_button_) {
    ...
    close_button_->SetImage(
        ...
        gfx::CreateVectorIcon(kPresearchAdsCloseButtonIcon, 18,
                              kPresearchAdsCloseButtonIconColor));
