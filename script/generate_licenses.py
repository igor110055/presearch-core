...
def main():
    ...
    # Presearch Ad Block component
    adblock_dir = os.path.join(third_party_dir, 'adblock')
    adblock_lists_dir = os.path.join(adblock_dir, 'lists')
    adblock_preamble = 'These licenses do not apply to any of the code shipped with the Presearch Browser, but may ' \
                       'apply to lists downloaded after installation for use with the Presearch Shields feature. ' \
                       'The Presearch Browser and such lists are separate and independent works.'
    ...
    # Presearch Local Data component
    local_data_dir = os.path.join(third_party_dir, 'local_data')
    local_data_lists_dir = os.path.join(local_data_dir, 'lists')
    local_data_preamble = 'These licenses do not apply to any of the code shipped with the Presearch Browser, but may ' \
                          'apply to data files downloaded after installation for use with various Presearch features. ' \
                          'The Presearch Browser and such data files are separate and independent works.'
    ...
    # Presearch New Tab UI component
    ntp_data_dir = os.path.join(components_dir, 'presearch_new_tab_ui', 'data')
    ntp_backgrounds_preamble = 'These licenses do not apply to any of the code shipped with the Presearch Browser and ' \
                               'instead apply to background images used on the new tab page. The Presearch Browser and ' \
