...
EXCLUSIONS = [
    # Already covered by presearch/third_party/npm-types
    '@types/jszip',
    '@types/parse-torrent',
    '@types/webtorrent',
]
...
def check_dependency(module_name):
    ...
    third_party_dir = os.path.join(os.path.dirname(SOURCE_ROOT), 'presearch', 'third_party')
...
def main():
    ...
    return_code = 0
    package_json = os.path.join(os.path.dirname(SOURCE_ROOT), 'presearch', 'package.json')
