...
PRESEARCH_REPO = "presearch/presearch-browser"
PRESEARCH_CORE_REPO = "presearch/presearch-core"
...
def get_releases_by_tag(repo, tag_name, include_drafts=False):
    ...
    release_url = GITHUB_URL + "/repos/" + PRESEARCH_REPO + "/releases?page=1&per_page=100"
