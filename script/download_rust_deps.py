...
PRESEARCH_CORE_ROOT = os.path.abspath(os.path.dirname(os.path.dirname(__file__)))

PRESEARCH_BROWSER_ROOT = os.path.abspath(
    os.path.join(os.path.dirname(__file__), os.pardir, os.pardir))

RUSTUP_PATH = os.path.join(PRESEARCH_CORE_ROOT, 'build', 'rustup')
...
def make_standalone_toolchain_for_android():
    ANDROID_NDK_PATH = os.path.join(
        PRESEARCH_BROWSER_ROOT, 'third_party', 'android_ndk')
