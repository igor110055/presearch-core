...
NPM_EXCLUDE_PATHS = [
    'build',
    os.path.join('components', 'presearch_sync', 'extension', 'presearch-sync', 'node_modules'),
    os.path.join('node_modules'),
    os.path.join('vendor', 'presearch-extension', 'node_modules'),
]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Audit presearch-core npm deps')
    parser.add_argument('input_dir', nargs='?', help='Directory to check')
    parser.add_argument('--source_root', required=True,
                        help='Full path of the src/presearch directory')
