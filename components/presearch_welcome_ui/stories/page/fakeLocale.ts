...
const locale = {
  // first screen
  welcome: 'Presearch Privacy Browser',
  whatIsPresearch: 'Presearch is a decentralized search engine powered by blockchain technology and distributed search nodes.\n Build by the community, for the community.',
