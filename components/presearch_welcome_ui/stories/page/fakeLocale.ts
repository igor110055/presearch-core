...
const locale = {
  // first screen
  welcome: 'Presearch the new Internet',
  whatIsPresearch: 'Get ready to enjoy a faster and more secure browsing experience with a browser built to protect your privacy.',
  letsGo: 'Let\'s go',
  // second screen
  ...
  p3aBody: 'Presearch Shields blocks the creepy stuff that tries to track you across the web — including most ads. Presearch uses completely private product analytics to estimate the overall usage of certain features. Turn this off in ',
  p3aSettings: 'Settings',
  p3aLink1: '#',
  p3aLink2: '#',
  // fifth screen
  enablePresearchRewards: 'Presearch Rewards',
