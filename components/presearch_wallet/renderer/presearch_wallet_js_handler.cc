...
PresearchWalletJSHandler::PresearchWalletJSHandler(content::RenderFrame* render_frame)
    : render_frame_(render_frame) {}

PresearchWalletJSHandler::~PresearchWalletJSHandler() = default;

bool PresearchWalletJSHandler::EnsureConnected() {
  if (!presearch_wallet_provider_.is_bound()) {
    render_frame_->GetBrowserInterfaceBroker()->GetInterface(
        presearch_wallet_provider_.BindNewPipeAndPassReceiver());
  }

  return presearch_wallet_provider_.is_bound();
}

void PresearchWalletJSHandler::AddJavaScriptObjectToFrame(
...
void PresearchWalletJSHandler::CreateEthereumObject(
...
void PresearchWalletJSHandler::BindFunctionsToObject(
    v8::Isolate* isolate,
    v8::Local<v8::Context> context,
    v8::Local<v8::Object> javascript_object) {
  BindFunctionToObject(isolate, javascript_object, "request",
                       base::BindRepeating(&PresearchWalletJSHandler::Request,
                                           base::Unretained(this), isolate));
}

template <typename Sig>
void PresearchWalletJSHandler::BindFunctionToObject(
    v8::Isolate* isolate,
    v8::Local<v8::Object> javascript_object,
...
v8::Local<v8::Promise> PresearchWalletJSHandler::Request(v8::Isolate* isolate,
  ...
  if (!resolver.IsEmpty()) {
    ...
    presearch_wallet_provider_->Request(
        input,
        base::BindOnce(&PresearchWalletJSHandler::OnRequest, base::Unretained(this),
...
void PresearchWalletJSHandler::OnRequest(
