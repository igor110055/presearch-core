...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_WALLET_BROWSER_PRESEARCH_WALLET_UTILS_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_WALLET_BROWSER_PRESEARCH_WALLET_UTILS_H_
...
// Used for converting domain names in the classic format (ex: presearch.crypto) to
// an ERC-721 token for ENS and Unstoppable Domains.
std::string Namehash(const std::string& name);

}  // namespace presearch_wallet

#endif  // PRESEARCH_COMPONENTS_PRESEARCH_WALLET_BROWSER_PRESEARCH_WALLET_UTILS_H_
