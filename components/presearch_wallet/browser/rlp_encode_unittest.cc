...
#include "presearch/components/presearch_wallet/browser/rlp_encode.h"
...
TEST(RLPEncodeTest, EmptyString) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("''"));
  ASSERT_EQ(ToHex(v), "0x80");
}

TEST(RLPEncodeTest, SingleChar) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("'d'"));
  ASSERT_EQ(ToHex(v), "0x64");
}

TEST(RLPEncodeTest, ShortString) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("'dog'"));
...
TEST(RLPEncodeTest, Zero) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("0"));
  ASSERT_EQ(ToHex(v), "0x80");
}

TEST(RLPEncodeTest, SmallInt1) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("1"));
  ASSERT_EQ(ToHex(v), "0x01");
}

TEST(RLPEncodeTest, SmallInt2) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("16"));
  ASSERT_EQ(ToHex(v), "0x10");
}

TEST(RLPEncodeTest, SmallInt3) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("79"));
  ASSERT_EQ(ToHex(v), "0x4f");
}

TEST(RLPEncodeTest, SmallInt4) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("127"));
  ASSERT_EQ(ToHex(v), "0x7f");
}

TEST(RLPEncodeTest, MediumInt1) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("128"));
  ASSERT_EQ(ToHex(v), "0x8180");
}

TEST(RLPEncodeTest, MediumInt2) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("1000"));
  ASSERT_EQ(ToHex(v), "0x8203e8");
}

TEST(RLPEncodeTest, MediumInt3) {
  std::string v = presearch_wallet::RLPEncode(RLPTestStringToValue("100000"));
  ASSERT_EQ(ToHex(v), "0x830186a0");
}

TEST(RLPEncodeTest, BlobStorage) {
  base::Value::BlobStorage input{0, 255, 33, 127, 0, 128};
  std::string v = presearch_wallet::RLPEncode(base::Value(input));
...
TEST(RLPEncodeTest, MediumInt4) {
  ...
  std::string v = presearch_wallet::RLPEncode(RLPUint256ToBlobValue(input));
...
TEST(RLPEncodeTest, ByteString00) {
  ...
  std::string v = presearch_wallet::RLPEncode(base::Value(bytestring));
...
TEST(RLPEncodeTest, StringList) {
  std::string v =
      presearch_wallet::RLPEncode(RLPTestStringToValue("['dog', 'god', 'cat']"));
  ASSERT_EQ(ToHex(v), "0xcc83646f6783676f6483636174");
}

TEST(RLPEncodeTest, ShortListMax1) {
  std::string v = presearch_wallet::RLPEncode(
...
TEST(RLPEncodeTest, Multilist) {
  std::string v =
      presearch_wallet::RLPEncode(RLPTestStringToValue("['zw', [4], 1]"));
  ASSERT_EQ(ToHex(v), "0xc6827a77c10401");
}

TEST(RLPEncodeTest, ListOfLists) {
  std::string v =
      presearch_wallet::RLPEncode(RLPTestStringToValue("[[[], []], []]"));
...
TEST(RLPEncodeTest, DictionaryValueNotSupported) {
  ...
  ASSERT_TRUE(presearch_wallet::RLPEncode(std::move(d)).empty());
}
