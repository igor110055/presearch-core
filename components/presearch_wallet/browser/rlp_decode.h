...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_WALLET_BROWSER_RLP_DECODE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_WALLET_BROWSER_RLP_DECODE_H_
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_WALLET_BROWSER_RLP_DECODE_H_
