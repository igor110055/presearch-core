...
#ifndef PRESEARCH_COMPONENTS_P3A_PRESEARCH_P3A_LOG_STORE_H_
#define PRESEARCH_COMPONENTS_P3A_PRESEARCH_P3A_LOG_STORE_H_
...
class PresearchP3ALogStore : public metrics::LogStore {
 public:
  class Delegate {
   public:
  ...
  PresearchP3ALogStore(Delegate* delegate,
                   PrefService* local_state);

  // TODO(iefremov): Make parent destructor virtual?
  virtual ~PresearchP3ALogStore();
...
#endif  // PRESEARCH_COMPONENTS_P3A_PRESEARCH_P3A_LOG_STORE_H_
