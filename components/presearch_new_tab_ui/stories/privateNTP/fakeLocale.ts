...
const locale = {
  ...
  headerText: 'Presearch doesn’t remember what you do in a Private Window. Sites you visit won\'t show up in your history and cookies vanish when you’re done. Private Windows don’t make you completely anonymous online, though.',
  headerButton: 'Learn more',

  // Header Private Window with Tor
  headerTorTitle: 'Private Window with Tor Connectivity',
  headerTorText: 'Presearch never remembers what you do in a Private Window. With Tor connectivity, your IP address is also hidden from the sites you visit. However, if your personal safety depends on remaining anonymous, use the Tor Browser instead.',
  headerTorButton: 'Learn more about Private Windows with Tor',

  // Box for DDG
  boxDdgLabel: 'Search Privately with',
  boxDdgTitle: 'DuckDuckGo',
  boxDdgText: 'With private search, Presearch will use DuckDuckGo for searches in Private Windows. DuckDuckGo doesn’t track your search history, so you can search privately.',
  ...
  boxTorText2: 'Using Private Windows only changes what Presearch does on your device — it doesn\'t change anyone else\'s behavior. Tor hides your IP address from the sites you visit and makes it somewhat more difficult, but not impossible, for your ISP or employer to see what sites you are visiting. Open a Private Window with Tor from the menu, or with Alt+Shift+N or Option+Shift+N.',
