...
import { getUnpaddedAsDataUrl } from '../../presearch_extension/extension/presearch_extension/background/today/privateCDN'

// @ts-ignore
window.presearchStorybookUnpadUrl = async function UnpadUrl (paddedUrl: string, mimeType = 'image/jpg'): Promise<string> {
...
function dismissPresearchTodayIntroCard () {
  console.log('presearch today intro card dismissed')
}
