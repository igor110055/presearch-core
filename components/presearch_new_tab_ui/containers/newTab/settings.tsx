...
import NraveStatsIcon from './settings/icons/presearchStats.svg'
...
import TodayIcon from './settings/icons/presearchToday.svg'

// Tabs
const BackgroundImageSettings = React.lazy(() => import('./settings/backgroundImage'))
const PresearchStatsSettings = React.lazy(() => import('./settings/presearchStats'))
...
const PresearchTodaySettings = React.lazy(() => import('./settings/presearchToday'))
...
export interface Props {
  ...
  todayPublishers?: PresearchToday.Publishers
  ...
  getTabIcon (tab: TabType, isActiveTab: boolean) {
    ...
    switch (tab) {
      case TabType.BackgroundImage:
        ...
        break
      case TabType.PresearchStats:
        srcUrl = NraveStatsIcon
        break
      case TabType.TopSites:
        srcUrl = TopSitesIcon
        break
      case TabType.PresearchToday:
        srcUrl = TodayIcon
        break
      case TabType.Clock:
        srcUrl = ClockIcon
        ...
        >
          ...
          <SettingsContent id='settingsBody'>
            ...
            <SettingsFeatureBody id='content'>
              ...
              {
                activeTab === TabType.PresearchStats
                  ? (
                    <PresearchStatsSettings
              ...
              {
                activeTab === TabType.PresearchToday
                ? (
                  <PresearchTodaySettings
