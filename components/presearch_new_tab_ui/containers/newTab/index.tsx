...
import PresearchTodayHint from '../../components/default/presearchToday/hint'
import PresearchToday from '../../components/default/presearchToday'
...
interface Props {
  ...
  onReadPresearchTodayIntroCard: () => any
...
class NewTabPage extends React.Component<Props, State> {
  ...
  hasInitPresearchToday: boolean = false
  ...
  buyCrypto = (coin: string, amount: string, fiat: string) => {
    ...
    const refParams = `ref=${refCode}&utm_source=presearch`
  ...
  startRewards = () => {
    chrome.presearchRewards.enableRewards()
  }
  ...
  onPresearchTodayInteracting = (isInteracting: boolean) => {
    if (isInteracting && !this.hasInitPresearchToday) {
      this.hasInitPresearchToday = true
  ...
  renderRewardsWidget (showContent: boolean, position: number) {
    ...
    return (
      <Rewards
        {...rewardsState}
        widgetTitle={getLocale('rewardsWidgetPresearchRewards')}
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Page.GridItemNavigationPresearchToday>
            <PresearchTodayHint />
          </Page.GridItemNavigationPresearchToday>
          }
        </Page.Page>
        ...
        <PresearchToday
          ...
          onReadCardIntro={this.props.onReadPresearchTodayIntroCard}
        />
        }
        <Settings
          actions={actions}
          ...
          allowSponsoredWallpaperUI={newTabData.featureFlagPresearchNTPSponsoredImagesWallpaper}
