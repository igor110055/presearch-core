...
export const defaultState: NewTab.State = {
  ...
  featureFlagPresearchNTPSponsoredImagesWallpaper: window.loadTimeData.getBoolean('featureFlagPresearchNTPSponsoredImagesWallpaper'),
  ...
  isPresearchTodayIntroDismissed: false,
  showEmptyPage: false,
