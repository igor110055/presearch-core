...
interface Props {
  content: (PresearchToday.Article | PresearchToday.PromotedArticle | undefined)[]
  publishers: PresearchToday.Publishers
  articleToScrollTo?: PresearchToday.FeedItem
  onReadFeedItem: OnReadFeedItem
  onSetPublisherPref: OnSetPublisherPref
  onItemViewed?: (item: PresearchToday.FeedItem) => any
  isPromoted?: boolean
}

type ArticleProps = {
  item: PresearchToday.Article | PresearchToday.PromotedArticle
