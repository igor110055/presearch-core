...
import { WithThemeVariables } from '../../../../presearch_rewards/resources/shared/components/with_theme_variables'
import { LocaleContext } from '../../../../presearch_rewards/resources/shared/lib/locale_context'
import {
  BAPDeprecationAlert,
  shouldShowBAPAlert,
  shouldShowBAPPopup,
  ...
  saveBAPPopupShown
} from '../../../../presearch_rewards/resources/shared/components/bap_deprecation'
...
export default function BAPDeprecationModal (props: Props) {
  ...
  React.useEffect(() => {
    ...
    if (shouldShowBAPPopup(onlyAnonWallet, balance.total)) {
      setPopupShown(true)
      saveBAPPopupShown()
      const popupURL = 'presearch_rewards_panel.html#bap-deprecation'
      chrome.presearchRewards.openBrowserActionUI(popupURL)
    }
  ...
  React.useEffect(() => {
    ...
    // BAP deprecation popup has been opened in the presearch rewards extension
