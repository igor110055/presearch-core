...
import { webtorrentReducer } from '../../../../presearch_webtorrent/extension/background/reducers/webtorrent_reducer'
import * as tabActions from '../../../../presearch_webtorrent/extension/actions/tab_actions'
import { torrentObjMap } from '../../testData'

// this import seems to trigger createStore and get an undefined reducer
jest.mock('../../../../presearch_webtorrent/extension/background/events/torrentEvents')
