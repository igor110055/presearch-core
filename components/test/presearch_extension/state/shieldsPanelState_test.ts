...
import { State, PersistentData } from '../../../presearch_extension/extension/presearch_extension/types/state/shieldsPannelState'
...
describe('shieldsPanelState test', () => {
  ...
  describe('isShieldsActive', () => {
    ...
    it('returns false if presearchShields is set to `block`', () => {
    ...
    it('returns true if presearchShields is not set to block', () => {
      const newState: State = deepFreeze({
        ...state,
        tabs: {
          ...state.tabs,
  ...
  describe('resetBlockingStats', () => {
    it('sets the specified stats back to 0 for the active tab', () => {
      ...
      expect(shieldsPanelState.resetBlockingStats(stateWithStats, this.tabId)).toEqual({
        ...
        tabs: {
          ...state.tabs,
          2: { ...state.tabs[2], presearchShields: 'block' },
          3: { ...state.tabs[2], id: 3, presearchShields: 'block' },
          4: { ...state.tabs[2], id: 4, presearchShields: 'block' }
        }
      })
    })
