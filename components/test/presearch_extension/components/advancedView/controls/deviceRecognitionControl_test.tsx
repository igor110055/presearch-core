...
import DeviceRecognitionControl, { Props } from '../../../../../presearch_extension/extension/presearch_extension/containers/advancedView/controls/deviceRecognitionControl'
