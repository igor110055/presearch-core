...
import ShieldsHeader, { Props } from '../../../../presearch_extension/extension/presearch_extension/containers/advancedView/header'
import { BlockOptions } from '../../../../presearch_extension/extension/presearch_extension/types/other/blockTypes'
import * as actionTypes from '../../../../presearch_extension/extension/presearch_extension/constants/shieldsPanelTypes'
...
describe('AdvancedView Header component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#presearchShieldsHeader').length === 1
