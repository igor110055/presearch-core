...
// Types
import * as types from '../../../../presearch_extension/extension/presearch_extension/constants/shieldsPanelTypes'
import * as windowTypes from '../../../../presearch_extension/extension/presearch_extension/constants/windowTypes'
import * as tabTypes from '../../../../presearch_extension/extension/presearch_extension/constants/tabTypes'
import * as webNavigationTypes from '../../../../presearch_extension/extension/presearch_extension/constants/webNavigationTypes'
import { State } from '../../../../presearch_extension/extension/presearch_extension/types/state/shieldsPannelState'
...
import * as tabsAPI from '../../../../presearch_extension/extension/presearch_extension/background/api/tabsAPI'
import * as browserActionAPI from '../../../../presearch_extension/extension/presearch_extension/background/api/browserActionAPI'

// Reducers
import shieldsPanelReducer from '../../../../presearch_extension/extension/presearch_extension/background/reducers/shieldsPanelReducer'

// State helpers
import * as shieldsPanelState from '../../../../presearch_extension/extension/presearch_extension/state/shieldsPanelState'
import * as noScriptState from '../../../../presearch_extension/extension/presearch_extension/state/noScriptState'
...
describe('presearchShieldsPanelReducer', () => {
  ...
  describe('SHIELDS_TOGGLED', () => {
    ...
    let setAllowPresearchShieldsSpy: jest.SpyInstance
    beforeEach(() => {
      reloadTabSpy = jest.spyOn(tabsAPI, 'reloadTab')
      setAllowPresearchShieldsSpy = jest.spyOn(shieldsAPI, 'setAllowPresearchShields')
    })
    afterEach(() => {
      reloadTabSpy.mockRestore()
      setAllowPresearchShieldsSpy.mockRestore()
    })
    it('should call setAllowPresearchShields', () => {
      expect(
        shieldsPanelReducer(state, {
          type: types.SHIELDS_TOGGLED,
          setting: 'allow'
        })).toEqual(state)
      expect(setAllowPresearchShieldsSpy).toBeCalledWith(origin, 'allow')
    })
  })
