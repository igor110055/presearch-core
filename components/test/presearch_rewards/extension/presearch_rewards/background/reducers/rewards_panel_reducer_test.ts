...
import reducers from '../../../../../../presearch_rewards/resources/extension/presearch_rewards/background/reducers'
import { types } from '../../../../../../presearch_rewards/resources/extension/presearch_rewards/constants/rewards_panel_types'
import { defaultState } from '../../../../../../presearch_rewards/resources/extension/presearch_rewards/background/storage'
  ...
  describe('ON_PUBLISHER_LIST_NORMALIZED', () => {
    ...
    it('publisher is update accordingly', () => {
      const list = [
        ...
        {
          publisherKey: 'presearch1.com',
          percentage: 30,
          status: 2
        },
        {
          publisherKey: 'presearch2.com',
          percentage: 10,
          status: 2
        },
        {
          publisherKey: 'presearch3.com',
          percentage: 10,
          status: 2
        }
      ]
      ...
      let state = {
        ...
        publishers: {
          ...
          key_2: {
            tabUrl: 'https://presearch4.com',
            publisherKey: 'presearch4.com',
            percentage: 40,
            status: 2
          }
        }
