...
import { SettingsMenu } from '../../../../components/presearch_new_tab_ui/components/default'
import Settings, { Props } from '../../../../components/presearch_new_tab_ui/containers/newTab/settings'
