...
// Initial state
import { defaultState as welcomeData } from '../../components/presearch_welcome_ui/storage'
import { defaultState as rewardsData } from '../../components/presearch_rewards/resources/page/storage'
import { defaultState as adblockData } from '../../components/presearch_adblock_ui/storage'

// Types
import { Tab } from '../presearch_extension/extension/presearch_extension/types/state/shieldsPannelState'
import { BlockDetails } from '../presearch_extension/extension/presearch_extension/types/actions/shieldsPanelActions'
...
let mockSettings: MockSettingsStore = {
  ['presearch.shields.advanced_view_enabled']: {
    key: 'presearch.shields.advanced_view_enabled',
    type: 'BOOLEAN',
    value: false
  },
  ['presearch.shields.stats_badge_visible']: {
    key: 'presearch.shields.stats_badge_visible',
    type: 'BOOLEAN',
    value: true
  }
}
...
export const getMockChrome = () => {
  let mock = {
    ...
    presearchTheme: {
      setPresearchThemeType: function (theme: string) {
        return
      }
    },
    runtime: {
    ...
    presearchShields: {
      ...
      getPresearchShieldsEnabledAsync: function (url: string) {
      ...
      setPresearchShieldsEnabledAsync: function (url: string, enabled: boolean) {
        return new Promise(() => [])
      },
...
export const mockSearchProviders = [
  {
    ...
    modelIndex: 1,
    name: 'DuckDuckGo',
    url: 'https://duckduckgo.com/?q=%s&t=presearch',
    urlLocked: true
  }
]
