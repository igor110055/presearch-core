...
#ifndef PRESEARCH_COMPONENTS_DECENTRALIZED_DNS_CONSTANTS_H_
#define PRESEARCH_COMPONENTS_DECENTRALIZED_DNS_CONSTANTS_H_
...
#endif  // PRESEARCH_COMPONENTS_DECENTRALIZED_DNS_CONSTANTS_H_
