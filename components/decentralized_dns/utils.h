...
#ifndef PRESEARCH_COMPONENTS_DECENTRALIZED_DNS_UTILS_H_
#define PRESEARCH_COMPONENTS_DECENTRALIZED_DNS_UTILS_H_
...
#endif  // PRESEARCH_COMPONENTS_DECENTRALIZED_DNS_UTILS_H_
