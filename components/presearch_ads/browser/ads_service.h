...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_ADS_BROWSER_ADS_SERVICE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_ADS_BROWSER_ADS_SERVICE_H_
...
#include "presearch/components/presearch_ads/browser/ads_service_observer.h"
#include "presearch/vendor/bat-native-ads/include/bat/ads/public/interfaces/ads.mojom.h"
...
class AdsService : public KeyedService {
 public:
  ...
  virtual void OnNewTabPageAdEvent(
      ...
      const ads::mojom::PresearchAdsNewTabPageAdEventType event_type) = 0;

  virtual void OnPromotedContentAdEvent(
      const std::string& uuid,
      const std::string& creative_instance_id,
      const ads::mojom::PresearchAdsPromotedContentAdEventType event_type) = 0;
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_ADS_BROWSER_ADS_SERVICE_H_
