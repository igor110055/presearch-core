...
#include "presearch/components/presearch_ads/browser/background_helper_mac.h"
...
@interface BackgroundHelperDelegate : NSObject {
 @private
  presearch_ads::BackgroundHelper* helper_;  // NOT OWNED
}
...
- (id)initWithHelper:(presearch_ads::BackgroundHelper*)helper {
  if ((self = [super init])) {
    helper_ = helper;
