...
// static
std::unique_ptr<presearch_ads::Notification> CreateAdNotification(
    const ads::AdNotificationInfo& info) {
  presearch_ads::RichNotificationData notification_data;
  ...
  auto notification = std::make_unique<presearch_ads::Notification>(
...
std::unique_ptr<message_center::Notification> CreateMessageCenterNotification(
  ...
  auto notification = std::make_unique<message_center::Notification>(
      ...
      gfx::Image(), base::string16(), GURL(kPresearchAdsUrlPrefix + info.uuid),
