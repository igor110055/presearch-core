...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_ADS_BROWSER_ADS_SERVICE_IMPL_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_ADS_BROWSER_ADS_SERVICE_IMPL_H_
...
using presearch_ads::ResourceComponent;
...
class AdsServiceImpl : public AdsService,
 ...
 private:
  ...
  void OnGetPresearchWallet(ledger::type::PresearchWalletPtr wallet);
  ...
  bool IsUpgradingFromPrePresearchAdsBuild();

  void DisableAdsIfUpgradingFromPrePresearchAdsBuild();
  ...
  bool is_upgrading_from_pre_presearch_ads_build_;
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_ADS_BROWSER_ADS_SERVICE_IMPL_H_
