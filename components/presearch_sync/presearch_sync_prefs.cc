...
const char kSyncV2Seed[] = "presearch_sync_v2.seed";
// Indicate whether migration has been done from v1 to v2
const char kSyncV1Migrated[] = "presearch_sync_v2.v1_migrated";
// Indicate all meta info set in V1 has been stripped in
// PresearchBookmarkModelLoadedObserver
const char kSyncV1MetaInfoCleared[] = "presearch_sync_v2.v1_meta_info_cleared";
// Has dismissed message about migration to sync v2
const char kSyncV2MigrateNoticeDismissed[] =
    "presearch_sync_v2.migrate_notice_dismissed";
// Deprecated
// ============================================================================
const char kSyncSeed[] = "presearch_sync.seed";
const char kSyncEnabled[] = "presearch_sync.enabled";
const char kSyncDeviceId[] = "presearch_sync.device_id";
const char kSyncDeviceIdV2[] = "presearch_sync.device_id_v2";
const char kSyncDeviceObjectId[] = "presearch_sync.device_object_id";
const char kSyncPrevSeed[] = "presearch_sync.previous_seed";
const char kSyncDeviceName[] = "presearch_sync.device_name";
const char kSyncBookmarksBaseOrder[] = "presearch_sync.bookmarks_base_order";
const char kSyncBookmarksEnabled[] = "presearch_sync.bookmarks_enabled";
const char kSyncSiteSettingsEnabled[] = "presearch_sync.site_settings_enabled";
const char kSyncHistoryEnabled[] = "presearch_sync.history_enabled";
const char kSyncLatestRecordTime[] = "presearch_sync.latest_record_time";
const char kSyncLatestDeviceRecordTime[] =
    "presearch_sync.latest_device_record_time";
const char kSyncLastFetchTime[] = "presearch_sync.last_fetch_time";
const char kSyncLastCompactTimeBookmarks[] =
    "presearch_sync.last_compact_time.bookmarks";
const char kSyncDeviceList[] = "presearch_sync.device_list";
const char kSyncApiVersion[] = "presearch_sync.api_version";
const char kSyncMigrateBookmarksVersion[]
                                       = "presearch_sync.migrate_bookmarks_version";
const char kSyncRecordsToResend[] = "presearch_sync_records_to_resend";
const char kSyncRecordsToResendMeta[] = "presearch_sync_records_to_resend_meta";
const char kDuplicatedBookmarksRecovered[] =
    "presearch_sync_duplicated_bookmarks_recovered";
const char kDuplicatedBookmarksMigrateVersion[] =
    "presearch_sync_duplicated_bookmarks_migrate_version";
// ============================================================================
}  // namespace
