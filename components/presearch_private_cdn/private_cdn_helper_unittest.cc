...
#include "presearch/components/presearch_private_cdn/private_cdn_helper.h"

#include "testing/gtest/include/gtest/gtest.h"

TEST(PresearchPrivateCdnHelper, RemovePadding) {
  auto* helper = presearch::PrivateCdnHelper::GetInstance();
