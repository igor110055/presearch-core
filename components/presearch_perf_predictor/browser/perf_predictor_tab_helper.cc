...
#include "presearch/components/presearch_perf_predictor/browser/named_third_party_registry_factory.h"
...
void PerfPredictorTabHelper::DispatchBlockedEvent(
  ...
  PerfPredictorTabHelper* blocking_observer =
      presearch_perf_predictor::PerfPredictorTabHelper::FromWebContents(
          web_contents);
...
#if defined(OS_ANDROID)
        chrome::android::PresearchShieldsContentSettings::DispatchSavedBandwidth(
          savings);
#endif
    }
  }
