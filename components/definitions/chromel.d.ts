...
declare namespace chrome.presearchRewards {
...
declare namespace chrome.presearchTogether {
  const isSupported: (callback: (supported: boolean) => void) => {}
}
...
declare namespace chrome.presearchToday {
...
declare namespace chrome.presearchShields {
  const onBlocked: {
  ...
  const setPresearchShieldsEnabledAsync: any
  const getPresearchShieldsEnabledAsync: any
  ...
  type PresearchShieldsViewPreferences = {
    showAdvancedView: boolean
    statsBadgeVisible: boolean
  }
}

declare namespace chrome.presearchWallet {
...
declare namespace chrome.presearchTheme {
  ...
  const getPresearchThemeType: (themeType: ThemeTypeCallback) => void
  const getPresearchThemeList: (themeList: ThemeListCallback) => void
  const setPresearchThemeType: (themeType: ThemeType) => void
  const onPresearchThemeTypeChanged: {
