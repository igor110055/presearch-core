...
using PresearchWaybackMachineTest = InProcessBrowserTest;
using ::testing::_;
...
IN_PROC_BROWSER_TEST_F(PresearchWaybackMachineTest, InfobarAddTest) {
  auto* model = browser()->tab_strip_model();
  auto* contents = model->GetActiveWebContents();
  auto* tab_helper = PresearchWaybackMachineTabHelper::FromWebContents(contents);
