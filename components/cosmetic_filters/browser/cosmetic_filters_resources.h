...
#ifndef PRESEARCH_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
#define PRESEARCH_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
...
class CosmeticFiltersResources final
 ...
 public:
  ...
  CosmeticFiltersResources(HostContentSettingsMap* settings_map,
                           presearch_shields::AdBlockService* ad_block_service);
 ...
 private:
  ...
  presearch_shields::AdBlockService* ad_block_service_;  // Not owned
...
#endif  // PRESEARCH_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
