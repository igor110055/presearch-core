...
void CosmeticFiltersResources::HiddenClassIdSelectors(
  ...
  ad_block_service_->GetTaskRunner()->PostTaskAndReplyWithResult(
      FROM_HERE,
      base::BindOnce(&presearch_shields::AdBlockService::HiddenClassIdSelectors,
...
void CosmeticFiltersResources::ShouldDoCosmeticFiltering(
  ...
  bool enabled =
      presearch_shields::ShouldDoCosmeticFiltering(settings_map_, GURL(url));
  bool first_party_enabled =
      presearch_shields::IsFirstPartyCosmeticFilteringEnabled(settings_map_,
                                                          GURL(url));
...
void CosmeticFiltersResources::UrlCosmeticResources(
  ...
  ad_block_service_->GetTaskRunner()->PostTaskAndReplyWithResult(
      FROM_HERE,
      base::BindOnce(&presearch_shields::AdBlockService::UrlCosmeticResources,
