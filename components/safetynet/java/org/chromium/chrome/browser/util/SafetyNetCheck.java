...
public class SafetyNetCheck {
    ...
    */
    ...
    private boolean clientAttestation(String nonceData, String apiKey,
        ...
        boolean res = false;
        try {
            Activity activity = (Activity)PresearchRewardsHelper.getChromeTabbedActivity();
        ...
        if (performAttestationOnClient) {
            if (tokenReceived) {
                ...
                if (tokenParts.length >= 2) {
                    ...
                    PresearchPrefServiceBridge.getInstance().setSafetynetStatus(attestationPassed
                ...
                PresearchPrefServiceBridge.getInstance().setSafetynetStatus(
