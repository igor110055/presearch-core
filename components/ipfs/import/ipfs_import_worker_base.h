...
#ifndef PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_IMPORT_WORKER_BASE_H_
#define PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_IMPORT_WORKER_BASE_H_
...
#include "presearch/components/ipfs/import/import_utils.h"
...
class IpfsImportWorkerBase {
 ...
 private:
  ...
  void CreatePresearchDirectory();
  void OnImportDirectoryCreated(const std::string& directory,
                                std::unique_ptr<std::string> response_body);
  void CopyFilesToPresearchDirectory();
...
#endif  // PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_IMPORT_WORKER_BASE_H_
