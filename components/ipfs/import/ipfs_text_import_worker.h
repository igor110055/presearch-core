...
#ifndef PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_TEXT_IMPORT_WORKER_H_
#define PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_TEXT_IMPORT_WORKER_H_
...
#endif  // PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_TEXT_IMPORT_WORKER_H_
