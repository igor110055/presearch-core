...
#ifndef PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
#define PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
...
#endif  // PRESEARCH_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
