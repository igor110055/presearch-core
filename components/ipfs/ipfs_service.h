...
#ifndef PRESEARCH_COMPONENTS_IPFS_IPFS_SERVICE_H_
#define PRESEARCH_COMPONENTS_IPFS_IPFS_SERVICE_H_
...
#include "presearch/components/ipfs/ipfs_p3a.h"
...
class IpfsService : public KeyedService,
                    public PresearchIpfsClientUpdater::Observer {
 public:
 ...
 private:
  ...
  // PresearchIpfsClientUpdater::Observer
  ...
  PresearchIpfsClientUpdater* ipfs_client_updater_;
...
#endif  // PRESEARCH_COMPONENTS_IPFS_IPFS_SERVICE_H_
