...
#ifndef PRESEARCH_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
#define PRESEARCH_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
...
#endif  // PRESEARCH_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
