...
#ifndef PRESEARCH_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
#define PRESEARCH_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
...
#endif  // PRESEARCH_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
