...
#include "presearch/components/ipfs/import/ipfs_directory_import_worker.h"
#include "presearch/components/ipfs/import/ipfs_file_import_worker.h"
#include "presearch/components/ipfs/import/ipfs_import_worker_base.h"
#include "presearch/components/ipfs/import/ipfs_link_import_worker.h"
#include "presearch/components/ipfs/import/ipfs_text_import_worker.h"
#include "presearch/components/ipfs/ipfs_constants.h"
#include "presearch/components/ipfs/ipfs_json_parser.h"
#include "presearch/components/ipfs/ipfs_ports.h"
#include "presearch/components/ipfs/ipfs_service_observer.h"
  ...
  return net::DefineNetworkTrafficAnnotation("ipfs_service", R"(
          semantics {
            ...
            description:
              ...
              "on behalf of the user interacting with the actions in presearch://ipfs."
            trigger:
              "Triggered by actions in presearch://ipfs."
            data:
          ...
          policy {
            cookies_allowed: NO
            setting:
              "You can enable or disable this feature in presearch://settings."
...
IpfsService::IpfsService(content::BrowserContext* context,
                         ipfs::PresearchIpfsClientUpdater* ipfs_client_updater,
  ...
  // Return early since g_presearch_browser_process and ipfs_client_updater are not
...
base::FilePath IpfsService::GetDataPath() const {
  return user_data_dir_.Append(FILE_PATH_LITERAL("presearch_ipfs"));
}
