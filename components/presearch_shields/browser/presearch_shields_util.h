...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_PRESEARCH_SHIELDS_UTIL_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_PRESEARCH_SHIELDS_UTIL_H_
...
void ResetPresearchShieldsEnabled(HostContentSettingsMap* map,
                              const GURL& url);
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_PRESEARCH_SHIELDS_UTIL_H_
