...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_AD_BLOCK_BASE_SERVICE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_AD_BLOCK_BASE_SERVICE_H_
...
// The base class of the presearch shields service in charge of ad-block
// checking and init.
class AdBlockBaseService : public BasePresearchShieldsService {
 public:
  using GetDATFileDataResult =
      presearch_component_updater::LoadDATFileDataResult<adblock::Engine>;

  explicit AdBlockBaseService(PresearchComponent::Delegate* delegate);
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_AD_BLOCK_BASE_SERVICE_H_
