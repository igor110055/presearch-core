...
AdBlockBaseService::AdBlockBaseService(PresearchComponent::Delegate* delegate)
    : BasePresearchShieldsService(delegate),
...
void AdBlockBaseService::GetDATFileData(const base::FilePath& dat_file_path) {
  base::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(&presearch_component_updater::LoadDATFileData<adblock::Engine>,
                     dat_file_path),
