...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
...
const char kAdBlockComponentName[] = "Presearch Ad Block Updater";
...
class AdBlockService : public AdBlockBaseService {
 public:
  explicit AdBlockService(PresearchComponent::Delegate* delegate);
 ...
 private:
  ...
  std::unique_ptr<presearch_shields::AdBlockRegionalServiceManager>
      regional_service_manager_;
  std::unique_ptr<presearch_shields::AdBlockCustomFiltersService>
      custom_filters_service_;

  PresearchComponent::Delegate* component_delegate_;
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
