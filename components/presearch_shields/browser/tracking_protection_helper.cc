...
void SetStartingSiteForRenderFrame(GURL starting_site,
  ...
  g_presearch_browser_process->tracking_protection_service()
...
void DeleteRenderFrameKey(int render_process_id, int render_frame_id) {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  g_presearch_browser_process->tracking_protection_service()->DeleteRenderFrameKey(
...
void ModifyRenderFrameKey(int old_render_process_id,
  ...
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  g_presearch_browser_process->tracking_protection_service()->ModifyRenderFrameKey(
