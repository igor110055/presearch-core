...
class HTTPSEverywhereServiceTest : public ExtensionBrowserTest {
 public:
  ...
  void PreRunTestOnMainThread() override {
    ...
    ASSERT_TRUE(
      g_presearch_browser_process->https_everywhere_service()->IsInitialized());
  }
  ...
  void InitService() {
    presearch_shields::HTTPSEverywhereService::SetIgnorePortForTest(true);
  ...
  bool InstallHTTPSEverywhereExtension() {
    ...
    g_presearch_browser_process->https_everywhere_service()->OnComponentReady(
  ...
  void WaitForHTTPSEverywhereServiceThread() {
    scoped_refptr<base::ThreadTestHelper> io_helper(new base::ThreadTestHelper(
        g_presearch_browser_process->https_everywhere_service()->GetTaskRunner()));
