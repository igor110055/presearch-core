...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_HTTPS_EVERYWHERE_SERVICE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_HTTPS_EVERYWHERE_SERVICE_H_
...
#include "presearch/components/presearch_shields/browser/https_everywhere_recently_used_cache.h"
...
class HTTPSEverywhereService : public BasePresearchShieldsService,
                         public base::SupportsWeakPtr<HTTPSEverywhereService> {
 public:
  explicit HTTPSEverywhereService(PresearchComponent::Delegate* delegate);
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_SHIELDS_BROWSER_HTTPS_EVERYWHERE_SERVICE_H_
