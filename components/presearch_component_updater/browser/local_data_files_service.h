...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
...
const char kLocalDataFilesComponentName[] = "Presearch Local Data Updater";
...
class LocalDataFilesService : public PresearchComponent {
 public:
  explicit LocalDataFilesService(PresearchComponent::Delegate* delegate);
...
LocalDataFilesServiceFactory(PresearchComponent::Delegate* delegate);

}  // namespace presearch_component_updater

#endif  // PRESEARCH_COMPONENTS_PRESEARCH_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
