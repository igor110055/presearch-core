...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_COMPONENT_UPDATER_BROWSER_DAT_FILE_UTIL_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_COMPONENT_UPDATER_BROWSER_DAT_FILE_UTIL_H_
...
using LoadDATFileDataResult =
    std::pair<std::unique_ptr<T>, presearch_component_updater::DATFileDataBuffer>;
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_COMPONENT_UPDATER_BROWSER_DAT_FILE_UTIL_H_
