...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_PROCHLO_PROCHLO_CRYPTO_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_PROCHLO_PROCHLO_CRYPTO_H_
...
class Crypto {
 ...
 private:
  friend class PresearchProchloCrypto;
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_PROCHLO_PROCHLO_CRYPTO_H_
