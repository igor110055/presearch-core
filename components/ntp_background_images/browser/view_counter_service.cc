...
constexpr char kNewTabsCreated[] = "presearch.new_tab_page.p3a_new_tabs_created";
constexpr char kSponsoredNewTabsCreated[] =
    "presearch.new_tab_page.p3a_sponsored_new_tabs_created";
...
ViewCounterService::ViewCounterService(NTPBackgroundImagesService* service,
                                       presearch_ads::AdsService* ads_service,
                                       PrefService* prefs,
...
void ViewCounterService::BrandedWallpaperWillBeDisplayed(
  ...
  ads_service_->OnNewTabPageAdEvent(wallpaper_id, creative_instance_id,
      ads::mojom::PresearchAdsNewTabPageAdEventType::kViewed);
...
void ViewCounterService::BrandedWallpaperLogoClicked(
  ...
  ads_service_->OnNewTabPageAdEvent(wallpaper_id, creative_instance_id,
      ads::mojom::PresearchAdsNewTabPageAdEventType::kClicked);
}
...
void ViewCounterService::UpdateP3AValues() const {
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Presearch.NTP.NewTabsCreated", answer,
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Presearch.NTP.SponsoredNewTabsCreated", answer,
