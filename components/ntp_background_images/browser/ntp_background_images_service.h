...
#ifndef PRESEARCH_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
#define PRESEARCH_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
...
class NTPBackgroundImagesService {
 ...
 private:
  ...
  // not show SI images until user chooses Presearch default images. So, we should
...
#endif  // PRESEARCH_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
