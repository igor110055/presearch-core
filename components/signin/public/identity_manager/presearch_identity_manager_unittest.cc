...
class PresearchIdentityManagerTest : public testing::Test {
 protected:
  PresearchIdentityManagerTest()
  ...
  ~PresearchIdentityManagerTest() override { signin_client_.Shutdown(); }

  PresearchIdentityManagerTest(const PresearchIdentityManagerTest&) = delete;
  PresearchIdentityManagerTest& operator=(const PresearchIdentityManagerTest&) = delete;
  ...
  void RecreateIdentityManager() {
    ...
    identity_manager_.reset(new PresearchIdentityManager(std::move(init_params)));
    identity_manager_observer_.reset(
...
TEST_F(PresearchIdentityManagerTest, GetAccountsInCookieJarWithNoAccounts) {
...
TEST_F(PresearchIdentityManagerTest, GetAccountsInCookieJarWithOneAccount) {
  base::RunLoop run_loop;
  identity_manager_observer()->SetOnAccountsInCookieUpdatedCallback(
      run_loop.QuitClosure());
...
TEST_F(PresearchIdentityManagerTest, GetAccountsInCookieJarWithTwoAccounts) {
  base::RunLoop run_loop;
  identity_manager_observer()->SetOnAccountsInCookieUpdatedCallback(
      run_loop.QuitClosure());
