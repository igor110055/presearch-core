...
#ifndef PRESEARCH_COMPONENTS_SEARCH_ENGINES_PRESEARCH_PREPOPULATED_ENGINES_H_
#define PRESEARCH_COMPONENTS_SEARCH_ENGINES_PRESEARCH_PREPOPULATED_ENGINES_H_
...
extern const int kPresearchCurrentDataVersion;
extern const int kPresearchFirstTrackedDataVersion;
...
enum PresearchPrepopulatedEngineID : unsigned int {
  ...
  PRESEARCH_PREPOPULATED_ENGINES_START = 500,
...
#endif  // PRESEARCH_COMPONENTS_SEARCH_ENGINES_PRESEARCH_PREPOPULATED_ENGINES_H_
