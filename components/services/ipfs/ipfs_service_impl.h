...
#ifndef PRESEARCH_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
#define PRESEARCH_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
...
#endif  // PRESEARCH_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
