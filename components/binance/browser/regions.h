...
#ifndef PRESEARCH_COMPONENTS_BINANCE_BROWSER_REGIONS_H_
#define PRESEARCH_COMPONENTS_BINANCE_BROWSER_REGIONS_H_
...
#endif  // PRESEARCH_COMPONENTS_BINANCE_BROWSER_REGIONS_H_
