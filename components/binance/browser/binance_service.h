...
#ifndef PRESEARCH_COMPONENTS_BINANCE_BROWSER_BINANCE_SERVICE_H_
#define PRESEARCH_COMPONENTS_BINANCE_BROWSER_BINANCE_SERVICE_H_
...
#endif  // PRESEARCH_COMPONENTS_BINANCE_BROWSER_BINANCE_SERVICE_H_
