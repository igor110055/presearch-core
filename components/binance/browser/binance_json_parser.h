...
#ifndef PRESEARCH_COMPONENTS_BINANCE_BROWSER_BINANCE_JSON_PARSER_H_
#define PRESEARCH_COMPONENTS_BINANCE_BROWSER_BINANCE_JSON_PARSER_H_
...
#endif  // PRESEARCH_COMPONENTS_BINANCE_BROWSER_BINANCE_JSON_PARSER_H_
