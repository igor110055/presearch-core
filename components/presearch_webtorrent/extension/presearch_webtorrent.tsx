...
// to presearch_webtorrent2.html and have that rewrite the URL to
// presearch_webtorrent.html
if (window.location.pathname === '/extension/presearch_webtorrent2.html') {
  window.location.href =
    window.location.href.replace('presearch_webtorrent2.html', 'presearch_webtorrent.html')
}
