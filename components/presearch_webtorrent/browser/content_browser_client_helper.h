...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
...
static GURL TranslateMagnetURL(const GURL& url) {
  GURL extension_page_url(
      base::StrCat({extensions::kExtensionScheme, "://",
        ...
        "/extension/presearch_webtorrent.html?%s"}));
...
static bool HandleTorrentURLReverseRewrite(GURL* url,
  ...
  if (url->SchemeIs(extensions::kExtensionScheme) &&
      url->host() == presearch_webtorrent_extension_id &&
      url->ExtractFileName() == "presearch_webtorrent.html" &&
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
