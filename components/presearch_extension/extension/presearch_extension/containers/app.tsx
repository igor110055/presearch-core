...
import PresearchShields from '../containers/presearchShields'
import { State } from '../types/state/mainState'

const mapStateToProps = (
  state: State,
  ownProps: {
    settings: chrome.presearchShields.PresearchShieldsViewPreferences
  }
) => {
  return ({
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(PresearchShields as any) // TODO remove any
