...
export default class Shields extends React.PureComponent<Props, State> {
  ...
  get isShieldsEnabled (): boolean {
    const { presearchShields } = this.props.shieldsPanelTabData
    return isShieldsEnabled(presearchShields)
  }
  ...
  render () {
    ...
    return (
      <ShieldsPanel data-test-id='presearch-shields-panel' style={{ width: '370px' }}>
        {
