...
#ifndef PRESEARCH_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
#define PRESEARCH_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
...
#endif  // PRESEARCH_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
