...
static SPEEDREADER_CSS: &str = "https://raw.githubusercontent.com/presearch-experiments/SpeedReader/master/data/content-stylesheet.css";
...
fn main() {
    ...
    let sheet = format!(
        "<style id=\"presearch_speedreader_style\">{}</style>",
