...
#ifndef PRESEARCH_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_H_
#define PRESEARCH_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_H_
...
#endif  // PRESEARCH_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_H_
