...
#include "presearch/components/speedreader/speedreader_url_loader.h"
    ...
    base::PostTaskAndReplyWithResult(
        ...
        base::BindOnce(
            [](std::string data, std::unique_ptr<Rewriter> rewriter,
              ...
              SCOPED_UMA_HISTOGRAM_TIMER("Presearch.Speedreader.Distill");
              ...
              // TODO(presearch-browser/issues/10372): would be better to pass
