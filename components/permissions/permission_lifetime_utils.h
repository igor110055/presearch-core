...
#ifndef PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
#define PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
...
#endif  // PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
