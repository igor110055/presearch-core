...
class PresearchPermissionDialogModel {
    ...
    private static void addLifetimeOptions(View customView, PermissionDialogDelegate delegate) {
        ...
        PresearchPermissionDialogDelegate presearchDelegate =
                (PresearchPermissionDialogDelegate) (Object) delegate;

        String[] lifetimeOptions = presearchDelegate.getLifetimeOptions();
        ...
        lifetimeOptionsText.setText(presearchDelegate.getLifetimeOptionsText());
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                presearchDelegate.setSelectedLifetimeOption(checkedId);
            }
        });
        radioGroup.check(0);
