...
#ifndef PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
#define PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
...
#endif  // PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
