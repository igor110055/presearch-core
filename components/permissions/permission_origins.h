...
#ifndef PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
#define PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
...
#endif  // PRESEARCH_COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
