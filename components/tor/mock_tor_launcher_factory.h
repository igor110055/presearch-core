...
#ifndef PRESEARCH_COMPONENTS_TOR_MOCK_TOR_LAUNCHER_FACTORY_H_
#define PRESEARCH_COMPONENTS_TOR_MOCK_TOR_LAUNCHER_FACTORY_H_
...
#endif  // PRESEARCH_COMPONENTS_TOR_MOCK_TOR_LAUNCHER_FACTORY_H_
