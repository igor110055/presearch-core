...
#include "presearch/components/tor/service_sandbox_type.h"
#include "presearch/components/tor/tor_file_watcher.h"
...
void TorLauncherFactory::OnTorControlClosed(bool was_running) {
  ...
  // TODO(riastradh-presearch): Rate limit in case of flapping?
  if (was_running) {
    LaunchTorInternal();
  }
}
