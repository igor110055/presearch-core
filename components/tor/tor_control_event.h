...
#ifndef PRESEARCH_COMPONENTS_TOR_TOR_CONTROL_EVENT_H_
#define PRESEARCH_COMPONENTS_TOR_TOR_CONTROL_EVENT_H_
...
#endif  // PRESEARCH_COMPONENTS_TOR_TOR_CONTROL_EVENT_H_
