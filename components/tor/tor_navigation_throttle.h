...
#ifndef PRESEARCH_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
#define PRESEARCH_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
...
#endif  // PRESEARCH_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
