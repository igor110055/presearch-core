...
#ifndef PRESEARCH_COMPONENTS_TOR_TOR_LAUNCHER_OBSERVER_H_
#define PRESEARCH_COMPONENTS_TOR_TOR_LAUNCHER_OBSERVER_H_
...
#endif  // PRESEARCH_COMPONENTS_TOR_TOR_LAUNCHER_OBSERVER_H_
