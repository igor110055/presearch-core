...
#ifndef PRESEARCH_COMPONENTS_GREASELION_BROWSER_GREASELION_DOWNLOAD_SERVICE_H_
#define PRESEARCH_COMPONENTS_GREASELION_BROWSER_GREASELION_DOWNLOAD_SERVICE_H_
...
struct GreaselionPreconditions {
  ...
  GreaselionPreconditionValue supports_minimum_presearch_version = kAny;
};
...
class GreaselionRule {
 ...
 private:
  ...
  std::string run_at_;
  std::string minimum_presearch_version_;
...
#endif  // PRESEARCH_COMPONENTS_GREASELION_BROWSER_GREASELION_DOWNLOAD_SERVICE_H_
