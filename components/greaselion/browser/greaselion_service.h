...
#ifndef PRESEARCH_COMPONENTS_GREASELION_BROWSER_GREASELION_SERVICE_H_
#define PRESEARCH_COMPONENTS_GREASELION_BROWSER_GREASELION_SERVICE_H_
...
enum GreaselionFeature {
  ...
  AUTO_CONTRIBUTION,
  ADS,
  SUPPORTS_MINIMUM_PRESEARCH_VERSION,
  LAST_FEATURE
};
...
#endif  // PRESEARCH_COMPONENTS_GREASELION_BROWSER_GREASELION_SERVICE_H_
