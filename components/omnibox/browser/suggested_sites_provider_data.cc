...
#include "presearch/components/binance/browser/regions.h"
  ...
  static const std::vector<SuggestedSitesMatch> suggested_sites = {
      {
          SuggestedSitesMatch(
              ...
              GURL(GetLocalizedURL(
                  "?fiat=USD&crypto=BTC&ref=39346846&utm_source=presearch", false)),
      ...
      },
      {
          SuggestedSitesMatch(
              "ethereum",
              GURL(GetLocalizedURL(
                  "?fiat=USD&crypto=ETH&ref=39346846&utm_source=presearch", false)),
      ...
      },
      {
          SuggestedSitesMatch(
              "litecoin",
              GURL(GetLocalizedURL(
                  "?fiat=USD&crypto=LTC&ref=39346846&utm_source=presearch", false)),
      ...
      },
      {
          SuggestedSitesMatch(
              "bnb",
              GURL(GetLocalizedURL(
                  "?fiat=USD&crypto=BNB&ref=39346846&utm_source=presearch", false)),
      ...
      },
      {
          SuggestedSitesMatch(
              ...
              GURL("https://www.binance.us/en/buy-sell-crypto"
                   "?fiat=USD&crypto=BTC&ref=35089877&utm_source=presearch"),
      ...
      },
      {
          SuggestedSitesMatch(
              "ethereum",
              GURL("https://www.binance.us/en/buy-sell-crypto"
                   "?fiat=USD&crypto=ETH&ref=35089877&utm_source=presearch"),
      ...
      },
      {
          SuggestedSitesMatch(
              "bnb",
              GURL("https://www.binance.us/en/buy-sell-crypto"
                   "?fiat=USD&crypto=BNB&ref=35089877&utm_source=presearch"),
