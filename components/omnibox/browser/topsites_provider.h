...
#ifndef PRESEARCH_COMPONENTS_OMNIBOX_BROWSER_TOPSITES_PROVIDER_H_
#define PRESEARCH_COMPONENTS_OMNIBOX_BROWSER_TOPSITES_PROVIDER_H_
...
#endif  // PRESEARCH_COMPONENTS_OMNIBOX_BROWSER_TOPSITES_PROVIDER_H_
