      ...
      <Grid columns={1} customStyle={{ maxWidth: '270px', margin: '0 auto' }}>
        ...
        { shouldAllowAdsSubdivisionTargeting ?
          <>
            ...
            <div>
              {getLocale('adsSubdivisionTargetingDescription')} <a href={'https://support.presearch.com/hc/en-us/articles/360026361072-Presearch-Ads-FAQ'} target={'_blank'}>{getLocale('adsSubdivisionTargetingLearn')}</a>
            </div>
          </> : null }
      </Grid>
    )
    ...
    if (isDisabled) {
      boxPropsExtra.alertContent = safetyNetFailed
         ...
         : !adsIsSupported
           ...
           : <>This version of Presearch does not support Ads.</>
    }
