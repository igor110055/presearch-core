...
export const constructBackupString = (backupKey: string) => {
  return `Presearch Wallet Recovery Key\nDate created: ${new Date(Date.now()).toLocaleDateString()} \n\nRecovery Key: ${backupKey}` +
    '\n\nNote: This key is not stored on Presearch servers. ' +
    'This key is your only method of recovering your Presearch wallet. ' +
    'Save this key in a safe place, separate from your Presearch browser. ' +
