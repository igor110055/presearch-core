...
const rewardsInternalsReducer: Reducer<RewardsInternals.State | undefined> = (state: RewardsInternals.State | undefined, action) => {
  ...
  switch (action.type) {
    case types.GET_REWARDS_INTERNALS_INFO:
      chrome.send('presearch_rewards_internals.getRewardsInternalsInfo')
      break
    ...
    case types.GET_BALANCE:
      chrome.send('presearch_rewards_internals.getBalance')
      break
    ...
    case types.GET_CONTRIBUTIONS:
      chrome.send('presearch_rewards_internals.getContributions')
      break
    ...
    case types.GET_PROMOTIONS:
      chrome.send('presearch_rewards_internals.getPromotions')
      break
    ...
    case types.GET_PARTIAL_LOG:
      chrome.send('presearch_rewards_internals.getPartialLog')
      break
    ...
    case types.GET_FULL_LOG:
      chrome.send('presearch_rewards_internals.getFullLog')
      break
    ...
    case types.CLEAR_LOG:
      chrome.send('presearch_rewards_internals.clearLog')
      break
    case types.DOWNLOAD_COMPLETED:
      state.fullLog = ''
      break
    case types.GET_EXTERNAL_WALLET:
      chrome.send('presearch_rewards_internals.getExternalWallet')
      break
    ...
    case types.GET_EVENT_LOGS:
      chrome.send('presearch_rewards_internals.getEventLogs')
      break
