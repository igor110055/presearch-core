...
export function getVerifyWalletPanel (
  ...
  switch (props.externalWalletProvider) {
    case 'bitflyer': {
      ...
      content = (
        <NewTabLink href='https://bitflyer.com/static/lp03/?ns=display_presearch_bf_presearch&utm_source=presearch&utm_medium=display&utm_campaign=bf_presearch&utm_term=202104&utm_content='>
