export const localeStrings = {
  ...
  onboardingPresearchRewards: 'Presearch Rewards',
  ...
  onboardingStartUsingRewards: 'Start using Presearch Rewards',
  ...
  onboardingTipHeader: 'Tip with Presearch rewards',
  onboardingTipText: 'By using Presearch rewards, you will start to gain BAT that you can use to tip creators.',
  ...
  onboardingPanelWelcomeHeader: 'Welcome to Presearch Rewards!',
  onboardingPanelWelcomeText: 'Presearch Private Ads reward you with tokens to support content creators unlike traditional ads, all while keeping your personal information private.',
  onboardingPanelAdsHeader: 'Where do ads show up?',
  onboardingPanelAdsText: 'Presearch Private Ads will appear as a normal notification. You control how often you see these ads in settings.',
  onboardingPanelScheduleHeader: 'When do you receive rewards?',
  onboardingPanelScheduleText: 'Your earned tokens from Presearch Private Ads throughout the current month will arrive on the 5th of the next month.',
  ...
  onboardingPanelCompleteText: 'By using Presearch Rewards you are helping make the web a better place for everyone. And that’s awesome!',
  ...
  onboardingPanelBitflyerText: 'By verifying your wallet and linking it to a bitFlyer account, you will be able to store and manage the tokens you have earned through Presearch Rewards more easily',
  onboardingPanelBitflyerLearnMore: '$1Learn more$2 about how to link your Presearch browser with your bitFlyer account.'
}
