...
export const localeStrings = {
  ...
  siteBannerConnectedText: 'This Presearch Verified Creator has not yet configured their account to receive contributions from Presearch users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
  siteBannerNoticeNote: 'NOTE:',
  siteBannerNoticeText: 'This creator has not yet signed up to receive contributions from Presearch users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
