...
export const box = withState({ checked: false, toggle: true, settings: false }, (store) => {
  ...
  return (
    <div style={{ width: '595px' }}>
      <Box
        title={text('Title', 'Presearch ads')}
        ...
        description={
          text('Description', `Earn tokens by seeing ads on Presearch. Ads are matched from machine learning and the data temporarily present in your browser without tracking your information or sending it outside.`)
        }
        onToggle={onToggle}
...
export const listToken = () => {
  return (
    <div style={{ width: '400px' }}>
      <ListToken
        title={text('Title', 'Presearch Contribute')}
...
export const tooltip = () => {
  const presearchAdsText = <span>Presearch Ads Settings</span>
