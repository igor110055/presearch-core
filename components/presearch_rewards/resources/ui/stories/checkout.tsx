...
const localeData = {
  strings: {
    ...
    updated: 'Updated',
    enableRewardsTitle: 'Enable Presearch Rewards to continue.',
    enableRewardsText: 'To purchase this item, you need to earn tokens. Turn on Presearch Rewards to earn.',
    enableRewardsLearnMore: 'Learn more.',
    enableRewardsButtonText: 'Enable Presearch Rewards',
    enableRewardsTerms: 'By clicking Enable Presearch Rewards, you agree to $1Presearch Reward’s Terms of Service$2.'
  },
  get (key: string) {
