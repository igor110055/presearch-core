...
const locale = {
  adsDesc: 'Earn tokens by seeing ads on Presearch. Ads are matched from machine learning and the data temporarily present in your browser without tracking your information or sending it outside.',
  adsDisabledText: 'Coming soon',
  adsDisplayed: 'Ads displayed',
  adsEarnings: 'Earnings this month',
  adsFreq: 'Ad Frequency',
  adsMode: 'Ad mode',
  adsTitle: 'Presearch Ads',
  ...
  contributionTitle: 'Presearch Contribute',
  ...
  rewardsDisabledDescTwo: 'Today, Presearch welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyPresearchRewards: 'Why Presearch Rewards?'
}
