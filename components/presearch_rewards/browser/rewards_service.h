...
#ifndef PRESEARCH_COMPONENTS_PRESEARCH_REWARDS_BROWSER_REWARDS_SERVICE_H_
#define PRESEARCH_COMPONENTS_PRESEARCH_REWARDS_BROWSER_REWARDS_SERVICE_H_
...
using GetPresearchWalletCallback =
    base::OnceCallback<void(ledger::type::PresearchWalletPtr wallet)>;
...
#endif  // PRESEARCH_COMPONENTS_PRESEARCH_REWARDS_BROWSER_REWARDS_SERVICE_H_
