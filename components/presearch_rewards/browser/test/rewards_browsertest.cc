...
// npm run test -- presearch_browser_tests --filter=RewardsBrowserTest.*
...
// https://github.com/presearch/presearch-browser/issues/12632
...
// https://github.com/presearch/presearch-browser/issues/12988
...
// Disabled in https://github.com/presearch/presearch-browser/issues/10789
...
// https://github.com/presearch/presearch-browser/issues/12987
...
// https://github.com/presearch/presearch-browser/issues/12704
...
IN_PROC_BROWSER_TEST_F(RewardsBrowserTest, EnableRewardsWithBalance) {
  ...
  prefs->SetBoolean(presearch_rewards::prefs::kEnabled, false);
  prefs->SetBoolean(presearch_rewards::prefs::kAutoContributeEnabled, false);
  ...
  EXPECT_TRUE(prefs->GetBoolean(presearch_rewards::prefs::kEnabled));
  EXPECT_FALSE(prefs->GetBoolean(presearch_rewards::prefs::kAutoContributeEnabled));
}
