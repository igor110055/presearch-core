...
// npm run test -- presearch_browser_tests --filter=RewardsNotificationBrowserTest.*

namespace rewards_browsertest {

using RewardsNotificationType =
    presearch_rewards::RewardsNotificationService::RewardsNotificationType;
...
class RewardsNotificationBrowserTest
 ...
 public:
  ...
  presearch_rewards::RewardsNotificationService* rewards_notification_service_;
  ...
  presearch_rewards::RewardsNotificationService::RewardsNotification
...
IN_PROC_BROWSER_TEST_F(
  ...
  presearch_rewards::RewardsNotificationService::RewardsNotificationArgs args;
  args.push_back("foo");
  args.push_back("bar");
...
IN_PROC_BROWSER_TEST_F(
  ...
  EXPECT_TRUE(
      ...
      presearch_rewards::RewardsNotificationService::REWARDS_NOTIFICATION_INVALID);
}
