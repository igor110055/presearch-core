...
#include "presearch/components/presearch_rewards/browser/test_util.h"
#include "chrome/browser/profiles/profile.h"
#include "content/public/test/browser_task_environment.h"
#include "testing/gmock/include/gmock/gmock.h"
#include "testing/gtest/include/gtest/gtest.h"

// npm run test -- presearch_unit_tests --filter=RewardsServiceTest.*
...
class RewardsServiceTest : public testing::Test {
 ...
 protected:
  void SetUp() override {
    ...
    profile_ = CreatePresearchRewardsProfile(temp_dir_.GetPath());
