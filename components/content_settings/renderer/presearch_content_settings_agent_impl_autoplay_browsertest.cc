...
class MockContentSettingsAgentImpl : public PresearchContentSettingsAgentImpl {
 public:
...
MockContentSettingsAgentImpl::MockContentSettingsAgentImpl(
    ...
    : PresearchContentSettingsAgentImpl(
          render_frame,
          false,
...
class PresearchContentSettingsAgentImplAutoplayBrowserTest
...
TEST_F(PresearchContentSettingsAgentImplAutoplayBrowserTest,
