...
std::string GetShieldsContentTypeName(const ContentSettingsType& content_type) {
  switch (content_type) {
    case ContentSettingsType::PRESEARCH_ADS:
      return presearch_shields::kAds;
    case ContentSettingsType::PRESEARCH_COSMETIC_FILTERING:
      return presearch_shields::kCosmeticFiltering;
    case ContentSettingsType::PRESEARCH_TRACKERS:
      return presearch_shields::kTrackers;
    case ContentSettingsType::PRESEARCH_HTTP_UPGRADABLE_RESOURCES:
      return presearch_shields::kHTTPUpgradableResources;
    case ContentSettingsType::PRESEARCH_FINGERPRINTING_V2:
      return presearch_shields::kFingerprintingV2;
    case ContentSettingsType::PRESEARCH_SHIELDS:
      return presearch_shields::kPresearchShields;
    case ContentSettingsType::PRESEARCH_REFERRERS:
      return presearch_shields::kReferrers;
    case ContentSettingsType::PRESEARCH_COOKIES:
      return presearch_shields::kCookies;
    default:
      NOTREACHED();
      return std::string();
  }
