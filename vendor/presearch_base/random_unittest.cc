...
class PresearchRandomDeterministicTest : public testing::Test {
 public:
  PresearchRandomDeterministicTest() {}
  ~PresearchRandomDeterministicTest() override {}
 private:
  DISALLOW_COPY_AND_ASSIGN(PresearchRandomDeterministicTest);
};

TEST_F(PresearchRandomDeterministicTest, Uniform_01) {
  using presearch_base::random::deterministic::Uniform_01;
...
TEST_F(PresearchRandomDeterministicTest, StdExponential) {
  using presearch_base::random::deterministic::StdExponential;
...
TEST_F(PresearchRandomDeterministicTest, Exponential) {
  using presearch_base::random::deterministic::Exponential;
...
TEST_F(PresearchRandomDeterministicTest, Geometric) {
  using presearch_base::random::deterministic::Geometric;
