...
@class BATAdNotification, BATPresearchAds, BATPresearchLedger;

OBJC_EXPORT
NS_SWIFT_NAME(PresearchAdsNotificationHandler)
@protocol BATPresearchAdsNotificationHandler
@required
...
OBJC_EXPORT 
NS_SWIFT_NAME(PresearchAds)
@interface BATPresearchAds : NSObject
...
@property (nonatomic, weak, nullable) id<BATPresearchAdsNotificationHandler> notificationsHandler;
...
/// System info
@property (nonatomic, class) BATPresearchAdsSysInfo *sysInfo;
/// The build channel that ads is configured for
@property (nonatomic, class) BATPresearchAdsBuildChannel *buildChannel;
