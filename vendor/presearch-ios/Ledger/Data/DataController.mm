...
- (NSURL *)storeURL
{
  return [[self storeDirectoryURL] URLByAppendingPathComponent:@"PresearchRewards.sqlite"];
}
...
+ (BOOL)defaultStoreExists
{
  ...
  const auto storeURL = [directoryURL URLByAppendingPathComponent:@"PresearchRewards.sqlite"];
