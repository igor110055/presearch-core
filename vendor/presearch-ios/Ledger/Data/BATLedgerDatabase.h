...
///
/// This class mirrors presearch-core's `publisher_info_database.h/cc` file. This file will actually
...
/// CoreData storage into version 10 of the presearch-core's database schema to
...
/// only (promos, promo creds, unblinded tokens) to version 10 of presearch-core's
/// database schema.
///
/// Return's nil if the migration template cannot be found
