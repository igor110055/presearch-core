...
@class BATPresearchLedger, BATRewardsNotification;
...
@interface BATPresearchLedgerObserver : NSObject

@property (nonatomic, readonly, weak) BATPresearchLedger *ledger;
