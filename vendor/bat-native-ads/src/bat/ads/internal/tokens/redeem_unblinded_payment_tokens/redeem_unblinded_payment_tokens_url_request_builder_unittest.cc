...
TEST(BatAdsRedeemUnblindedPaymentTokensRequestTest, BuildUrl) {
  // Arrange
  WalletInfo wallet;
  ...
  expected_url_request->url =
      R"(https://ads-serve.presearch.software/v1/confirmation/payment/d4ed0af0-bfa9-464b-abd7-67b29d891b8b)";
