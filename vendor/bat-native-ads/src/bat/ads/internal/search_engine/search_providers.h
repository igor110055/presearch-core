...
#ifndef PRESEARCH_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_SEARCH_ENGINE_SEARCH_PROVIDERS_H_
#define PRESEARCH_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_SEARCH_ENGINE_SEARCH_PROVIDERS_H_
...
const std::vector<SearchProviderInfo> _search_providers = {
    ...
    SearchProviderInfo("Qwant",
                       "https://qwant.com",
                       "https://www.qwant.com/?q={searchTerms}&client=presearch",
                       true),
    SearchProviderInfo(
        "Yandex",
        "https://yandex.com",
...
#endif  // PRESEARCH_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_SEARCH_ENGINE_SEARCH_PROVIDERS_H_
