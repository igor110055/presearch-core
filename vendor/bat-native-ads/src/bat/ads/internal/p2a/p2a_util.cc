...
const char kOpportunityQuestionPrefix[] =
    "Presearch.P2A.AdOpportunitiesPerSegment.";
const char kImpressionQuestionPrefix[] = "Presearch.P2A.AdImpressionsPerSegment.";
}  // namespace
...
std::vector<std::string> CreateAdOpportunityQuestionList(
  ...
  questions.push_back("Presearch.P2A.TotalAdOpportunities");
...
std::vector<std::string> CreateAdImpressionQuestionList(
  ...
  questions.push_back("Presearch.P2A.TotalAdImpressions");
