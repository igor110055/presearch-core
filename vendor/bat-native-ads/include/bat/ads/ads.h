...
#ifndef PRESEARCH_VENDOR_BAT_NATIVE_ADS_INCLUDE_BAT_ADS_ADS_H_
#define PRESEARCH_VENDOR_BAT_NATIVE_ADS_INCLUDE_BAT_ADS_ADS_H_
...
class ADS_EXPORT Ads {
 public:
  ...
  // |presearch_ads::ResourceComponent|
...
#endif  // PRESEARCH_VENDOR_BAT_NATIVE_ADS_INCLUDE_BAT_ADS_ADS_H_
