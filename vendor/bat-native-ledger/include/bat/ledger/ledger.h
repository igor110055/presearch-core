...
#ifndef PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_INCLUDE_BAT_LEDGER_LEDGER_H_
#define PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_INCLUDE_BAT_LEDGER_LEDGER_H_
...
using GetPresearchWalletCallback = std::function<void(type::PresearchWalletPtr)>;
...
class LEDGER_EXPORT Ledger {
 public:
  ...
  virtual void GetPresearchWallet(GetPresearchWalletCallback callback) = 0;

  virtual std::string GetWalletPassphrase() const = 0;

  virtual void LinkPresearchWallet(const std::string& destination_payment_id,
...
#endif  // PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_INCLUDE_BAT_LEDGER_LEDGER_H_
