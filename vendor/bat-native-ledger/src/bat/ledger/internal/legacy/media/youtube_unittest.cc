...
// npm run test -- presearch_unit_tests --filter=MediaYouTubeTest.*
...
TEST(MediaYouTubeTest, GetMediaIdFromUrl) {
  ...
  std::string media =
      presearchledger_media::YouTube::GetMediaIdFromUrl(data.url);
  ASSERT_EQ(media, "");
...
TEST(MediaYouTubeTest, GetPublisherKeyFromUrl) {
  ...
  key = presearchledger_media::YouTube::GetPublisherKeyFromUrl(path);
  ASSERT_EQ(key, "");
...
TEST(MediaYouTubeTest, GetUserFromUrl) {
  ...
  std::string user = presearchledger_media::YouTube::
      GetUserFromUrl(path);
  ASSERT_EQ(user, "");
  ...
  user = presearchledger_media::YouTube::
      GetUserFromUrl(path);
  ...
  user =
      presearchledger_media::YouTube::GetUserFromUrl(path);
  ASSERT_EQ(user, "");

  // single element in the url
  path = "https://www.youtube.com/user/presearch";

  user =
      presearchledger_media::YouTube::GetUserFromUrl(path);
  ASSERT_EQ(user, "presearch");

  // multiple elements in the url
  path = "https://www.youtube.com/user/"
             "presearch?view_as=subscriber";
  ...
  path = "https://www.youtube.com/user/"
             "presearch/playlist?view_as=subscriber";
...
TEST(MediaYouTubeTest, GetBasicPath) {
  ...
  std::string realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ...
  path = "/presearchsoftware";
  realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/presearchsoftware");

  path = "/presearchsoftware/videos";
  realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/presearchsoftware");
  ...
  path = "/presearchsoftware/playlists";
  realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/presearchsoftware");

  path = "/presearchsoftware/community";
  realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/presearchsoftware");

  path = "/presearchsoftware/channels";
  realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/presearchsoftware");

  path = "/presearchsoftware/about";
  realPath =
      presearchledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/presearchsoftware");
...
TEST(MediaYouTubeTest, GetNameFromChannel) {
  ...
  // empty string
  std::string resolve =
      presearchledger_media::YouTube::GetNameFromChannel(std::string());
  ASSERT_EQ(resolve, std::string());

  // quote
  resolve =
      presearchledger_media::YouTube::GetNameFromChannel("\"");
  ASSERT_EQ(resolve, std::string());
  ...
  resolve =
      presearchledger_media::YouTube::GetNameFromChannel(subject);
...
TEST(MediaYouTubeTest, GetPublisherName) {
  ...
  std::string publisher_name =
      presearchledger_media::YouTube::GetPublisherName(std::string());
  ASSERT_EQ(publisher_name, std::string());

  // quote
  publisher_name =
      presearchledger_media::YouTube::GetPublisherName("\"");
  ASSERT_EQ(publisher_name, std::string());
  ...
  publisher_name =
      presearchledger_media::YouTube::GetPublisherName(subject);
...
TEST(MediaYouTubeTest, GetChannelId) {
  ...
  data = "<div id=\"microformat\"><title>Presearch</title><link rel=\"canonical\" h"
         ...
         "Zg\"><meta property=\"og:title\" content=\"Presearch\"><meta property=\"o"
