...
#ifndef PRESEARCHLEDGER_BAT_GET_MEDIA_H_
#define PRESEARCHLEDGER_BAT_GET_MEDIA_H_
...
class Media {
 ...
 private:
  ...
  std::unique_ptr<presearchledger_media::YouTube> media_youtube_;
  std::unique_ptr<presearchledger_media::Twitch> media_twitch_;
  std::unique_ptr<presearchledger_media::Reddit> media_reddit_;
  std::unique_ptr<presearchledger_media::Vimeo> media_vimeo_;
  std::unique_ptr<presearchledger_media::GitHub> media_github_;
};

}  // namespace presearchledger_media

#endif  // PRESEARCHLEDGER_BAT_GET_MEDIA_H_
