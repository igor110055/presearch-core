...
#ifndef PRESEARCHLEDGER_LEGACY_PUBLISHER_SETTINGS_STATE_H_
#define PRESEARCHLEDGER_LEGACY_PUBLISHER_SETTINGS_STATE_H_
...
#endif  // PRESEARCHLEDGER_LEGACY_PUBLISHER_SETTINGS_STATE_H_
