...
#ifndef PRESEARCHLEDGER_UPHOLD_UPHOLD_CARD_H_
#define PRESEARCHLEDGER_UPHOLD_UPHOLD_CARD_H_
...
const char kCardName[] = "Presearch Browser";
...
#endif  // PRESEARCHLEDGER_UPHOLD_UPHOLD_CARD_H_
