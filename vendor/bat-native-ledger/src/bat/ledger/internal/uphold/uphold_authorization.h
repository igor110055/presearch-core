...
#ifndef PRESEARCHLEDGER_UPHOLD_UPHOLD_AUTHORIZATION_H_
#define PRESEARCHLEDGER_UPHOLD_UPHOLD_AUTHORIZATION_H_
...
#endif  // PRESEARCHLEDGER_UPHOLD_UPHOLD_AUTHORIZATION_H_
