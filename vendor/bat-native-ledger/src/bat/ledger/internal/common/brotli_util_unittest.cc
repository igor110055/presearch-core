...
// npm run test -- presearch_unit_tests --filter='PresearchLedgerBrotliHelpersTest.*'
...
class PresearchLedgerBrotliHelpersTest : public testing::Test {
 protected:
...
TEST_F(PresearchLedgerBrotliHelpersTest, TestDecode) {
  std::string s;
...
TEST_F(PresearchLedgerBrotliHelpersTest, TestDecodeWithBuffer) {
  std::string s;
