...
#ifndef PRESEARCHLEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
#define PRESEARCHLEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
...
#endif  // PRESEARCHLEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
