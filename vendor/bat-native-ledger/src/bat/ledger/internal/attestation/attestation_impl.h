...
#ifndef PRESEARCHLEDGER_ATTESTATION_ATTESTATION_IMPL_H_
#define PRESEARCHLEDGER_ATTESTATION_ATTESTATION_IMPL_H_
...
#endif  // PRESEARCHLEDGER_ATTESTATION_ATTESTATION_IMPL_H_
