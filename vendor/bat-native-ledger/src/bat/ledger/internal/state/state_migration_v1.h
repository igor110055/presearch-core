...
#ifndef PRESEARCHLEDGER_BAT_STATE_STATE_MIGRATION_V1_H_
#define PRESEARCHLEDGER_BAT_STATE_STATE_MIGRATION_V1_H_
...
#endif  // PRESEARCHLEDGER_BAT_STATE_STATE_MIGRATION_V1_H_
