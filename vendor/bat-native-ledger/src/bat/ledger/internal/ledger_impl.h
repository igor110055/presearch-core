...
#ifndef PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_LEDGER_IMPL_H_
#define PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_LEDGER_IMPL_H_
...
class LedgerImpl : public ledger::Ledger {
 public:
  ...
  presearchledger_media::Media* media() const;
 ...
 private:
  ...
  std::unique_ptr<presearchledger_media::Media> media_;
...
#endif  // PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_LEDGER_IMPL_H_
