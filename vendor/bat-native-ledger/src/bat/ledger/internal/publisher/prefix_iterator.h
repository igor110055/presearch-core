...
#ifndef PRESEARCHLEDGER_PUBLISHER_PREFIX_ITERATOR_H_
#define PRESEARCHLEDGER_PUBLISHER_PREFIX_ITERATOR_H_
...
#endif  // PRESEARCHLEDGER_PUBLISHER_PREFIX_ITERATOR_H_
