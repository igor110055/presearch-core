...
#ifndef PRESEARCHLEDGER_DATABASE_DATABASE_INITIALIZE_H_
#define PRESEARCHLEDGER_DATABASE_DATABASE_INITIALIZE_H_
...
#endif  // PRESEARCHLEDGER_DATABASE_DATABASE_INITIALIZE_H_
