...
#ifndef PRESEARCHLEDGER_DATABASE_DATABASE_RECURRING_TIP_H_
#define PRESEARCHLEDGER_DATABASE_DATABASE_RECURRING_TIP_H_
...
#endif  // PRESEARCHLEDGER_DATABASE_DATABASE_RECURRING_TIP_H_
