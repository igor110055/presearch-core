...
#ifndef PRESEARCHLEDGER_DATABASE__DATABASE_SERVER_PUBLISHER_BANNER_H_
#define PRESEARCHLEDGER_DATABASE__DATABASE_SERVER_PUBLISHER_BANNER_H_
...
#endif  // PRESEARCHLEDGER_DATABASE__DATABASE_SERVER_PUBLISHER_BANNER_H_
