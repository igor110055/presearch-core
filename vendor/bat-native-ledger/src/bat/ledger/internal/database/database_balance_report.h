...
#ifndef PRESEARCHLEDGER_DATABASE_DATABASE_BALANCE_REPORT_H_
#define PRESEARCHLEDGER_DATABASE_DATABASE_BALANCE_REPORT_H_
...
#endif  // PRESEARCHLEDGER_DATABASE_DATABASE_BALANCE_REPORT_H_
