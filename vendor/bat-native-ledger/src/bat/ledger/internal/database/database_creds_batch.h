...
#ifndef PRESEARCHLEDGER_DATABASE_DATABASE_CREDS_BATCH_H_
#define PRESEARCHLEDGER_DATABASE_DATABASE_CREDS_BATCH_H_
...
#endif  // PRESEARCHLEDGER_DATABASE_DATABASE_CREDS_BATCH_H_
