...
#ifndef PRESEARCHLEDGER_DATABASE_DATABASE_PENDING_CONTRIBUTION_H_
#define PRESEARCHLEDGER_DATABASE_DATABASE_PENDING_CONTRIBUTION_H_
...
#endif  // PRESEARCHLEDGER_DATABASE_DATABASE_PENDING_CONTRIBUTION_H_
