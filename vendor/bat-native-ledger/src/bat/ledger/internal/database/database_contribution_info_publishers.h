...
#ifndef PRESEARCHLEDGER_DATABASE_DATABASE_CONTRIBUTION_INFO_PUBLISHERS_H_
#define PRESEARCHLEDGER_DATABASE_DATABASE_CONTRIBUTION_INFO_PUBLISHERS_H_
...
#endif  // PRESEARCHLEDGER_DATABASE_DATABASE_CONTRIBUTION_INFO_PUBLISHERS_H_
