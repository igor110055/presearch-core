...
#ifndef PRESEARCHLEDGER_ENDPOINT_PRIVATE_CDN_PRIVATE_CDN_SERVER_H_
#define PRESEARCHLEDGER_ENDPOINT_PRIVATE_CDN_PRIVATE_CDN_SERVER_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_PRIVATE_CDN_PRIVATE_CDN_SERVER_H_
