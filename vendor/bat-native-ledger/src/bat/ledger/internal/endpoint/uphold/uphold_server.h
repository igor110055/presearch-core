...
#ifndef PRESEARCHLEDGER_ENDPOINT_UPHOLD_UPHOLD_SERVER_H_
#define PRESEARCHLEDGER_ENDPOINT_UPHOLD_UPHOLD_SERVER_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_UPHOLD_UPHOLD_SERVER_H_
