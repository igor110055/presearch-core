...
#ifndef PRESEARCHLEDGER_ENDPOINT_UPHOLD_GET_ME_GET_ME_H_
#define PRESEARCHLEDGER_ENDPOINT_UPHOLD_GET_ME_GET_ME_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_UPHOLD_GET_ME_GET_ME_H_
