...
PromotionServer::PromotionServer(LedgerImpl* ledger)
    : get_available_(std::make_unique<promotion::GetAvailable>(ledger)),
      ...
      post_wallet_presearch_(std::make_unique<promotion::PostWalletPresearch>(ledger)),
      get_recover_wallet_(
      ...
      post_claim_presearch_(std::make_unique<promotion::PostClaimPresearch>(ledger)),
...
promotion::PostWalletPresearch* PromotionServer::post_wallet_presearch() const {
  return post_wallet_presearch_.get();
}
...
promotion::PostClaimPresearch* PromotionServer::post_claim_presearch() const {
  return post_claim_presearch_.get();
}
