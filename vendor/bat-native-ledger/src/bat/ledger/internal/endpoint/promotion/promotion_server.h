...
#ifndef PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
#define PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
...
#include "bat/ledger/internal/endpoint/promotion/post_wallet_presearch/post_wallet_presearch.h"
...
class PromotionServer {
 public:
  ...
  promotion::PostWalletPresearch* post_wallet_presearch() const;
  ...
  promotion::PostClaimPresearch* post_claim_presearch() const;
 ...
 private:
  ...
  std::unique_ptr<promotion::PostWalletPresearch> post_wallet_presearch_;
  ...
  std::unique_ptr<promotion::PostClaimPresearch> post_claim_presearch_;
...
#endif  // PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
