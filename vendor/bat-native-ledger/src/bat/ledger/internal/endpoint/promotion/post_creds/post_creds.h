...
#ifndef PRESEARCHLEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
#define PRESEARCHLEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
