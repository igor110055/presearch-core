...
#ifndef PRESEARCHLEDGER_ENDPOINT_REWARDS_REWARDS_SERVER_H_
#define PRESEARCHLEDGER_ENDPOINT_REWARDS_REWARDS_SERVER_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_REWARDS_REWARDS_SERVER_H_
