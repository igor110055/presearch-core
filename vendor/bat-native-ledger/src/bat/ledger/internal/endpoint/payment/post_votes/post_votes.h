...
#ifndef PRESEARCHLEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
#define PRESEARCHLEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
