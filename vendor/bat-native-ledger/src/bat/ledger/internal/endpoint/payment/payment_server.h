...
#ifndef PRESEARCHLEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
#define PRESEARCHLEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
...
#endif  // PRESEARCHLEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
