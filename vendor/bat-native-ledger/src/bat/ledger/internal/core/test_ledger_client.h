...
#ifndef PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_CORE_TEST_LEDGER_CLIENT_H_
#define PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_CORE_TEST_LEDGER_CLIENT_H_
...
#endif  // PRESEARCH_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_CORE_TEST_LEDGER_CLIENT_H_
