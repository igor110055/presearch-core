...
PresearchCommandLineHelper::PresearchCommandLineHelper(base::CommandLine* command_line)
    : command_line_(*command_line) {
  Parse();
}

const std::unordered_set<std::string>&
PresearchCommandLineHelper::enabled_features() const {
  return enabled_features_;
}

const std::unordered_set<std::string>&
PresearchCommandLineHelper::disabled_features() const {
  return disabled_features_;
}

void PresearchCommandLineHelper::ParseCSV(
...
void PresearchCommandLineHelper::Parse() {
...
void PresearchCommandLineHelper::AppendSwitch(const char* switch_key) {
  if (!command_line_.HasSwitch(switch_key))
    command_line_.AppendSwitch(switch_key);
}

void PresearchCommandLineHelper::AppendFeatures(
...
void PresearchCommandLineHelper::AppendCSV(
...
void PresearchCommandLineHelper::AppendSwitchASCII(const char* switch_key,
                                               const char* value) {
  if (!command_line_.HasSwitch(switch_key))
