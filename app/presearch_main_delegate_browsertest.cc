...
using PresearchMainDelegateBrowserTest = InProcessBrowserTest;
...
IN_PROC_BROWSER_TEST_F(PresearchMainDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(PresearchMainDelegateBrowserTest, DisableHyperlinkAuditing) {
  EXPECT_TRUE(
...
IN_PROC_BROWSER_TEST_F(PresearchMainDelegateBrowserTest, OriginTrialsTest) {
  EXPECT_TRUE(base::CommandLine::ForCurrentProcess()->HasSwitch(
      embedder_support::kOriginTrialPublicKey));
  EXPECT_EQ(kPresearchOriginTrialsPublicKey,
            base::CommandLine::ForCurrentProcess()->GetSwitchValueASCII(
                embedder_support::kOriginTrialPublicKey));
}

IN_PROC_BROWSER_TEST_F(PresearchMainDelegateBrowserTest, DisabledFeatures) {
...
IN_PROC_BROWSER_TEST_F(PresearchMainDelegateBrowserTest, EnabledFeatures) {
