...
TEST(PresearchCommandLineHelperUnitTest, TestAppendSwitch) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
  PresearchCommandLineHelper helper(&command_line);
...
TEST(PresearchCommandLineHelperUnitTest, TestParseFeatures) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
...
TEST(PresearchCommandLineHelperUnitTest, TestAppendFeatures) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
  PresearchCommandLineHelper helper(&command_line);
